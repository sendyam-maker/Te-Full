   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":031C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":0638
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":0814
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":0B30
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":0E4C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":1168
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":1484
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":1ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040148.frx":1DD8
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
   ...
   m_bInsert = IsUserHasRightOfFunction("frm12040148", strAdd, False)
   m_bUpdate = IsUserHasRightOfFunction("frm12040148", strEdit, False)
   m_bDelete = IsUserHasRightOfFunction("frm12040148", strDel, False)
   m_bQuery = IsUserHasRightOfFunction("frm12040148", strFind, False)
...
Private Sub RefreshRange()
   ...
   strSql = "SELECT MIN(SDR01) FROM Staff_Dept_Right "
   ...
   strSql = "SELECT MAX(SDR01) FROM Staff_Dept_Right "
   rsTmp.CursorLocation = adUseClient
   rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
   If rsTmp.RecordCount > 0 Then
...
' 顯示資料
Private Sub ShowCurrRecord(ByVal strSDR01 As String)
Dim strSql As String
Dim rsTmp As New ADODB.Recordset
   
   If IsRecordExist(strSDR01) = True Then
      m_CurrSR = strSDR01
   Else
   strSql = "SELECT SDR01 FROM Staff_Dept_Right " & _
                        "WHERE SDR01 IN (Select MIN(SDR01) FROM Staff_Dept_Right " & _
                                       "WHERE  SDR01 > '" & m_CurrSR & "' ) "

      rsTmp.CursorLocation = adUseClient
      rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
      If rsTmp.RecordCount > 0 Then
         If IsNull(rsTmp.Fields("SDR01")) = False Then: m_CurrSR = rsTmp.Fields("SDR01")
      Else
         RefreshRange
         m_CurrSR = m_LastSR
      End If
...
Dim rsTmp As New ADODB.Recordset
   ...
   strSql = "SELECT SDR01 FROM STAFF_Dept_RIGHT " & _
                  "WHERE SDR01 IN (SELECT MAX(SDR01) FROM STAFF_Dept_RIGHT " & _
                                 "WHERE SDR01 < '" & m_CurrSR & "' ) "
   ...
   If nRow > 0 And nRow < GrdList.Rows Then
      Select Case nCol
         ...
         Case 1:
            ...
            If GrdList.TextMatrix(GrdList.row, 2) = "V" Then
               nIndex = 2
               GrdList.TextMatrix(GrdList.row, nIndex) = Empty
               GrdList.TextMatrix(GrdList.row, 4) = Empty 'Add By Sindy 2021/8/27
            Else
               nIndex = 2
               GrdList.TextMatrix(GrdList.row, nIndex) = "V"
            End If
         ' 當作用的欄位是第2欄時, 變更該筆記錄的單項權限(全選或全不選)
         Case 2
            If GrdList.TextMatrix(GrdList.row, GrdList.col) = "V" Then
               GrdList.TextMatrix(GrdList.row, GrdList.col) = Empty
            Else
               GrdList.TextMatrix(GrdList.row, GrdList.col) = "V"
            End If
         'Add By Sindy 2021/8/27
         ' 當作用的欄位是第4欄時, 變更該筆記錄的單項權限
         Case 4
            If GrdList.TextMatrix(GrdList.row, 2) = "V" Then
               If GrdList.TextMatrix(GrdList.row, GrdList.col) = "V" Then
                  GrdList.TextMatrix(GrdList.row, GrdList.col) = Empty
...
' 檢查記錄是否已經存在
Private Function IsRecordExist(ByVal strSDR01 As String) As Boolean
Dim rsTmp As New ADODB.Recordset
Dim strSql As String
   
   IsRecordExist = False
   strSql = "SELECT * FROM STAFF_Dept_RIGHT " & _
            "WHERE SDR01 = '" & strSDR01 & "' "
   ' 讀取資料庫
   rsTmp.CursorLocation = adUseClient
   rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
   ' 檢查讀取的資料筆數
...
' 清除該筆記錄的原先資料
Private Sub ClearOldRecord(ByVal strSDR01 As String)
Dim strSql As String
   
   strSql = "DELETE FROM STAFF_Dept_RIGHT " & _
            "WHERE SDR01 = '" & strSDR01 & "' "
...
''''''''''''''''''''''''''''''''''''''''''''''''''''
' 將該筆資料寫入資料庫中
'Modify By Sindy 2021/8/27 + SDR04
Private Sub UpdateDB(ByVal strSDR01 As String, ByVal strSDR02 As String, ByVal strSDR03 As String, ByVal strSDR04 As String)
   strSql = "INSERT INTO STAFF_Dept_RIGHT (SDR01, SDR02, SDR03, SDR04) " & _
            "VALUES ('" & strSDR01 & "','" & strSDR02 & "'"
   If strSDR03 = Empty Then: strSql = strSql & ",NULL": Else strSql = strSql & ",'Y'"
   If strSDR04 = Empty Then: strSql = strSql & ",NULL": Else strSql = strSql & ",'Y'"
   strSql = strSql & ")"
   cnnConnection.Execute strSql
End Sub
...
Dim bUpdate As Boolean
   ...
   '20080925 add by Toni  是跨部門權限
   For nRow = 1 To GrdList.Rows - 1
      bUpdate = False
      nCol = 2
      If GrdList.TextMatrix(nRow, nCol) = "V" Then
         bUpdate = True
      End If
      
      If bUpdate = True Then
         UpdateDB textSR01, GrdList.TextMatrix(nRow, 1), GrdList.TextMatrix(nRow, 2), GrdList.TextMatrix(nRow, 4)
      End If
   Next nRow
...
Dim strDes As String
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      Do While rsTmp.EOF = False
         strSrc = UCase(rsTmp.Fields("SDR02"))
         ' 在GridList找尋該表單編號的列
         For nRow = 1 To GrdList.Rows - 1
            ...
            If strSrc = strDes Then
               If IsNull(rsTmp.Fields("SDR03")) = False Then
                  If rsTmp.Fields("SDR03") = "Y" Then
                     GrdList.TextMatrix(nRow, 2) = "V"
                  End If
               End If
               'Add By Sindy 2021/8/27
               If IsNull(rsTmp.Fields("SDR04")) = False Then
                  If rsTmp.Fields("SDR04") = "Y" Then
                     GrdList.TextMatrix(nRow, 4) = "V"
                  End If
               End If
               '2021/8/27 END
               Exit For
...
'' 更新GridList中的內容
'Private Sub UpdateGridListData(ByVal strSDR03 As String)
' Dim nRow As Integer
'   For nRow = 1 To grdList.Rows - 1
'      If grdList.TextMatrix(nRow, 1) = strSDR03 Then
'         If strSDR03 = "Y" Then: grdList.TextMatrix(nRow, 2) = "V"
'         Exit For
'      End If
'   Next
'End Sub
...
Private Sub QueryDB()
   ...
   strSql = "SELECT * FROM SystemKind ORDER BY SK01"
   rsTmp.CursorLocation = adUseClient
   rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
   ' 檢查讀取的資料筆數
   If rsTmp.RecordCount > 0 Then
      ...
      Do While rsTmp.EOF = False
         ...
         nRow = GrdList.Rows - 1
         If IsNull(rsTmp.Fields("SK01")) = False Then
            GrdList.TextMatrix(nRow, 1) = rsTmp.Fields("SK01")
         End If
         If IsNull(rsTmp.Fields("SK04")) = False Then
            GrdList.TextMatrix(nRow, 3) = rsTmp.Fields("SK04")
         End If
         rsTmp.MoveNext
      Loop
