...
Begin VB.Form frm12040116 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":031C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":0638
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":0814
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":0B30
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":0E4C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":1168
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":1484
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":1ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040116.frx":1DD8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frm12040116"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Morgan 2021/12/22 改成Form2.0 (txtDesc,textCUID,lblCustName)
'Added by Lydia 2015/01/05 年費報價資料維護
Option Explicit
...
Private Sub Form_Load()
   ...
   lblCustName.BackColor = &H8000000F
...
Private Sub textYF03_Change()
   If Len(textYF03) = 9 Then
      lblCustName = GetCustomerName(textYF03)
      SetScore
   Else
      lblCustName = ""
   End If
...
Private Sub textYF03_Validate(Cancel As Boolean)
   textYF03 = ChangeCustomerL(textYF03)
 'Modified by Lydia 2015/01/08 開放可輸入臺灣案,但要控制業務區不可為F
strExc(0) = GetCuSales(textYF03, strExc(1))
If Left(strExc(0), 1) = "F" Then
   ShowMsg "該業務區客戶不可設定 !"
   Cancel = True
End If
End Sub
...
Private Sub SetCtrlReadOnly(ByVal bLocked As Boolean)
   For Each oText In Me.Controls
      ...
      End If
   Next
   'Modified by Lydia 費用與點數皆不鎖定,以最後輸入的欄位,計算另一欄位
...
'    stKey = textYF01 & textYF02 & textYF03 & "605"
'    strExc(1) = ""
'    If Trim(txtYear) <> "" Then strExc(1) = " and a.YF05=" & Trim(txtYear)
'    strExc(1) = " and a.YF05= 1"
'   Select Case p_iWay
'      Case 0, 3 '當筆
'         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF02||a.YF03||a.YF04='" & stKey & "'" & strExc(1) & _
'                     " AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by a.yf05"
'      Case -2 '第一筆 'Modified by Lydia 2015/01/22 + yf05
'         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF02||a.YF03||a.YF04='" & stKey & "'" & strExc(1) & _
'                     " AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by a.yf05"
'      Case -1 '前一筆
...
'         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF02||a.YF03||a.YF04='" & stKey & "'" & strExc(1) & _
'                     " AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by a.yf05"
'      Case 2 '最後筆  'Modified by Lydia 2015/01/22 + yf05
'         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF02||a.YF03||a.YF04='" & stKey & "'" & strExc(1) & _
'                     " AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by a.yf05 desc "
'   End Select
   'Modified by Morgan 2024/5/24 專利種類要加單引號，否則會有數字無效的型態錯誤
   stKey = textYF01 & textYF03 & "605"
   Select Case p_iWay
      Case 0, 3 '當筆
         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF03||a.YF04='" & stKey & "'" & _
                     " and a.yf05=1 and a.yf02='" & textYF02 & "' AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by 2 "
      Case -2 '第一筆
         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF03||a.YF04='" & stKey & "'" & _
                     " and a.yf05=1 and a.yf02<='" & IIf(textYF02 = "", "0", textYF02) & "' AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by 2 "
      Case -1 '前一筆
         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF03||a.YF04='" & stKey & "'" & _
                     " and a.yf05=1 and a.yf02<'" & IIf(textYF02 = "", "0", textYF02) & "'  AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by 2 "
      Case 1 '後一筆
      ...
      Case 2 '最後筆
         strExc(0) = "SELECT a.*, C.YF07 YFee FROM PatentYearFee a, PatentYearFee c where a.YF01||a.YF03||a.YF04='" & stKey & "'" & _
                     " and a.yf05=1 and a.yf02>='" & IIf(textYF02 = "", "0", textYF02) & "' AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05 order by 2 desc "
   End Select
   'end 2015/01/22
   ...
   Select Case m_EditMode
      Case 1: '新增
         ...
         If TxtValidate() = True Then
            ' 檢查記錄是否已存在
            'Modified by Lydia 2015/01/22
            'If PUB_PYFIsExists(textYF01, textYF02, textYF03, "605", txtYear) = True Then
            If PUB_PYFIsExists(textYF01, textYF02, textYF03, "605", "1") = True Then
               strExc(0) = "新增資料"
               strExc(1) = "該筆記錄已存在"
...
Private Sub UpdateFieldNewData()
   ...
   m_FieldList(3).fiNewData = textYF03.Text
     

   m_FieldList(4).fiNewData = "605"
   'Modified by Lydia 2015/01/22 年度不輸入
   'm_FieldList(5).fiNewData = Val(txtYear)
...
Private Sub textYF03_GotFocus()
   TextInverse textYF03
   CloseIme 'Modifed by Lydia 2015/01/09 關閉中文輸入
End Sub
...
Private Sub txtFee_Validate(Cancel As Boolean)
   SetScore
End Sub
...
' 新增時檢查記錄是否已存在
'Modified by Lydia 2015/01/22 txtYear = 1
If m_EditMode = "1" And PUB_PYFIsExists(textYF01, textYF02, textYF03, "605", "1") = True Then
   strExc(0) = "檢核資料"
   strExc(1) = "該筆記錄已存在"
   MsgBox strExc(1), vbOKOnly, strExc(0)
   Cancel = True
...
'Modified by Lydia 2015/01/08 輸入小數1位
   'If KeyAscii <> 8 And Not IsNumeric(Chr(KeyAscii)) Then
   If KeyAscii <> 8 And Not IsNumeric(Chr(KeyAscii)) And KeyAscii <> 46 Then
      KeyAscii = 0
      Beep
   End If
End Sub
...
On Error GoTo ErrHand
   ...
   'Modified by Lydia 2015/01/22 年度不輸入,由底價檔取得(ex:新增1~20年)
'   '畫面有的欄位才更新
'   For idx = 1 To TF_YF
...
'   stSQL = "INSERT INTO patentyearfee (" & stCols & ") Values (" & stValues & ")"
   ...
   strSql = " select yf01,yf02," & CNULL(ChangeCustomerL(textYF03)) & ",yf04,yf05," & CNULL(Format(Val(txtScore) * 1000, "###0")) & ",yf07," & CNULL(Trim(txtDesc)) & _
   " from patentyearfee where yf01=" & CNULL(textYF01) & " and yf03='Y00000001' and yf04='605'and yf02=" & CNULL(textYF02)
   
   stSQL = "INSERT INTO patentyearfee (YF01,YF02,YF03,YF04,YF05,YF06,YF07,YF15) " & strSql
   Pub_SeekTbLog stSQL
   ...
   With p_Rst
      If .RecordCount > 0 Then
         For idx = 1 To TF_YF
            ...
            If idx = 7 Then
               m_FieldList(idx).fiOldData = "" & .Fields("YFee")
            End If
         ...
         textYF03.Text = m_FieldList(3).fiNewData
         textYF03.Tag = textYF03.Text
         'm_FieldList(4).fiNewData = 605
         txtYear.Text = m_FieldList(5).fiNewData
...
On Error GoTo ErrHand
   ...
   '刪除資料
   'Modified by Lydia 2015/01/22 -YF05
...
'      Exit Function
   ...
   If textYF03 = "" Then
      ...
      textYF03.SetFocus
      Exit Function
   ElseIf Len(textYF03) <> 6 And Len(textYF03) <> 9 Then
      ShowMsg "客戶編號輸入錯誤 !"
      textYF03.SetFocus
      textYF03_GotFocus
      Exit Function
   Else
      textYF03 = ChangeCustomerL(textYF03)
      If PUB_CheckStatus(textYF03) = False Then
         textYF03.SetFocus
         textYF03_GotFocus
         Exit Function
      End If
   ...
   If m_EditMode <> 4 Then
      'Modified by Lydia 2015/01/22 費用不輸入
'      If txtFee = "" Then
'         ShowMsg "費用不可空白 !"
'         txtFee.SetFocus
'         txtFee_GotFocus
...
'         Exit Function
'      End If
      'Modified by Lydia 2015/01/08 設點數最小到小數一位
      If txtScore = "" Then
         ShowMsg "點數不可空白 !"
         txtScore.SetFocus
         txtScore_GotFocus
         Exit Function
      ElseIf Val(txtScore) = 0 Then
         ShowMsg "點數不可為零 !"
         txtScore.SetFocus
         txtScore_GotFocus
         Exit Function
      ElseIf InStr(Trim(Val(txtScore) * 10), ".") > 0 Then
         ShowMsg "點數最小到小數點一位 !"
         txtScore.SetFocus
         txtScore_GotFocus
         Exit Function
...
End Function
'計算點數
Private Function SetScore() As Boolean
   If Trim(txtFee) <> "" And Trim(textYF01) <> "" And Trim(textYF02) <> "" And Trim(txtYear) <> "" Then
      strExc(0) = "select yf07 from patentyearfee where yf01='" & textYF01 & "' and yf02='" & textYF02 & "' and yf03='Y00000001' and yf04='605' and yf05=" & Val(txtYear)
      intI = 1
      Set RsTemp = ClsLawReadRstMsg(intI, strExc(0))
      If intI = 1 Then
         If Val(txtFee) <= Val(RsTemp(0)) Then
            MsgBox "費用不可低於底價！", vbExclamation
         Else
            txtScore = Format((Val(txtFee) - Val(RsTemp(0))) / 1000, "0.0")
            SetScore = True
         End If
      Else
         MsgBox "無法讀取底價！", vbExclamation
      End If
   Else
      SetScore = True
   End If
...
'Add by Lydia 2015/01/09
'計算費用
Private Function SetFee() As Boolean
   If Trim(txtScore) <> "" And Trim(textYF01) <> "" And Trim(textYF02) <> "" Then
      'Modified by 2015/01/22 年度不輸入
'      strExc(0) = "select yf07 from patentyearfee where yf01='" & textYF01 & "' and yf02='" & textYF02 & "' and yf03='Y00000001' and yf04='605' and yf05=" & Val(txtYear)
      strExc(0) = "select yf07 from patentyearfee where yf01='" & textYF01 & "' and yf02='" & textYF02 & "' and yf03='Y00000001' and yf04='605' and yf05=1 "
      intI = 1
      Set RsTemp = ClsLawReadRstMsg(intI, strExc(0))
      If intI = 1 Then
         txtFee = Format(Val(txtScore) * 1000 + Val(RsTemp(0)), "###0")
         txtScore = Format(Val(txtScore), "0.0")
         If Val(txtFee) <= Val(RsTemp(0)) Then
            MsgBox "點數不可低於底價！", vbExclamation
         Else
            SetFee = True
         End If
      Else
