   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":031C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":0638
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":0814
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":0B30
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":0E4C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":1168
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":1484
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":1ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm12040115.frx":1DD8
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'Modified by Lydia 2015/01/08 不限大陸,更名為-領證報價資料維護
Option Explicit
...
Private Sub textYF02_Change()
   If textYF02 <> "" Then
      ...
      SetScore 'Modified by Lydia 2015/01/08
   Else
      textYF02_2 = ""
   End If
End Sub
...
'Modified by Lydia 2015/01/05 增加判斷
If m_EditMode = "1" And PUB_PYFIsExists(textYF01, textYF02, textYF03, "601", "1") = True Then
   strExc(0) = "檢核資料"
   strExc(1) = "該筆記錄已存在"
   ...
   Select Case KeyCode
      ...
      Case vbKeyF5 ' 刪除
         If MsgBox("是否要刪除此筆資料?", vbYesNo + vbCritical + vbDefaultButton2, "詢問") = vbYes Then
            m_EditMode = 3
            If OnWork = True Then
               'Modify by Morgan 2008/6/16 刪除後改為查詢狀態
               'ShowRecord 2
               'UpdateToolbarState
               OnAction vbKeyF4
            Else
...
Private Sub SetCtrlReadOnly(ByVal bLocked As Boolean)
   For Each oText In Me.Controls
      ...
      End If
   Next
   'Add by Morgan 2008/6/16 控制點數不可輸入
...
Private Sub UpdateToolbarState()
   ...
   End Select
   'Add by Morgan 2008/6/16 不允許上下筆
   tlbar.Buttons(6).Enabled = False
   tlbar.Buttons(7).Enabled = False
   tlbar.Buttons(8).Enabled = False
   tlbar.Buttons(9).Enabled = False
...
Private Function ShowRecord(Optional ByVal p_iWay As Integer = 0, Optional ByVal p_bGridOnly As Boolean) As Boolean
   ...
   stCon = " AND A.YF04='601' AND A.YF05='1' AND substr(A.YF03,1,1)='X'"
   
   stKey = textYF01 & textYF02 & textYF03 & "601"
   
   'Modify by Morgan 2010/12/9 規費改抓代理人Y00000001 設定且不存檔
   Select Case p_iWay
      Case 0, 3 '當筆
         strExc(0) = "SELECT A.*,C.YF07 YFee" & _
            " FROM patentyearfee A,patentyearfee C" & _
            " WHERE A.YF01||A.YF02||A.YF03||A.YF04='" & stKey & "'" & stCon & _
            " AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05"
            
      Case -2 '首筆
         strExc(0) = "SELECT A.*,C.YF07 YFee" & _
            " FROM patentyearfee A,patentyearfee C" & _
            " WHERE A.YF01||A.YF02||A.YF03||A.YF04||A.YF05=(SELECT MIN(B.YF01||B.YF02||B.YF03||B.YF04||B.YF05)" & _
            " FROM patentyearfee B WHERE 1=1" & stCon & ")" & _
            " AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05"

      Case -1 '前筆
         strExc(0) = "SELECT A.*,C.YF07 YFee" & _
            " FROM patentyearfee A,patentyearfee C" & _
            " WHERE A.YF01||A.YF02||A.YF03||A.YF04||A.YF05=(SELECT MAX(B.YF01||B.YF02||B.YF03||B.YF04||B.YF05)" & _
            " FROM patentyearfee B WHERE B.YF01||B.YF02||B.YF03||B.YF04<'" & stKey & "'" & stCon & ")" & _
            " AND C.YF01(+)||C.YF02(+)||C.YF03(+)||C.YF04(+)||C.YF05(+)=A.YF01||A.YF02||'Y00000001'||A.YF04||A.YF05"
   ...
   Select Case m_EditMode
      Case 1: '新增
         ...
         If TxtValidate() = True Then
            'Modified by Lydia 2015/01/05 增加判斷
            If PUB_PYFIsExists(textYF01, textYF02, textYF03, "601", "1") = True Then
               strExc(0) = "新增資料"
               strExc(1) = "該筆記錄已存在"
               MsgBox strExc(1), vbOKOnly, strExc(0)
               Exit Function
...
'      Exit Function
   ...
   If m_EditMode <> 4 Then
      If txtFee = "" Then
         ...
         Exit Function
      End If
'Modify by Morgan 2008/6/16 點數改程式計算
'      If txtScore = "" Then
'         ShowMsg "點數不可空白 !"
'         txtScore.SetFocus
'         txtScore_GotFocus
...
Private Function SetScore() As Boolean
   If Trim(txtFee) <> "" And Trim(textYF01) <> "" And Trim(textYF02) <> "" Then
      strExc(0) = "select yf07 from patentyearfee where yf01='" & textYF01 & "' and yf02='" & textYF02 & "' and yf03='Y00000001' and yf04='601'"
      intI = 1
      Set RsTemp = ClsLawReadRstMsg(intI, strExc(0))
      If intI = 1 Then
