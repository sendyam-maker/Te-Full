...
Begin VB.Form frm170006 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":031C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":0638
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":0814
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":0B30
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":0E4C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":1168
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":1484
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":1ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm170006.frx":1DD8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "單筆資料"
      TabPicture(0)   =   "frm170006.frx":20F4
      ...
      Tab(0).Control(8)=   "txtNote"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "txtAE(4)"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "txtAE(3)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "txtAE(1)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "txtAE(2)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).ControlCount=   13
      TabCaption(1)   =   "多筆瀏覽"
      TabPicture(1)   =   "frm170006.frx":2110
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "txtSum(0)"
      Tab(1).Control(1)=   "cmdok"
      Tab(1).Control(2)=   "txt1(3)"
      ...
      Begin MSHierarchicalFlexGridLib.MSHFlexGrid GRD1 
         ...
         ScrollTrack     =   -1  'True
         AllowUserResizing=   3
         FormatString    =   "員工代號|姓名|借支日期|借支金額|償還年月|備註"
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         Caption         =   "PS：若要在年終獎金扣款償還，則請輸入該年的第13月"
         ForeColor       =   &H000000FF&
         Height          =   180
         Index           =   2
         Left            =   510
...
Dim stCon As String
   ...
   stCon = ""
   If txt1(0) <> "" Then
      stCon = stCon & " and ae01>='" & txt1(0) & "' "
   End If
   If txt1(1) <> "" Then
      stCon = stCon & " and ae01<='" & txt1(1) & "' "
   End If
   If txt1(2) <> "" Then
      stCon = stCon & " and ae02>=" & DBDATE(txt1(2))
   End If
   If txt1(3) <> "" Then
      stCon = stCon & " and ae02<=" & DBDATE(txt1(3))
   End If
   strExc(0) = "SELECT ae01 員工代號,ST02 姓名,sqldateT(ae02) 借支日期,to_char(ae03,'99G999G999') 借支金額,ae04-191100 償還年月,ae11 備註 FROM Advance_Employee,staff " & _
               " where ae01=st01(+) " & stCon & " order by ae01,ae02"
   intI = 1
   ...
   If intI <> 2 Then
      ...
      If RsTemp.RecordCount > 0 Then
         ...
         Do While Not RsTemp.EOF
            txtSum(0) = Val(txtSum(0)) + Val(Format("" & RsTemp("借支金額")))
            RsTemp.MoveNext
         Loop
...
Private Sub Form_Unload(Cancel As Integer)
   Set frm170006 = Nothing
End Sub

' 初始化欄位陣列
Private Sub InitialField()
   strExc(0) = "select * from Advance_Employee where rownum<1"
   intI = 1
   Set RsTemp = ClsLawReadRstMsg(intI, strExc(0))
   If intI <> 2 Then
      With RsTemp
      TF_AE = .Fields.Count
      ReDim m_FieldList(TF_AE) As FIELDITEM
      For Each oText In txtAE
         idx = oText.Index
         m_FieldList(idx).fiName = "AE" & Format(idx, "00")
...
Dim adoRst As New ADODB.Recordset
   ...
   stKey01 = txtAE(1)
   stKey02 = DBDATE(txtAE(2))
   
   Select Case p_iWay
      Case 0
         strExc(0) = "SELECT * FROM Advance_Employee" & _
            " WHERE ae01 = '" & stKey01 & "' and ae02= '" & stKey02 & "'"
      Case -2
         strExc(0) = "SELECT * FROM Advance_Employee order by 2 ASC, 1 ASC"
      Case -1
         strExc(0) = "SELECT * FROM Advance_Employee" & _
            " WHERE ae02||ae01 <'" & stKey02 & stKey01 & "' order by 2 DESC,1 DESC"
      Case 1
         strExc(0) = "SELECT * FROM Advance_Employee" & _
            " WHERE ae02||ae01 >'" & stKey02 & stKey01 & "' order by 2 ASC,1 ASC"
      Case 2
         strExc(0) = "SELECT * FROM Advance_Employee order by 2 DESC,1 DESC"
   End Select
   intI = 1
   adoRst.MaxRecords = 1
   ...
   If lCurRow > 0 Then
      If GRD1.TextMatrix(lCurRow, 0) <> "" Then
         If TBar1.Buttons(4).Enabled = True Then
            ...
            If txtAE(1).Locked = False Then
               txtAE(1).Text = GRD1.TextMatrix(lCurRow, 0)
               txtAE(2).Text = ChangeTDateStringToTString(GRD1.TextMatrix(lCurRow, 2))
...
Private Sub txtAE_GotFocus(Index As Integer)
   Select Case Index
'      Case 11
'         OpenIme
      Case Else
   ...
   TextInverse txtAE(Index)
End Sub

Private Sub ClearField()
   txtNote.Text = Empty: txtNote.Tag = Empty 'Modify By Sindy 2021/12/20
   For Each oText In txtAE
      oText.Text = Empty
   Next
...
Private Sub UpdateCtrlData(ByRef p_Rst As ADODB.Recordset)
   ...
   If .RecordCount > 0 Then
      For Each oText In txtAE
         ...
         End If
      Next
      'Modify By Sindy 2021/12/20
      txtNote.Text = "" & .Fields("ae11")
      txtNote.Tag = "" & .Fields("ae11")
      '2021/12/20 END
      
      If ClsPDGetStaffN(txtAE(1), strExc(1), , True) Then
         lblDsp(1) = strExc(1)
      End If
...
Private Sub SetCtrlReadOnly(ByVal bLocked As Boolean)
   ...
   Next
   txtNote.Locked = bLocked 'Add By Sindy 2021/12/20
End Sub
...
Private Sub UpdateToolbarState()
   Select Case m_EditMode
      Case 0 ' 無任何動作
         ...
         End If
         If m_bUpdate And txtAE(1) <> "" Then
            TBar1.Buttons(2).Enabled = True
         Else
            TBar1.Buttons(2).Enabled = False
         End If
         If m_bDelete And txtAE(1) <> "" Then
...
Dim bCancel As Boolean
   ...
   '維護
   Else
      If txtAE(1) = "" And txtAE(1).Locked = False Then
         ShowMsg "請輸入員工代號 !"
         txtAE(1).SetFocus
         txtAE_GotFocus 1
         GoTo EscPoint
      End If
      If txtAE(2) = "" And txtAE(2).Locked = False Then
         ShowMsg "請輸入借支日期 !"
         txtAE(2).SetFocus
         txtAE_GotFocus 2
         GoTo EscPoint
      End If
      If Val(txtAE(3)) = 0 And txtAE(3).Locked = False Then
         ShowMsg "請輸入借支金額 !"
         txtAE(3).SetFocus
         txtAE_GotFocus 3
         GoTo EscPoint
      End If
      If Val(txtAE(4)) = 0 And txtAE(4).Locked = False Then
         ShowMsg "請輸入償還年月 !"
         txtAE(4).SetFocus
         txtAE_GotFocus 4
         GoTo EscPoint
...
On Error GoTo ErrHand
   ...
   For Each oText In txtAE
      ...
      End If
   Next
   stCols = Mid(stCols & ",ae11", 2) 'Modify By Sindy 2021/12/20 + txtNote
   stValues = Mid(stValues & "," & CNULL(ChgSQL(txtNote.Text)), 2) 'Modify By Sindy 2021/12/20 + txtNote
   stSQL = "INSERT INTO Advance_Employee (" & stCols & ") Values (" & stValues & ")"
...
On Error GoTo ErrHand
   ...
   stSQL = "begin user_data.user_enabled:=1; UPDATE Advance_Employee SET "
   stSet = ""
   For Each oText In txtAE
      idx = oText.Index
   ...
   If txtNote.Text <> txtNote.Tag Then
      stSet = stSet & ",ae11=" & CNULL(ChgSQL(txtNote.Text))
   End If
   If bDifference = True Or txtNote.Text <> txtNote.Tag Then
   '2021/12/20 END
      stSet = Mid(stSet, 2)
      stSQL = stSQL & stSet & " where ae01='" & txtAE(1) & "' and ae02=" & DBDATE(txtAE(2)) & "; end; "
...
Private Sub txtAE_KeyPress(Index As Integer, KeyAscii As Integer)
   KeyAscii = UpperCase(KeyAscii)
   Select Case Index
      Case 1, 11 'Added by Morgan 2013/4/16  2015/12/28 +11
      Case Else
...
Private Sub txtAE_Validate(Index As Integer, Cancel As Boolean)
   
   If m_EditMode = 1 Or m_EditMode = 2 Then
      Select Case Index
         Case 1
            If txtAE(Index) <> "" Then
               If ChkStaffID(txtAE(Index)) = True Then
                  Cancel = True
               End If
               If Cancel = False And ClsPDGetStaff(txtAE(Index), strExc(1)) = False Then
                  Cancel = True
               Else
                  lblDsp(1) = strExc(1)
               End If
         ...
         Case 2
            If txtAE(Index) <> "" Then
               If ChkDate(txtAE(Index)) = False Then
                  Cancel = True
               End If
            End If
         Case 4
            If txtAE(Index) <> "" Then
               If Right(txtAE(Index), 2) > 13 Then
                  ShowMsg "償還月份不可超過13 !"
                  Cancel = True
               End If
            End If
         ...
         Case 11
            If Not CheckLengthIsOK(txtAE(Index), txtAE(Index).MaxLength) Then
               Cancel = True
            End If
         '2015/12/25 END
      End Select
      
      If Cancel = True Then TextInverse txtAE(Index)
...
On Error GoTo ErrHand
   ...
   '刪除
   stSQL = "delete from Advance_Employee where ae01='" & txtAE(1) & "' and ae02=" & DBDATE(txtAE(2))
   Pub_SeekTbLog stSQL
   cnnConnection.Execute stSQL, intI
