...
Dim BoxOptBtn As OptionButton
   BlnCheck = True
   For Each BoxOptBtn In frm090104_1.OptBtn
...
Private Sub Query_Sub()
   frm090104_2.Show
   frm090104_2.Hide
   frm090104_2.MousePointer = vbHourglass
   frm090104_2.GridData
   frm090104_2.MousePointer = vbDefault
   If frm090104_2.Enabled = True Then
      frm090104_2.Show
   Else
   ...
   Do
      ...
      If bolToEndByNick = True Then
         ...
         Exit Sub
      End If
   Loop Until Not frm090104_2.Visible
   Unload frm090104_2
End Sub
...
Dim OrderStr As String, SubSQL As String, strCondition As String
   ...
   If Txtdata(0) <> Empty Then
      ...
      End If
      pub_QL05 = pub_QL05 & ";" & Label1 & Txtdata(0) & LblTmq10NM 'Add By Sindy 2010/12/13
   End If
