...
Public Function Process() As Boolean
   ...
   StrSqlB = "select " & SQLDate("CP05") & " as 收文日,cp09 as 收文號,nvl(cpm03,cpm04) as 案件性質,s1.st02 as 承辦人,s2.st02 as 智權人員" & _
      " from caseprogress,casepropertymap,staff s1,staff s2" & _
      " where cp01='" & oCP01 & "' and cp02='" & oCP02 & "' and cp03='" & oCP03 & "' and cp04='" & oCP04 & "'" & _
      " and cp09<'B' and ((cp10>='101' and cp10<='140') or (cp10>='301' and cp10<='315'))" & _
      " and cp01=cpm01(+) and cp10=cpm02(+) and cp14=s1.st01(+) and cp13=s2.st01(+) AND CP57 IS NULL order by cp05 desc"
   With AdoRecordSet3
...
Case 0
      For i = 1 To grd1.Rows - 1
         ...
         If grd1.CellBackColor = QBColor(13) Then
            frm090633.txtMH(14).Text = grd1.TextMatrix(i, 1)
            Unload Me
            Exit Sub
         End If
      Next i
