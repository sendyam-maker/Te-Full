...
Begin VB.Form frm090618_2 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      EndProperty
      TabCaption(0)   =   "瀏覽資料"
      TabPicture(0)   =   "frm090618_2.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "詳細資料"
      TabPicture(1)   =   "frm090618_2.frx":001C
...
Dim m_AR26 As Double   '發文實績點數得分 Added by Morgan 2019/3/20
...
Dim IsHaveClose As Boolean '判斷該季是否協理有評過任一人
...
Dim idx1 As Integer, idx2 As Integer 'Added by Morgan 2019/3/20
Dim m_bolEngOpen As Boolean 'Added by Morgan 2019/3/26
...
Case 1
         ...
         With AdoRecordSet33
               If ProSysState = "1" Then '承辦人
                  ...
                  'Modified by Morgan 2019/3/20 +EA22發文實績點數,EA23發文實績點數達成率,EA24發文實績點數得分
                  If .RecordCount <> 0 Then
                        strSql = "update engineerassess set ea04=" & ChgNull(lbl2(2)) & ",ea05=" & ChgNull(lbl2(4)) & ",ea06=" & ChgNull(lbl2(5)) & ",ea18=" & ChgNull(lbl2(6)) & ",ea07=decode(" & Val(lbl2(2)) & ",0, Null," & Val(lbl2(5)) & "/" & Val(lbl2(2)) & "*100),ea08=" & ChgNull(lbl2(10)) & ",ea09=" & ChgNull(Val(lbl2(14)) - Val(lbl2(25))) & ",ea10=" & ChgNull(lbl2(15)) & ",ea11=" & ChgNull(lbl2(16)) & ",ea12=" & ChgNull(lbl2(18)) & ",ea13=" & ChgNull(lbl2(19)) & ",ea14=" & ChgNull(lbl2(20)) & ",ea15=" & ChgNull(lbl2(21)) & ",ea16=" & ChgNull(lbl2(22)) & ",ea17=" & ChgNull(lbl2(23)) & ",ea19=" & ChgNull(lbl2(24)) & ",ea20=" & ChgNull(lbl2(25)) & ",ea22=" & ChgNull(lbl2(26)) & ",ea23=" & ChgNull(lbl2(27)) & ",ea24=" & ChgNull(lbl2(28)) & " where ea01='" & lblst01.Caption & "' and ea02=" & Val(frm090618.txt1(0)) + 1911 & " and ea03=" & Val(frm090618.txt1(1)) & " "
                        cnnConnection.Execute strSql
                  Else
                        strSql = "insert into engineerassess (ea01,ea02,ea03,ea04,ea05,ea06,ea07,ea08,ea09,ea10,ea11,ea12,ea13,ea14,ea15,ea16,ea17,ea18,ea19,ea20,ea22,ea23,ea24) values ('" & lblst01.Caption & "'," & Val(frm090618.txt1(0)) + 1911 & "," & Val(frm090618.txt1(1)) & " ," & ChgNull(lbl2(2)) & "," & ChgNull(lbl2(4)) & "," & ChgNull(lbl2(5)) & ",decode(" & Val(lbl2(2)) & ",0,Null," & Val(lbl2(5)) & "/" & Val(lbl2(2)) & "*100)," & ChgNull(lbl2(10)) & "," & ChgNull(Val(lbl2(14)) - Val(lbl2(25))) & "," & ChgNull(lbl2(15)) & "," & ChgNull(lbl2(16)) & "," & ChgNull(lbl2(18)) & "," & ChgNull(lbl2(19)) & "," & ChgNull(lbl2(20)) & "," & ChgNull(lbl2(21)) & "," & ChgNull(lbl2(22)) & "," & ChgNull(lbl2(23)) & "," & ChgNull(lbl2(6)) & "," & ChgNull(lbl2(24)) & "," & ChgNull(lbl2(25)) & "," & ChgNull(lbl2(26)) & "," & ChgNull(lbl2(27)) & "," & ChgNull(lbl2(28)) & ") "
                        cnnConnection.Execute strSql
                  End If
...
Private Sub Form_Activate()
   ...
   If m_IsRun = False Then
      ...
      'Added by Morgan 2019/3/26 108考核,開放工程師成員(P11)可以查詢所有人員最近一季的季考核成績(在王副總完成評分之後)
      ElseIf ProSysState = "1" And frm090618.txt1(6) = "" Then
         m_bolEngOpen = True
      'end 2019/3/26
      End If
      ...
      'Added by Morgan 2019/3/20
      '為方便編輯標籤改有底色，此處再改為表單顏色
      For Each oLabel In lbl2
         oLabel.BackColor = Me.BackColor
      Next
      lblPromoter.BackColor = Me.BackColor 'Added by Morgan 2022/1/13
      ...
      If ProState <> "2" Then '個人
         '無瀏覽頁籤,只能看自己詳細資料(不顯示主管評分)
         SSTab1.Tab = 1
         
         If Not m_bolEngOpen Then 'Added by Morgan 2019/3/26 108考核
         ...
         If Val(Trim(lbl2(20).Caption)) + Val(Trim(lbl2(21).Caption)) + Val(Trim(lbl2(22).Caption)) <> 0 Then
            txt1(0).Enabled = False '修改及複雜案件時數
            txt1(1).Enabled = False '自我比較評分
         End If
         
      Else
         'Modified by Morgan 2023/3/25
         'If PUB_GetST05(strUserNum) = "71" Or PUB_GetST05(strUserNum) = "00" Then '副總
...
With grd1
    ...
    If ProSysState = "1" Then
         ...
         .ColWidth(5) = 800
         .CellAlignment = flexAlignCenterCenter
         'Added by Morgan 2019/3/20 插入實績點數3個欄位,後面欄位調整索引值
         .col = 6:   .Text = "發文"
         .ColWidth(6) = 800
         .CellAlignment = flexAlignCenterCenter
         .col = 7:   .Text = "發文"
...
End With
   With Me.grd1
      ...
      'Added by Morgan 2019/3/26 108考核,開放工程師成員(P11)可以查詢所有人員最近一季的季考核成績(在王副總完成評分之後)
      '預設在自己那一筆
      If m_bolEngOpen Then
         idx1 = GetColIndex("st01")
         For jj = 2 To .Rows - 1
            If .TextMatrix(jj, idx1) = strUserNum Then
               .row = jj
               .TopRow = .row
               Exit For
            End If
...
Function StrMenu() As Boolean
   ...
   If ProSysState = "1" Then '承辦人
         'Modified by Morgan 2019/3/20 +EA22發文實績點數,EA23發文實績點數達成率,EA24發文實績點數得分
         strSql = " select  nvl(ea04,A1) ea04,nvl(ea05,A2) ea05,nvl(ea06,ma37) ea06" & _
            ",nvl(ea07,decode(A1,0,0,round(ma37/A1 * 100,2))) ea07,nvl(ea08,0) ea08" & _
            ",nvl(ea22,ma55) ea22,nvl(ea23,decode(A2,0,0,round(ma55/A2 * 100,2))) ea23,nvl(ea24,0) ea24" & _
            ",nvl(ea09,ma40) ea09,nvl(ea10,decode(A2,0,0,round(ma40/A2 * 100,2))) ea10,nvl(ea11,0) ea11" & _
            ",nvl(ea12,round(ma35/" & CalMonth & ",2)) ea12,ea13,ea14,ea15,ea16,nvl(ea17,0) ea17,st02,ea18,st01" & _
            ",nvl(ea19,CancelCount) ea19,nvl(ea20,CancelPoint) ea20" & _
            " from (select pe01,sum(nvl(decode(pe02,'CFP',pe05 * 2 ,pe05),0) + nvl(decode(pe02,'CFP',pe07*2,pe07),0)) as A1, sum(nvl(pe06,0) + nvl(pe08,0)) as A2,sum(nvl(pe09,0)) as A3,sum(nvl(pe10,0)) as A4,sum(nvl(pe11,0)) as A5 from performance where pe02 in ('P','CFP') And pe03>=" & BeginDay & " and pe03<=" & EndDay & " " & strSQL2 & " group by pe01) APE ,("
         strSql = strSql & " select st01,st02,ma03,sum(nvl(ma04,0)) as ma04,sum(nvl(ma37,0)) as ma37,sum(nvl(ma40,0)) as ma40,sum(nvl(ma43,0)) as ma43,sum(nvl(ma35 - decode(ma44,0,0,0.5*ma51) ,0)) as ma35,sum(nvl(ma47,0)) as ma47,sum(nvl(ma51,0)) as ma51,nvl(sum(ma55),0) ma55 from monthassess,staff where ma01=st01(+) and ma02>=" & BeginDay & " and ma02<=" & EndDay & " " & strSQL1
   ...
   Else
         ...
         strSql = strSql & " select st01,st02,ma03,sum(nvl(ma04,0)) as ma04,sum(nvl(ma37,0)) as ma37,sum(nvl(ma40,0)) as ma40,sum(nvl(ma43,0)) as ma43,sum(nvl(ma35 - decode(ma44,0,0,0.5*ma51) ,0)) as ma35,sum(nvl(ma47,0)) as ma47,sum(nvl(ma51,0)) as ma51,sum(nvl(ma52,0)) as ma52,sum(nvl(ma53,0)) as ma53 from monthassess,staff where ma01=st01(+) and ma02>=" & BeginDay & " and ma02<=" & EndDay & " " & strSQL1
         strSql = strSql & " group by st01,st02,ma03) AAA,("
   ...
   If adoRecordset.RecordCount <> 0 Then
         ...
         '算得分
         'Modified by Morgan 2019/3/20 108考核,+ar01<=季考核起始日
         ...
         If AdoRecordSet33.RecordCount <> 0 Then
               ...
               m_AR26 = Val("" & AdoRecordSet33.Fields("ar26").Value) 'Added by Morgan 2019/3/20
               ...
               With grd1
                     For j = 2 To grd1.Rows - 1
                        If ProSysState = "1" Then '承辦人
                           ...
                           MinD = MaxD * -1
                           'Modified by Morgan 2019/3/20 108考核,自我比較評分改±5%(原±5分)
                           lbl3(0) = "± " & Trim(MaxD) & " %"
                           ...
                           'Added by Morgan 2019/4/9
                           For idx2 = 1 To 17
                              '點數1位其他2位小數
                              If idx2 = 2 Or idx2 = 6 Or idx2 = 9 Then
                                 .TextMatrix(j, idx2) = Format(.TextMatrix(j, idx2), "#0.0")
                              Else
                           ...
                           'Modified by Morgan 2019/3/19 108考核,得分取消(達成率)^2的計算方式
                           '發文基數得分
                           idx1 = GetColIndex("EA08"): idx2 = GetColIndex("EA07")
                           .TextMatrix(j, idx1) = Format((Val(.TextMatrix(j, idx2)) / 100) * 0.8 * (AdoRecordSet33.Fields("ar02").Value), "0.00")
                           
                           '發文點數得分
                           idx1 = GetColIndex("EA11"): idx2 = GetColIndex("EA10")
                           .TextMatrix(j, idx1) = Format((Val(.TextMatrix(j, idx2)) / 100) * 0.8 * (AdoRecordSet33.Fields("ar03").Value), "0.00")
                           '點數有上限
                           If Val(.TextMatrix(j, idx1)) > ((AdoRecordSet33.Fields("ar03").Value) * 1.5) Then
                              .TextMatrix(j, idx1) = Format((AdoRecordSet33.Fields("ar03").Value) * 1.5, "0.00")
                           End If
                           
                           'Added by Morgan 2019/3/20 108考核,加發文實績點數
                           '發文實績點數得分
                           idx1 = GetColIndex("EA24"): idx2 = GetColIndex("EA23")
                           .TextMatrix(j, idx1) = Format((Val(.TextMatrix(j, idx2)) / 100) * 0.8 * (AdoRecordSet33.Fields("ar26").Value), "0.00")
                           '點數有上限
                           If Val(.TextMatrix(j, idx1)) > ((AdoRecordSet33.Fields("ar03").Value) * 1.5) Then
                              .TextMatrix(j, idx1) = Format((AdoRecordSet33.Fields("ar03").Value) * 1.5, "0.00")
                           End If
                           ...
                           '速度考核最低分是 0 分
                           idx1 = GetColIndex("EA12")
                           If Val(.TextMatrix(j, idx1)) < 0 Then
                                 .TextMatrix(j, idx1) = "0.00"
                           End If
                           
                           '主管是抓正確，不用比對人<--??
                           idx1 = GetColIndex("st01")
                           lblst01.Caption = .TextMatrix(j, idx1)
                           Process j
                           'Modified by Morgan 2023/3/25
                           'If PUB_GetST05(strUserNum) = "71" Or PUB_GetST05(strUserNum) = "00" Then
                           'Modified by Morgan 2025/2/4 +P10部門
                           ...
                           Else
                                '核稿人評分
                                idx1 = GetColIndex("EA14")
                                .TextMatrix(j, idx1) = txt1(2).Text
                                '帶人主管評分
                                idx1 = GetColIndex("EA15")
                                .TextMatrix(j, idx1) = txt1(3).Text
                           End If
                           '季考核得分
                           idx1 = GetColIndex("EA17")
                           .TextMatrix(j, idx1) = lbl2(23).Caption
   ...
   For iRow = 2 To .Rows - 1
      ...
      For iCol = 0 To .Cols - IIf(ProSysState = "1", 6, 7)
         ...
         ElseIf ProSysState = "1" Then
            ...
            '考核基數
            ElseIf iCol = 3 Then
               stTemp = Format(Val(lbl2(8).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 600 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
               
            '考核基數達成率
            ElseIf iCol = 4 Then
               stTemp = Format(Val(lbl2(9).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 800 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
            
            '考核基數得分
            ElseIf iCol = 5 Then
               stTemp = Format(Val(lbl2(10).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 600 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
            ...
            '發文實績點數
            ElseIf iCol = 6 Then
               stTemp = Format(Val(lbl2(26).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 800 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
            ...
            '發文實績點數達成率
            ElseIf iCol = 7 Then
               stTemp = Format(Val(lbl2(27).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 800 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
            ...
            '發文實績點數得分
            ElseIf iCol = 8 Then
               stTemp = Format(Val(lbl2(28).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 600 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
            ...
            '發文點數
            ElseIf iCol = 9 Then
               stTemp = Format(Val(lbl2(14).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 800 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
            ...
            '發文點數達成率
            ElseIf iCol = 10 Then
               stTemp = Format(Val(lbl2(15).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 800 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
            ...
            '發文點數得分
            ElseIf iCol = 11 Then
               stTemp = Format(Val(lbl2(16).Caption), "0.00")
               Printer.CurrentX = PLeft(iCol) + 600 - Printer.TextWidth(stTemp)
               Printer.CurrentY = iPrint
               Printer.Print stTemp
               
            'Modified by Morgan 2019/3/27
            '若有控制欄未寬度為0者不應列印(無權限)
            ElseIf .ColWidth(iCol) > 0 Then
...
'定陣列
If ProSysState = "1" Then '承辦人
      PLeft(0) = 200      '承辦人 1000
      PLeft(1) = 1200   '目標基數 800
      PLeft(2) = 2000   '目標點數 1000
      PLeft(3) = 3000   '考核-基數 800
      PLeft(4) = 3800   '考核-達成率% 1000
      PLeft(5) = 4800   '考核-得分 800
      PLeft(6) = 5600   '發文實績-點數 1000
      PLeft(7) = 6600   '發文實績-達成率% 1000
      PLeft(8) = 7600   '發文實績-得分 800
      PLeft(9) = 8400   '發文-點數 1000
      PLeft(10) = 9400 '發文-達成率% 1000
      PLeft(11) = 10400 '發文實績-得分 800
      PLeft(12) = 11200 '速度考核得分 800
      PLeft(13) = 12000 '自我比較評分 950
      PLeft(14) = 12950 '核稿人評分 950
      PLeft(15) = 13900 '帶人主管評分 800
      PLeft(16) = 14700 '部門主管評分 950
      PLeft(17) = 15650 '季考核總分
...
If ProSysState = "1" Then
      ...
      Printer.Print "承辦人"
      stName = "目標"
      Printer.CurrentX = PLeft(1) + ((PLeft(3) - 100 - PLeft(1) - Printer.TextWidth(stName)) / 2)
      Printer.CurrentY = iPrint
      Printer.Print stName
      Printer.Line (PLeft(1), iPrint + 290)-(PLeft(3) - 100, iPrint + 290)
      
      stName = "考核"
      Printer.CurrentX = PLeft(3) + ((PLeft(6) - 100 - PLeft(3) - Printer.TextWidth(stName)) / 2)
      Printer.CurrentY = iPrint
      Printer.Print stName
      Printer.Line (PLeft(3), iPrint + 290)-(PLeft(6) - 100, iPrint + 290)
      
      stName = "發文實績"
      Printer.CurrentX = PLeft(6) + ((PLeft(9) - 100 - PLeft(6) - Printer.TextWidth(stName)) / 2)
      Printer.CurrentY = iPrint
      Printer.Print stName
      Printer.Line (PLeft(6), iPrint + 290)-(PLeft(9) - 100, iPrint + 290)
      
      stName = "發文"
      Printer.CurrentX = PLeft(9) + ((PLeft(12) - 100 - PLeft(9) - Printer.TextWidth(stName)) / 2)
      Printer.CurrentY = iPrint
      Printer.Print stName
...
With grd1
      If ProSysState = "1" Then '承辦人
         ...
         idx1 = GetColIndex("st01")
         lblst01.Caption = .TextMatrix(oRow, idx1)
         lblPromoter.Caption = .TextMatrix(oRow, 0)
         lbl2(1).Caption = frm090618.txt1(0) & " 年 " & frm090618.txt1(1) & "  季 "
         '目標基數
         idx1 = GetColIndex("EA04")
         lbl2(2).Caption = .TextMatrix(oRow, idx1)
         '目標點數
         idx1 = GetColIndex("EA05")
         lbl2(4).Caption = .TextMatrix(oRow, idx1)
         '發文基數
         idx1 = GetColIndex("EA06")
         lbl2(5).Caption = .TextMatrix(oRow, idx1)
         '修改及複雜案件時數
         idx1 = GetColIndex("EA18")
         lbl2(6).Caption = .TextMatrix(oRow, idx1)
         txt1(0).Text = lbl2(6).Caption
         '銷案基數
         idx1 = GetColIndex("EA19")
         lbl2(24).Caption = .TextMatrix(oRow, idx1)
         '銷案點數
         idx1 = GetColIndex("EA20")
         lbl2(25).Caption = .TextMatrix(oRow, idx1)
         ...
         '發文點數
         '點數要加入銷案點數，且達成率也要重算
         idx1 = GetColIndex("EA09")
         lbl2(14).Caption = Trim(Val(.TextMatrix(oRow, idx1)) + Val(lbl2(25).Caption))
         '達成率
         ...
         '實績發文點數
         idx1 = GetColIndex("EA22")
         lbl2(26).Caption = .TextMatrix(oRow, idx1)
         '達成率
         If Val(lbl2(4).Caption) <> 0 Then
            lbl2(27).Caption = Format(Trim((Val(lbl2(26).Caption) / Val(lbl2(4).Caption)) * 100), "0.00")
         Else
            lbl2(27).Caption = "0"
         End If
         '實績發文點數得分
         lbl2(28).Caption = Format(Val(lbl2(27).Caption) / 100 * 0.8 * m_AR26, "0.00")
         
         '速度考核得分
         idx1 = GetColIndex("EA12")
         lbl2(18).Caption = .TextMatrix(oRow, idx1)
         '自我比較評分
         idx1 = GetColIndex("EA13")
         lbl2(19).Caption = .TextMatrix(oRow, idx1)
         txt1(1).Text = lbl2(19).Caption
         '核稿人評分
         idx1 = GetColIndex("EA14")
         lbl2(20).Caption = .TextMatrix(oRow, idx1)
         txt1(2).Text = lbl2(20).Caption
         '帶人主管評分
         idx1 = GetColIndex("EA15")
         lbl2(21).Caption = .TextMatrix(oRow, idx1)
         txt1(3).Text = lbl2(21).Caption
         '部門主管評分
         idx1 = GetColIndex("EA16")
         lbl2(22).Caption = .TextMatrix(oRow, idx1)
         txt1(4).Text = lbl2(22).Caption
         '季考核得分
         idx1 = GetColIndex("EA17")
         lbl2(23).Caption = .TextMatrix(oRow, idx1)
      ...
      Else
         ...
         txt1(2).Visible = False
         'Added by Morgan 2019/3/20
         Label29.Visible = False: lbl2(26).Visible = False '發文實績點數
         Label30.Visible = False: lbl2(27).Visible = False '發文實績點數達成率
         Label31.Visible = False: lbl2(28).Visible = False '發文實績點數得分
         'end 2019/3/20
         lblPromoter.Caption = .TextMatrix(oRow, 0)
         lbl2(1).Caption = frm090618.txt1(0) & " 年 " & frm090618.txt1(1) & "  季 "
         ...
         Else  '管理
               ...
               Else
                  ...
                  'Modified by Morgan 2024/12/20 此表單為工程師專用,移除原繪圖控制
...
Dim tmplbl21 As String    '帶人主管
      ...
      If ProSysState = "1" Then '承辦人
         ...
         'Modified by Morgan 2019/3/20 108考核,自我比較評分改±5%(原±5分)
         '數據得分(75)=考核基數得分(20)+發文實績點數達成(20)+發文點數得分(10)+速度考核得分(25)
         '總分=數據得分x(1+自我比較評分%+核稿人評分%)+帶人主管評分(25)
         '季考核得分=總分x(1+部門主管評分%)
         lbl2(23).Caption = Format((((Val(lbl2(10)) + Val(lbl2(16)) + Val(lbl2(18)) + Val(lbl2(28))) * (1 + (Val(lbl2(19)) + Val(tmplbl20)) / 100) + Val(tmplbl21)) * (1 + (Val(lbl2(22)) / 100))), "0.00")
      Else   '繪圖
         If Val(txt1(0).Text) <> 0 Then
            lbl2(7).Caption = Format(Val(txt1(0).Text) / Val(4), "0.00")
         Else
...
Private Function GetColIndex(pFieldName As String)
   ...
   For ii = 0 To .Fields.Count - 1
      If UCase(.Fields(ii).Name) = UCase(pFieldName) Then
         GetColIndex = ii + grd1.FixedCols '第0列為固定列所以要+1
         Exit For
      End If
   Next
   End With
