...
Begin VB.Form frm210111_Img 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   300
      ItemData        =   "frm210111_Img.frx":0000
      Left            =   705
      List            =   "frm210111_Img.frx":000A
      Style           =   2  '單純下拉式
      TabIndex        =   4
      Top             =   180
      Visible         =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "全所"
      TabPicture(0)   =   "frm210111_Img.frx":0020
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Combo2"
      Tab(0).Control(1)=   "MSC1(0)"
      Tab(0).Control(2)=   "Label2"
      Tab(0).ControlCount=   3
      TabCaption(1)   =   "區佔全所比例"
      TabPicture(1)   =   "frm210111_Img.frx":003C
      ...
      TabPicture(2)   =   "frm210111_Img.frx":0058
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "MSC1(4)"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "個人佔該區比例"
      TabPicture(3)   =   "frm210111_Img.frx":0074
      ...
      TabCaption(4)   =   "個人各項比例"
      TabPicture(4)   =   "frm210111_Img.frx":0090
      ...
      Begin VB.ComboBox Combo2 
         Height          =   300
         ItemData        =   "frm210111_Img.frx":00AC
         Left            =   -74235
         List            =   "frm210111_Img.frx":00BF
         Style           =   2  '單純下拉式
         TabIndex        =   10
         Top             =   390
         Width           =   1485
      ...
      Begin MSChart20Lib.MSChart MSC1 
         ...
         Index           =   0
         Left            =   -74925
         OleObjectBlob   =   "frm210111_Img.frx":00D9
         TabIndex        =   2
         Top             =   690
         Width           =   9135
      End
      Begin MSChart20Lib.MSChart MSC1 
         ...
         Index           =   1
         Left            =   -74955
         OleObjectBlob   =   "frm210111_Img.frx":242A
         TabIndex        =   3
         Top             =   690
         Width           =   9135
      End
      Begin MSChart20Lib.MSChart MSC1 
         ...
         Index           =   3
         Left            =   -74955
         OleObjectBlob   =   "frm210111_Img.frx":477B
         TabIndex        =   12
         Top             =   360
         Width           =   9135
      End
      Begin MSChart20Lib.MSChart MSC1 
         ...
         Index           =   2
         Left            =   60
         OleObjectBlob   =   "frm210111_Img.frx":6ACC
         TabIndex        =   14
         Top             =   705
         Width           =   9135
      End
      Begin MSChart20Lib.MSChart MSC1 
         ...
         Index           =   4
         Left            =   -74955
         OleObjectBlob   =   "frm210111_Img.frx":8E1D
         TabIndex        =   16
         Top             =   360
         Width           =   9135
      End
   ...
   End
End
Attribute VB_Name = "frm210111_Img"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2022/01/04 改成Form2.0 ; Combo4
   ...
   Do While Not Calrs.EOF
         If CheckStr(Calrs.Fields(0).Value) = Combo2.Text Then
            If InStr(1, oTotName, "'" & CheckStr(Calrs.Fields(1)) & "'") = 0 And CheckStr(Calrs.Fields(1)) <> "" Then
               ...
               arrValues(1, 2) = Trim(Val(arrValues(1, 2)) + Val(Replace(Calrs.Fields("全所總比例"), "%", "")))
            End If
         End If
      Calrs.MoveNext
   Loop
...
With MSC1(1)
   ...
   Loop
      arrValues(1, 3) = 100 - Val(arrValues(1, 2))
      'add by nickc 2005/09/26 加入判斷誤差 5 / 10000 內
      If Val(arrValues(1, 3)) <= 0.05 Then
         arrValues(1, 2) = "100"
         arrValues(1, 3) = "0"
      End If
      .ChartData = arrValues
...
With MSC1(4)
   ...
   Do While Not Calrs.EOF
         If CheckStr(Calrs.Fields(0)) = Combo2.Text And CheckStr(Calrs.Fields(1).Value) = Combo3.Text Then
            If InStr(1, oTotName, "'" & CheckStr(Calrs.Fields(1)) & "'") = 0 And CheckStr(Calrs.Fields(1)) <> "" Then
               oTotName = oTotName & "'" & CheckStr(Calrs.Fields(1)) & "'"
               arrValues(1, 2) = Trim(Val(arrValues(1, 2)) + Val(Replace(Calrs.Fields("全所業務比例"), "%", "")))
            End If
         End If
      Calrs.MoveNext
   Loop
...
Do While Not Calrs.EOF
   If CheckStr(Calrs.Fields(0)) = Combo2.Text And CheckStr(Calrs.Fields(1)) = Combo3.Text Then
      If InStr(1, oTotName, "'" & CheckStr(Calrs.Fields(2)) & "'") = 0 And CheckStr(Calrs.Fields(2)) <> "" Then
         oTotName = oTotName & "'" & CheckStr(Calrs.Fields(2)) & "'"
      End If
   End If
   Calrs.MoveNext
Loop
...
'   Next i
   ...
   Do While Not Calrs.EOF
         If CheckStr(Calrs.Fields(0)) = Combo2.Text And CheckStr(Calrs.Fields(1)) = Combo3.Text And CheckStr(Calrs.Fields(2).Value) = Combo4.Text Then
            arrValues(1, 2) = Trim(Val(arrValues(1, 2)) + Val(Replace(Calrs.Fields("該區總比例"), "%", "")))
         End If
      Calrs.MoveNext
   Loop
      arrValues(1, 3) = 100 - Val(arrValues(1, 2))
...
If frm210111.txtSalesArea1.Enabled = False And frm210111.txtSalesArea.Enabled = False Then
   SSTab1.TabEnabled(0) = False
   SSTab1.Tab = 1
End If
If frm210111.txtSales.Enabled = False Then
...
'If frm210111.opt1(0).Value = True Then
...
'End If
'Set CalRs = frm210111.grdDataList.Recordset.Clone
'
'Dim TmpArr As Variant
'oTotName = ""
'CalRs.MoveFirst
...
Dim i As Integer
'計算幾個所
Set Calrs = frm210111.Calrs.Clone
