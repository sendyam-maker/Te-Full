...
'Create by Lydia 2015/11/30 CFP常辦國家年費(延展費)預估報價
'Memo by Lydia 2019/07/01 表單名稱:CFP常辦國家年費(延展費)預估報價=>CFP年費預估報價
Option Explicit
...
'            strExc(0) = "select * from pricelistfile where plf01='" & strKEY01 & "'"
