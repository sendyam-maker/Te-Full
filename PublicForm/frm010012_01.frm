...
Begin VB.Form frm010012_01 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "第一頁"
      TabPicture(0)   =   "frm010012_01.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "textTM07"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "textTM06"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "textTM05"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "textTM05_1"
      ...
      Tab(0).Control(28)=   "Label36"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "Label39"
      ...
      Tab(0).Control(33)=   "Label42"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "Label43"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "Label44"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "textCP14_2"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "textCP13_2"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "textCP56_2"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "textSP59_2"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "textSP58_2"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "textTM44_2"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "textTM23_2"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "textTM80_2"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "textTM81_2"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "textCP89_2"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "textCP90_2"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "textCP91_2"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "textCP92_2"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "textCP05"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "textSP59"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "textSP58"
      Tab(0).Control(51).Enabled=   0   'False
      Tab(0).Control(52)=   "cmdNation"
      Tab(0).Control(52).Enabled=   0   'False
      Tab(0).Control(53)=   "textTM45"
      Tab(0).Control(53).Enabled=   0   'False
      Tab(0).Control(54)=   "textTM44"
      Tab(0).Control(54).Enabled=   0   'False
      Tab(0).Control(55)=   "textTM23"
      Tab(0).Control(55).Enabled=   0   'False
      Tab(0).Control(56)=   "textTM29"
      Tab(0).Control(56).Enabled=   0   'False
      Tab(0).Control(57)=   "textCP43"
      Tab(0).Control(57).Enabled=   0   'False
      Tab(0).Control(58)=   "textCP26"
      Tab(0).Control(58).Enabled=   0   'False
      Tab(0).Control(59)=   "textTM28"
      Tab(0).Control(59).Enabled=   0   'False
      Tab(0).Control(60)=   "textTM10_2"
      Tab(0).Control(60).Enabled=   0   'False
      Tab(0).Control(61)=   "textTM08_2"
      Tab(0).Control(61).Enabled=   0   'False
      Tab(0).Control(62)=   "textTM08"
      Tab(0).Control(62).Enabled=   0   'False
      Tab(0).Control(63)=   "textCP13"
      Tab(0).Control(63).Enabled=   0   'False
      Tab(0).Control(64)=   "textTM10"
      Tab(0).Control(64).Enabled=   0   'False
      Tab(0).Control(65)=   "textCP06"
      Tab(0).Control(65).Enabled=   0   'False
      Tab(0).Control(66)=   "textCP07"
      Tab(0).Control(66).Enabled=   0   'False
      Tab(0).Control(67)=   "textCP10_2"
      Tab(0).Control(67).Enabled=   0   'False
      Tab(0).Control(68)=   "textCP10"
      Tab(0).Control(68).Enabled=   0   'False
      Tab(0).Control(69)=   "textCP14"
      Tab(0).Control(69).Enabled=   0   'False
      Tab(0).Control(70)=   "textCP56"
      Tab(0).Control(70).Enabled=   0   'False
      Tab(0).Control(71)=   "textTM80"
      Tab(0).Control(71).Enabled=   0   'False
      Tab(0).Control(72)=   "textTM81"
      Tab(0).Control(72).Enabled=   0   'False
      Tab(0).Control(73)=   "textCP89"
      Tab(0).Control(73).Enabled=   0   'False
      Tab(0).Control(74)=   "textCP90"
      Tab(0).Control(74).Enabled=   0   'False
      Tab(0).Control(75)=   "textCP91"
      Tab(0).Control(75).Enabled=   0   'False
      Tab(0).Control(76)=   "textCP92"
      Tab(0).Control(76).Enabled=   0   'False
      Tab(0).Control(77)=   "grdList"
      Tab(0).Control(77).Enabled=   0   'False
      Tab(0).ControlCount=   78
      TabCaption(1)   =   "第二頁"
      TabPicture(1)   =   "frm010012_01.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "textTM34"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "textTM35"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "textTM89"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "textTM93"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "textTM85"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "textTM88"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "textTM92"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "textTM84"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "textTM87"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "textTM91"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "textTM83"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "textTM86"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "textTM90"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "textTM82"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "textTM26"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "textTM25"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "textTM24"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "Label58"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "Label57"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "Label56"
      ...
      Tab(1).Control(26)=   "Label48"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "Label47"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "Label46"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "Label17"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "Label18"
      Tab(1).Control(30).Enabled=   0   'False
      Tab(1).Control(31)=   "Label19"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "Label20"
      Tab(1).Control(32).Enabled=   0   'False
      Tab(1).Control(33)=   "Label38"
      Tab(1).Control(33).Enabled=   0   'False
      Tab(1).ControlCount=   34
      TabCaption(2)   =   "第三頁"
      TabPicture(2)   =   "frm010012_01.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "textCP18"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).Control(1)=   "textCP17"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "textCP16"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "cmdPriority"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "textTM09"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "textTM22S"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).Control(6)=   "textTM21S"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "textSP32"
      Tab(2).Control(7).Enabled=   0   'False
      Tab(2).Control(8)=   "textTM32"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "textCP64"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "textTM58"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "textTM05S"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "Label60"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "Label23(2)"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "Label59"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).Control(15)=   "Label32"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "Label31"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "Label30"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "Label29"
      Tab(2).Control(18).Enabled=   0   'False
      Tab(2).Control(19)=   "Line1"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "Label28"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "Label24"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "Label21"
   ...
   Begin VB.Label Label35 
      AutoSize        =   -1  'True
      Caption         =   "T及TS的商品類別請輸在第二頁的""案件備註""欄內!!!"
      BeginProperty Font 
         Name            =   "新細明體"
         Size            =   10.2
         Charset         =   136
   ...
   End
End
Attribute VB_Name = "frm010012_01"
...
'Memo by Morgan 2021/5/11 改成Form2.0 (textTM89 ,textTM93 ...)
...
'2008/11/12 END
'Added by Lydia 2015/10/29
'Dim m_CP20 As String 'Modify By Sindy 2016/6/29 Mark
...
Private Sub cmdCaseProgress_Click()
   ...
   'frm010012_03.SetParent "frm010012_01"
...
Private Sub cmdNation_Click()
   ModifyAssignCountry m_strCountry
End Sub
...
'      'OnSaveData
      ...
      If textCP10 = "204" Or textCP10 = "205" Then
         ...
         If textCP06 <> "" And textCP07 <> "" And textTM10 = "000" Then
            '2008/11/12 ADD BY SONIA textCP43
            ...
            'frm880005.txtEmail(1).Text = "開庭通知--內部收文案件：" & m_TM01 & "-" & m_TM02 & "-" & m_TM03 & "-" & m_TM04
            ...
            m_StrSub = frm880005.txtEmail(1).Text = "開庭通知--內部收文案件：" & m_TM01 & "-" & m_TM02 & "-" & m_TM03 & "-" & m_TM04
            m_StrCont = "本所案號：" & m_TM01 & "-" & m_TM02 & "-" & m_TM03 & "-" & m_TM04 & vbCrLf & _
                                          ...
                                          "法院案號：" & m_CP43CP08 & vbCrLf & _
                                          "律　　師：" & t_CP43CP110
            m_strCP09 = PUB_GetLastABKindCP09(m_TM01, m_TM02, m_TM03, m_TM04)
      ...
      If (Left(m_TM01, 1) = "T" Or m_TM01 = "S") And textCP10 <> "" And InStr(textCP10_2, "補收款") > 0 And Left(GetST15(textCP13), 1) = "S" Then
...
'   textTM07S.BackColor = &H8000000F
   ...
   'textCP57.BackColor = &H8000000F
    'Added by Lydia 2015/10/29 原第2頁隱藏,第3頁改為第2頁
   SSTab1.TabVisible(1) = False
   SSTab1.TabCaption(2) = "第二頁"
...
'   textTM07S = Empty
   ...
   m_strCountry = Empty
    ...
    textCP17 = Empty
    textCP18 = Empty
'    m_CP20 = Empty 'Modify By Sindy 2016/6/29 Mark
End Sub
...
'      SetTMSPFieldOldData "TM07", textTM07, 0
      ...
      'm_strCust2 = ""
      'm_strCust3 = ""
      m_strCust2 = "" & textSP58.Text
      m_strCust3 = "" & textSP59.Text
      m_strCust4 = "" & textTM80.Text
      m_strCust5 = "" & textTM81.Text
...
'      End If
      ...
      If IsNull(rsTmp.Fields("SP66")) = False Then
         ...
         textTM81_Validate False
      End If
      m_strCust2 = "" & Me.textTM80.Text
      m_strCust3 = "" & Me.textTM81.Text
      m_TM80 = textTM80
      m_TM81 = textTM81
...
Private Sub QueryCaseProgressWithNewCP()
   ...
   'Added by Lydia 2015/10/29 +費用,規費,點數
   ...
   ' 標準價
   'SetCPFieldOldData "CP33", Empty, 1  91.11.10 cancel by sonia
   ' 底價
   'SetCPFieldOldData "CP34", Empty, 1  91.11.10 cancel by sonia
   ...
   ' 取消收文日期
   SetCPFieldOldData "CP57", Empty, 1
   '收據編號
...
Private Sub QueryCaseProgress()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      If IsNull(rsTmp.Fields("CP05")) = False Then
         ...
         'add by Toni 2008/11/05
         textCP05.Tag = TAIWANDATE(rsTmp.Fields("CP05"))
         'end 2008/11/05
      End If
      ...
      'Modify By Sindy 2016/6/29 Mark
'      m_CP20 = CheckStr(rsTmp.Fields("CP20"))
'      SetCPFieldOldData "CP20", m_CP20, 0
...
Public Sub QueryData()
   ...
   'End Select
    If m_TM01 = "TM" Then
        EnableTextBox textSP32, True
        textSP32.Enabled = True
    Else
        EnableTextBox textSP32, False
        textSP32.Enabled = False
    End If
...
Private Sub textCP10_Validate(Cancel As Boolean)
   ...
   If IsEmptyText(textCP10) = False Then
      ...
      'Add By Sindy 2025/8/19 僅T台灣"補充理由"案件才控管
      If m_TM01 = "T" And textTM10 = "000" And textCP10 = "612" Then
         '行政訴訟案件(案件性質:403行政訴訟、407參加訴訟)，智權人員填寫接洽單收文時，有指定後續補充理由為：A類收文或B類收文。
         '若選擇A類收文，專業部不可自行作B類內部收文。
         strSql = "select crc14 from caseprogress,consultrecordlist,consultrecCMP" & _
                  " where cp01='" & m_TM01 & "' and cp02='" & m_TM02 & "' and cp03='" & m_TM03 & "' and cp04='" & m_TM04 & "'" & _
                  " and cp140=crl01(+) and crl01 is not null and crl02<=" & DBDATE(textCP05) & _
                  " and crl01=crc01 and crc03 in('403','407') and crc14 is not null" & _
                  " order by crc01 desc"
         intI = 1
         Set RsTemp = ClsLawReadRstMsg(intI, strSql)
         If intI = 1 Then
            If RsTemp.Fields(0) = "A" Then
               Cancel = True
               strTit = "檢核資料"
               strMsg = "因智權人員前已選擇補充理由做A類收文，不可自行作B類內部收文！"
               nResponse = MsgBox(strMsg, vbOKOnly, strTit)
               textCP10_GotFocus
            End If
         End If
...
'      '2010/5/04 外商輸入T案且為回覆代理人720或告知代理人719時,設定智權人員為輸入之承辦人
'      If m_TM01 = "T" And Mid(Pub_StrUserSt03, 1, 2) = "F1" And (m_CP10 = "719" Or m_CP10 = "720") Then
'         textCP13.Text = textCP14
'         textCP13_2.Text = textCP14_2
'      End If
'      '2010/5/04 End
'end 2023/5/23
   ...
   Else
      If m_TM01 & m_TM02 <> "TT999999" Then 'add by sonia 2020/5/19 TT-999999不檢查
         Cancel = True
         strTit = "資料檢核"
         strMsg = "承辦人不可空白"
         nResponse = MsgBox(strMsg, vbOKOnly, strTit)
...
Private Sub textCP56_Validate(Cancel As Boolean)
   ...
   If Not IsEmptyText(textCP56) Then
      ...
      End If
   End If
   If Cancel = True Then textCP56_GotFocus
End Sub
...
Private Sub textCP89_Validate(Cancel As Boolean)
   ...
   If Not IsEmptyText(textCP89) Then
      ...
      End If
   End If
   If Cancel = True Then textCP89_GotFocus
End Sub
...
Private Sub textCP90_Validate(Cancel As Boolean)
   ...
   If Not IsEmptyText(textCP90) Then
      ...
      End If
   End If
   If Cancel = True Then textCP90_GotFocus
End Sub
...
Private Sub textCP91_Validate(Cancel As Boolean)
   ...
   If Not IsEmptyText(textCP91) Then
      ...
      End If
   End If
   If Cancel = True Then textCP91_GotFocus
End Sub
...
'            SetCPFieldNewData "CP07", (Val(GetCF08(m_TM01, m_TM10, Me.textCP10.Text)) * 2)
   ...
   ' 是否向客戶收款
   'Modified by Lydia 2015/10/29
   'SetCPFieldNewData "CP20", "N"
   SetCPFieldNewData "CP16", textCP16
   SetCPFieldNewData "CP17", textCP17
   SetCPFieldNewData "CP18", textCP18
   
   'Modify By Sindy 2016/6/29 畫面上有'費用'欄, 且畫面沒有'是否向客戶收款'欄時,
   '存檔時檢查若有輸入費用時, '是否向客戶收款'欄存 NULL,  CP32是否開電腦收據 存NULL
   '            未輸入費用時, '是否向客戶收款'欄存 'N', CP32是否開電腦收據 存'N' .
'   SetCPFieldNewData "CP20", m_CP20
'   ' 是否開電腦收據
'   SetCPFieldNewData "CP32", "N"
   ...
   ' 標準價
   'SetCPFieldNewData "CP33", Empty  91.11.10 cancel by sonia
   ' 底價
   'SetCPFieldNewData "CP34", Empty  91.11.10 cancel by sonia
   'Dim nick911018rs As New ADODB.Recordset
   'Dim nickstrsql As String
   'nickstrsql = "select cf13,cf14 from casefee where cf01='" & m_TM01 & "' and cf02='" & textTM10 & "' and cf03='" & textCP10 & "' "
   'Set nick911018rs = New ADODB.Recordset
   'nick911018rs.CursorLocation = adUseClient
   'nick911018rs.Open nickstrsql, cnnConnection, adOpenStatic, adLockReadOnly
   'If nick911018rs.RecordCount <> 0 Then
   '    If Not IsNull(nick911018rs.Fields("CF13").Value) Then
   '         SetCPFieldNewData "CP33", nick911018rs.Fields("CF13").Value
   '    End If
   '    If Not IsNull(nick911018rs.Fields("CF14").Value) Then
   '         SetCPFieldNewData "CP34", nick911018rs.Fields("CF14").Value
   '    End If
   'End If
   '***** end
   '91.11.10 end
   ...
   End If
   'add by nickc 2006/12/01 移轉申請人2
   If Not IsEmptyText(textCP89) Then
...
'            SetTMSPFieldNewData "TM07", textTM07
      ...
      Case Else:
        ...
        End Select
         ...
         Else
            SetTMSPFieldNewData "SP08", Empty
         End If
         If m_TM01 = "TC" Then
            ' 申請人2
...
OnUpdateTradeMark = True
   ...
   'Modify By Sindy 2009/10/23 在OnUpdateField已有此段程式, 重覆了!!
'   '911018 nick 錯誤，不能檢查是否有申請人，應該要檢查是否有異動
'   '***** start
'    SetTMSPFieldNewData "TM24", textTM24
'    SetTMSPFieldNewData "TM25", textTM25
'    SetTMSPFieldNewData "TM26", textTM26
...
'         OnUpdateServicePractice
   ...
   'Modify By Sindy 2009/10/23 不更新基本檔原申請人
''add by nickc 2007/01/10
...
'   objPublicData.SavePriority m_Pa, m_Priority(1), m_Priority(2), m_Priority(3)
   ...
   Select Case textCP10
      ...
      Case "719":
         If Mid(Pub_StrUserSt03, 1, 2) = "F1" Then
            strSql = "UPDATE CaseProgress SET CP27 = " & DBDATE(SystemDate()) & " " & _
                     "WHERE CP09 = '" & m_CP09 & "' "
            cnnConnection.Execute strSql
         End If
   ...
   '''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   ' 計算承辦期限
''edit by nickc 2007/10/11 抓有時效的
''   strDay = Empty
...
''      strDate = DBDATE(CompWorkDay(Val(strDay), DBDATE(textCP05), 0))
  strDate = Pub_GetHandleDay(m_TM01, textTM10, textCP10, DBDATE(textCP05))
  If Trim(strDate) <> "" Then
      strSql = "UPDATE CaseProgress SET CP48 = " & CNULL(strDate) & " " & _
               "WHERE CP09 = '" & m_CP09 & "' "
      cnnConnection.Execute strSql
   End If
   'Added by Lydia 2019/04/11 T台灣案(包含中間程序)內部收文排除齊備日管制(預設文件齊備=Y)
   If m_TM01 = "T" And textTM10 = "000" Then
   ...
   If m_TM03 = "0" And m_TM04 = "00" Then
      ' 系統類別為TF類
      Select Case m_TM01
'2005/12/26 CANCEL BY SONIA 分案於2005/8/10取消
'         Case "T", "FCT":
...
Dim ii As Integer
   ...
   CheckDataValid = False
    'Add By Cheng 2003/01/06
    'modify by sonia 2020/5/19 TT-999999不檢查
    If Me.textCP14.Text = "" And m_TM01 & m_TM02 <> "TT999999" Then
   ...
   'modify by sonia 2020/5/19 TT-999999不檢查
   If IsEmptyText(strTemp) = True And m_TM01 & m_TM02 <> "TT999999" Then
      strTit = "資料檢核"
      strMsg = "承辦人代號不存在"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      textCP14.SetFocus
...
'         strMsg = "案件性質為延展, 法定期限不可為空白"
   ...
   '2008/11/05 add by Toni
   ' 案件性質為204 and 205 法定期限, 本所期限要同時有資料
   If textCP10 = "204" Or textCP10 = "205" Then
   ...
   '91.11.3 END
    ...
    '檢查案件名稱
    If Me.textTM05_1.Enabled = True And Me.textTM05_1.Text = "" Then
   ...
   'Added by Lydia 2015/10/26
    If Me.textCP17.Enabled = True And Me.textCP16.Enabled = True Then
       textCP17_Validate False
    End If
...
Private Sub textTM23_Validate(Cancel As Boolean)
   ...
   Cancel = False
   '911018 nick 因為申請人早就不能輸入，所以不用檢查  請查 QueryData
   '***** start
   'textTM23_2 = Empty
   ...
   '         End If
   '      End If
   '      '911018 nick 當沒有收據和請款編號時，若有更動申請人，則更新申請地址
   '      Dim nIndex As Integer
   '      If Len(m_CP60) = 0 Then
   '         For nIndex = 0 To m_TMSPCount - 1
   '            If m_TMSPList(nIndex).fiName = "TM23" Then
   '                 If m_TMSPList(nIndex).fiOldData <> textTM23 Then
   '                     Dim nick911018RS As New ADODB.Recordset
   '                     Dim nickstrsql As String
   '                     Set nick911018RS = New ADODB.Recordset
   '                     nickstrsql = "select cu23,cu24||' '||cu25||' '||cu26||' '||cu27||' '||cu28,cu29 from customer where cu01='" & Mid(textTM23, 1, 8) & "' and cu02='" & Mid(textTM23, 9, 1) & "' "
   '                     nick911018RS.CursorLocation = adUseClient
   '                     nick911018RS.Open nickstrsql, cnnConnection, adOpenStatic, adLockReadOnly
   '                     If nick911018RS.RecordCount <> 0 Then
   '                         textTM24 = CheckStr(nick911018RS.Fields(0).Value)
   '                         textTM25 = CheckStr(nick911018RS.Fields(1).Value)
   '                         textTM26 = CheckStr(nick911018RS.Fields(2).Value)
   '                     End If
   '                 End If
   '             End If
   '         Next nIndex
...
Private Sub textTM44_Validate(Cancel As Boolean)
   ...
   If IsEmptyText(textTM44) = False Then
      ...
      If PUB_GetAgentNameAndState(m_TM01, textTM44.Text, strTempName) Then
...
Private Function ValidateInput() As Boolean
   ...
   '911112 nick
   If Me.textTM35.Enabled = True Then
        Cancel = False
        'textTM35_Validate Cancel
        If Cancel = True Then
           Exit Function
        End If
   End If
...
'   m_CP20 = "N" 'Modify By Sindy 2016/6/29 Mark
   If textCP16.Text <> "" Or textCP17.Text <> "" Then
      textCP18.Text = Format((Val(textCP16) - Val(textCP17)) / 1000, "0.0")
      'Modify By Sindy 2016/6/29 Mark
