...
Private Sub Form_Load()
    '電腦中心才顯示是否公布及每日每月批次
    If Pub_StrUserSt03 = "M51" Or Pub_StrUserSt03 = "" Then
...
Dim strSql As String
   ...
   If strSrvDate(1) >= 新部門啟用日 Then
      strSql = "SELECT BU01, BU03,BU04,BU05,BU14,BU06,BU07,BU02,ST02,ST03,BU08,BU09,BU10,BU11,BU12,BU13,NVL(A0922,A0902) AS CDEPT " & _
   ...
   Else
   'end 2023/12/25
      strSql = "SELECT BU01, BU03,BU04,BU05,BU14,BU06,BU07,BU02,ST02,ST03,BU08,BU09,BU10,BU11,BU12,BU13 FROM PGMBulletin,STAFF " & _
   ...
   Text2.Text = IIf(rsTmp(7) <= 9, Format(Val(rsTmp(7)), "00"), rsTmp(7)) '流水號
    Label2(1).Caption = rsTmp(8) '需求人員名稱
    'Added by Lydia 2023/12/25
    If strSrvDate(1) >= 新部門啟用日 Then
       Label2(2).Caption = IIf("" & rsTmp.Fields("cdept") = "", "" & rsTmp.Fields("st03"), "" & rsTmp.Fields("cdept"))
    Else
    'end 2023/12/25
       Label2(2).Caption = IIf(ClsPDGetStaffDeptName(rsTmp(9), strTmp), strTmp, "") '需求部門名稱
    End If
   RedSystemKind IIf(IsNull(rsTmp(6)), "", rsTmp(6)) '系統別
   End If
   ...
   strExc(0) = "Select  ibf01 From ImgByteFile Where IBF01='" & m_ibf01 & "' And IBF02='" & m_ibf02 & "' And IBF03='0' And IBF04='00'"
...
Private Sub TxtClear()
   ...
   For Each txt In frm100131_2.Text1
      txt.Text = ""
   Next
   Text2.Text = "" '流水號
