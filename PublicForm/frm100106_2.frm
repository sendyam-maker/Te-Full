...
Begin VB.Form frm100106_2 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   300
      ItemData        =   "frm100106_2.frx":0000
      Left            =   5970
      List            =   "frm100106_2.frx":001C
      Style           =   2  '單純下拉式
      TabIndex        =   13
      Top             =   390
      Width           =   3195
...
Dim m_strFACUData  As String '判斷是否要列印代理人及客戶資料
...
Dim m_blnExportFile As Boolean '是否產生電子檔
'Add By Cheng 2003/05/23
Dim m_blnSales As Boolean '使用者為智權人員等級
...
Dim colDDate1 As Integer, colDDate2 As Integer, colDDate3 As Integer  'DDate1=法限、DDate2=所限、DDate3=延期日
Dim colSalesName As Integer, colCP27 As Integer
Dim colCP05 As Integer, colPA10name As Integer, colPA11 As Integer, colCP14name As Integer
...
Private Sub Form_Load()
   ...
   cmdState = -1
   '設定操作功能權限
   Me.cmdOK(6).Enabled = IsUserHasRightOfFunction("frm100106_2", strPrint, False)
   Me.cmdOK(7).Enabled = IsUserHasRightOfFunction("frm100106_1", strPrint, False)
   m_blnColOrderAsc = True 'Add By Sindy 2014/4/2
End Sub

'Modified by Lydia 2021/05/19 更名為SetDataListWidth_old
Private Sub SetDataListWidth_old()

   Dim arrGridHeadText, arrGridHeadWidth
   Dim iRow As Integer
   
   'Modified by Lydia 2019/11/01 +申請人1~5(cust01~cust05),FC代理人;
   'arrGridHeadText = Array("V", "法定期限", "進度備註", "本所案號", "分所號", "案件名稱" _
                     , "案件性質", "承辦人", "智權人員", "收文日", "本所期限" _
                     , "申請人", "是否出名", "延期日", "申請國家", "申請人國籍" _
                     , "發文日", "代理人", "彼所案號", "申請案號", "承辦人備註" _
                     , "取消收文日", "", "", "", "", "")
   'StrMenu: NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort,PA76,pa75,pa26
   ', AA.NP10 AS NP10, AA.NP01 AS NP01, AA.np22 AS NP22, AA.NP02 AS NP02, AA.NP07 AS NP07,AA.FSort as FSort
   '_Sub1: ,cp13,cp09, CP01, CP10,PA76,pa75,pa26
   '_Sub2: ,cp13,cp09, CP01, CP10,PA76,pa75,pa26
   ', AA.NP10 AS NP10, AA.NP01 AS NP01, AA.np22 AS NP22, AA.NP02 AS NP02, AA.NP07 AS NP07,AA.FSort as FSort
   arrGridHeadText = Array("V", "本所期限", "本所案號", "分所號", "案件名稱" _
                     , "案件性質", "承辦人", "智權人員", "收文日", "法定期限", "進度備註" _
                     , "申請人", "是否出名", "延期日", "申請國家", "申請人國籍" _
                     , "發文日", "代理人", "彼所案號", "申請案號", "承辦人備註" _
                     , "取消收文日", "NP10", "NP01", "NP22", "NP02", "NP07" _
                     , "FSort", "CUST01", "CUST02", "CUST03", "CUST04", "CUST05", "FCNO")
   If bolFNation = False Then
      'Modified by Lydia 2019/11/01
      'arrGridHeadWidth = Array(200, 810, 810, 13000, 0, 800 _
                        , 800, 750, 750, 810, 810 _
   ...
   Else
      'Modified by Lydia 2019/11/01
      'arrGridHeadWidth = Array(200, 810, 810, 1300, 0, 800 _
                        , 800, 750, 750, 810, 810 _
                        , 1000, 800, 810, 800, 1000 _
...
'Added by Lydia 2021/05/19 重新比對欄位
Private Sub SetDataListWidth(Optional ByVal bolReset As Boolean = True)

Dim arrGridHeadText, arrGridHeadWidth
Dim iRow As Integer
  
  '"V","法定期限","進度備註","本所案號","分所號","案件名稱","案件性質","承辦人","智權人員","收文日","本所期限10","申請人","是否出名","延期日","申請國家","申請人國籍","發文日","代理人","彼所案號","申請案號","承辦人備註20","取消收文日","CP13","CP09","CP66","CP01","CP10","NP07","FSORT","CUST01","CUST02-30","CUST03","CUST04","CUST05","FCNO"
    arrGridHeadText = Array("V", "法定期限", IIf(frm100106_1.opt2(0).Value = True, "備註", "進度備註"), "本所案號", "分所號", "案件名稱", _
                 "案件性質", "承辦人", "智權人員", "收文日", "本所期限", _
                 "申請人", "是否出名", "延期日", "申請國家", "申請人國籍", _
                 "發文日", "代理人", "彼所案號", "申請案號", "承辦人備註", _
                 "取消收文日", "CP13", "CP09", "CP66", "CP01", _
                 "CP10", "NP07", "FSORT", "APPLYNO", "CUST01", _
                 "CUST02", "CUST03", "CUST04", "CUST05", "FCNO")
   'ApplyNo=顯示的申請人編號
   If bolFNation = False Then
      arrGridHeadWidth = Array(200, 810, 1300, 1200, 800, 1300 _
                        , 900, 810, 810, 810, 810 _
                        , 1000, 800, 810, 800, 810 _
                        , 810, 0, 810, 810, 1000 _
                        , 1035, 0, 0, 0, 0 _
                        , 0, 0, 0, 0, 0 _
                        , 0, 0, 0, 0, 0)
   ...
   For iRow = 0 To grdDataList.Cols - 1
      ...
      grdDataList.CellAlignment = flexAlignCenterCenter
   Next
   strExc(1) = PUB_GetST06(strUserNum)
   '電腦中心，跟分所才秀
   If Pub_StrUserSt03 <> "M51" And pub_strUserOffice = "1" Then
       grdDataList.ColWidth(4) = 0
   Else
       grdDataList.ColWidth(4) = 620
   End If
   ...
   If colCp09 = 0 Then
        colCp09 = PUB_MGridGetId("CP09", grdDataList) '收文號 CP09 / NP01
        colCP66 = PUB_MGridGetId("CP66", grdDataList) 'CP66 / NP22
        colCP10 = PUB_MGridGetId("CP10", grdDataList) 'CP10 / NP07
        ...
        colCP13 = PUB_MGridGetId("CP13", grdDataList)  'CP13 / NP10
        colCP01 = PUB_MGridGetId("CP01", grdDataList) '系統別
        
        colDDate1 = PUB_MGridGetId("法定期限", grdDataList)
           ...
           For i = 1 To grdDataList.Rows - 1
              ...
              If Trim(grdDataList.Text) = "V" Then
                  ...
                  If Len(Trim(StrTag)) <> 0 Then
                     ...
                     'If Left(StrTag, 1) = "*" Or Left(StrTag, 1) = "#" Or Left(StrTag, 1) = "v" Then
                     ...
                     'If Left(StrTag, 1) = "*" Or Left(StrTag, 1) = "#" Or LCase(Left(StrTag, 1)) = "v" Or Left(StrTag, 1) = "!" Or Left(StrTag, 1) = "&" Then
                     ...
                     If Not IsNull(StrTag) Then
                          If fnSaveParentForm(Me) = False Then
                             ...
                             Exit Sub
                          End If
                        'Modified by Lydia 2021/05/19 改用變數取得: 9=>colCP05 (收文日)
                        grdDataList.col = colCP05
                        StrR03008 = grdDataList.Text
                        'Modified by Lydia 2021/05/19 改用變數取得: 6=>colCp10Name (案件性質)
                        grdDataList.col = colCp10Name
                        StrR03009 = grdDataList.Text
                        'Modified by Lydia 2021/05/19 改用變數取得: 1=>colDDate2 (所限)
                        grdDataList.col = colDDate2
                        StrR03011 = grdDataList.Text
                        'Modified by Lydia 2021/05/19 改用變數取得: 10=>colDDate1(法限)
                     ...
                     Call StrMenu2
                      If Not IsNull(StrTag) Then
                        If fnSaveParentForm(Me) = False Then
                           ...
                           Exit Sub
                        End If
                        'Modify by Morgan 2008/12/8 需判斷有無分所案
                        'Modifid by Lydia 2021/05/19 改模組取得
'                        If grdDataList.TextMatrix(0, 4) = "案件名稱" Then
...
'                        ElseIf grdDataList.TextMatrix(0, 5) = "案件名稱" Then
'                           StrToMail(2) = grdDataList.TextMatrix(i, 5)
'                           StrToMail(3) = grdDataList.TextMatrix(i, 9)
'                           StrToMail(4) = grdDataList.TextMatrix(i, 6)
'                           StrToMail(5) = grdDataList.TextMatrix(i, 10)
'                           StrToMail(6) = grdDataList.TextMatrix(i, 1)
'                        End If
                        StrToMail(2) = grdDataList.TextMatrix(i, colCaseName)  '案件名稱
                        StrToMail(3) = grdDataList.TextMatrix(i, colCP05)  '收文日
                        StrToMail(4) = grdDataList.TextMatrix(i, colCp10Name)  '案件性質
                        StrToMail(5) = grdDataList.TextMatrix(i, colDDate2)   '本所期限
                        StrToMail(6) = grdDataList.TextMatrix(i, colDDate1) '法定期限
                        'end 2021/05/19
                        
                        'Modify by Morgan 2008/12/24 費用等空的欄位不庇蔭
                        ' frm100106_4.txt1(1) = "           本所案號：" + StrToMail(1) + vbCrLf + vbCrLf + _
                                               "           案件名稱：" + StrToMail(2) + vbCrLf + vbCrLf + _
                                               "           收 文 日：" + StrToMail(3) + Space(30 - Len(StrToMail(3))) + "案件性質：" + StrToMail(4) + vbCrLf + vbCrLf + _
                                               "           費    用：" + "                     " + vbTab + vbTab + vbTab + "規費：" + "                     " + vbTab + vbTab + vbTab + "點數：" + "" + vbCrLf + vbCrLf + _
                         ...
                         'Add by Morgan 2007/1/10
                        'Modifid by Lydia 2021/05/19 改變數取得
                        'If grdDataList.TextMatrix(0, 6) = "承辦人" Then
                        '   frm100106_4.strCP09 = grdDataList.TextMatrix(i, 22)
                        'Else
                        '   frm100106_4.strCP09 = grdDataList.TextMatrix(i, 23)
                        'End If
                        ' 'end 2007/1/10
      ...
      Case 7 '產生管制表電子檔
          ...
          If Me.grdDataList.Rows > 1 Then
              strFileName = InputBox("請輸入欲匯出的檔案名稱(不可指定路徑)？" & vbCrLf & vbCrLf & "檔案存放位置為==> My Documents 或 我的文件夾 " & vbCrLf & vbCrLf & "(註：檔案名稱若重複，新資料會加在原檔案之後！)")
...
Public Function StrMenu() As Boolean
   ...
   'Added by Lydia 2019/11/18 for 申請人1~5用
   ...
   Me.Enabled = False
   StrS = ""
   LBL1(0).Caption = frm100106_1.txt2(0)
   LBL1(1).Caption = IIf(Len(frm100106_1.txt2(1).Text) > 0, frm100106_1.txt2(1).Text, ServerDate - 19110000)
   ...
   If frm100106_1.opt2(0).Value = True Then     '未收文
       ...
       If Len(Trim(frm100106_1.txt2(0))) <> 0 Then
           strSQL1 = strSQL1 + " AND NP09>=" & Val(ChangeTStringToWString(frm100106_1.txt2(0))) & " "
       End If
       pub_QL05 = pub_QL05 & ";" & frm100106_1.opt1(1).Caption & frm100106_1.txt2(0) 'Add By Sindy 2010/01/22
       If Len(Trim(frm100106_1.txt2(1))) <> 0 Then
           strSQL1 = strSQL1 + " AND NP09<=" & Val(ChangeTStringToWString(frm100106_1.txt2(1))) & " "
           pub_QL05 = pub_QL05 & "-" & frm100106_1.txt2(1) 'Add By Sindy 2010/01/22
       '若未輸入則以系統日代替
       Else
           strSQL1 = strSQL1 + " AND NP09<=" & Val(ChangeTStringToWString(ServerDate - 19110000)) & " "
           pub_QL05 = pub_QL05 & "-" & (ServerDate - 19110000) 'Add By Sindy 2010/01/22
       End If
       ...
       If Len(Trim(frm100106_1.txt5(0))) <> 0 Then
         ...
         End If 'Added by Morgan 2015/10/20
            ...
            pub_QL05 = pub_QL05 & ";" & frm100106_1.Label1(4) & frm100106_1.txt5(0)  'Add By Sindy 2010/01/22
       End If
...
'---------end 2019/11/18
      ...
      If Len(Trim(frm100106_1.txt5(11).Text)) + Len(Trim(frm100106_1.txt5(12).Text)) <> 0 Then
         ...
         '2010/9/13 MODIFY BY SONIA 日期欄改百年日期排序問題
         'Modify by Amy 2018/09/20 申請人資料全顯示不限制字數 原:SUBSTRB(NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)),1,10)
         'Modified by Lydia 2019/11/01 +增加欄位SeColPA,SeColSP; PA26,SP08 => ApplyNo
         strSql = "SELECT '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(pa23,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP07,'411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort,PA76,pa75 " & _
                  ",PA26 as ApplyNo " & SeColPA & " FROM NEXTPROGRESS,CASEPROGRESS,PATENT,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                  " WHERE (PA57<>'Y' or pa57 is null) AND NP02=PA01(+) AND NP03=PA02(+) AND NP04=PA03(+) AND NP05=PA04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(PA26,1,8)=CU01(+) AND SUBSTR(PA26||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL1 & _
          ...
          strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP07,'411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort,NULL,sp26 " & _
                   ",SP08 as ApplyNo " & SeColSP & " FROM NEXTPROGRESS,CASEPROGRESS,SERVICEPRACTICE,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
      ...
      Else
         ...
         strSql = "SELECT '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(pa23,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FCP411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                  ", PA26 as ApplyNo " & SeColPA & " FROM NEXTPROGRESS,CASEPROGRESS,PATENT,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                  " WHERE (PA57<>'Y' or pa57 is null) AND NP02=PA01(+) AND NP03=PA02(+) AND NP04=PA03(+) AND NP05=PA04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(PA26,1,8)=CU01(+) AND SUBSTR(PA26||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL1 & _
                  " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                  " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
         ...
         If Len(Trim(frm100106_1.txt4(0))) <> 0 Then
                strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(pa23,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FCP411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", PA27 as ApplyNo " & SeColPA & " FROM NEXTPROGRESS,CASEPROGRESS,PATENT,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (PA57<>'Y' or pa57 is null) AND NP02=PA01(+) AND NP03=PA02(+) AND NP04=PA03(+) AND NP05=PA04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(PA27,1,8)=CU01(+) AND SUBSTR(PA27||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(1) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(pa23,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FCP411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", PA28 as ApplyNo " & SeColPA & " FROM NEXTPROGRESS,CASEPROGRESS,PATENT,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (PA57<>'Y' or pa57 is null) AND NP02=PA01(+) AND NP03=PA02(+) AND NP04=PA03(+) AND NP05=PA04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(PA28,1,8)=CU01(+) AND SUBSTR(PA28||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(2) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(pa23,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FCP411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", PA29 as ApplyNo " & SeColPA & " FROM NEXTPROGRESS,CASEPROGRESS,PATENT,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (PA57<>'Y' or pa57 is null) AND NP02=PA01(+) AND NP03=PA02(+) AND NP04=PA03(+) AND NP05=PA04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(PA39,1,8)=CU01(+) AND SUBSTR(PA39||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(3) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(pa23,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FCP411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", PA30 as ApplyNo " & SeColPA & " FROM NEXTPROGRESS,CASEPROGRESS,PATENT,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (PA57<>'Y' or pa57 is null) AND NP02=PA01(+) AND NP03=PA02(+) AND NP04=PA03(+) AND NP05=PA04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(PA30,1,8)=CU01(+) AND SUBSTR(PA30||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(4) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
         ...
         'end 2019/11/18
          ...
          strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(tm28,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, SUBSTRB(NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)),1,10) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(TM10,'000',TM45,CP45) AS 彼所案號,TM12 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                   ", TM23 as ApplyNo " & SeColTM & " FROM NEXTPROGRESS,CASEPROGRESS,TRADEMARK,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                   " WHERE (TM29<>'Y' or tm29 is null) AND NP02=TM01(+) AND NP03=TM02(+) AND NP04=TM03(+) AND NP05=TM04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(TM23,1,8)=CU01(+) AND DECODE(SUBSTR(TM23,9,1),NULL,'0',SUBSTR(TM23,9,1))=CU02(+) AND SUBSTR(TM44,1,8)=FA01(+) AND DECODE(SUBSTR(TM44,9,1),NULL,'0',SUBSTR(TM44,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND TM10=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND NP01=SK01(+) " & strSQL2 & _
                   " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                   " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
         ...
         If Len(Trim(frm100106_1.txt4(0))) <> 0 Then
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(tm28,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, SUBSTRB(NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)),1,10) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(TM10,'000',TM45,CP45) AS 彼所案號,TM12 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", TM78 as ApplyNo " & SeColTM & " FROM NEXTPROGRESS,CASEPROGRESS,TRADEMARK,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (TM29<>'Y' or tm29 is null) AND NP02=TM01(+) AND NP03=TM02(+) AND NP04=TM03(+) AND NP05=TM04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(TM78,1,8)=CU01(+) AND DECODE(SUBSTR(TM78,9,1),NULL,'0',SUBSTR(TM78,9,1))=CU02(+) AND SUBSTR(TM44,1,8)=FA01(+) AND DECODE(SUBSTR(TM44,9,1),NULL,'0',SUBSTR(TM44,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND TM10=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND NP01=SK01(+) " & StrSql20(1) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND TM10 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND TM10 <= '" & frm100106_1.txt5(8).Text & "'", "") & _
                         " and decode(np02||np07,'T716',tm17,'T102',tm17,'FCT716',tm17,'FCT102',tm17,'TF716',tm17,'TF102',tm17,'Y')='Y' "
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(tm28,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, SUBSTRB(NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)),1,10) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(TM10,'000',TM45,CP45) AS 彼所案號,TM12 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", TM79 as ApplyNo " & SeColTM & " FROM NEXTPROGRESS,CASEPROGRESS,TRADEMARK,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (TM29<>'Y' or tm29 is null) AND NP02=TM01(+) AND NP03=TM02(+) AND NP04=TM03(+) AND NP05=TM04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(TM79,1,8)=CU01(+) AND DECODE(SUBSTR(TM79,9,1),NULL,'0',SUBSTR(TM79,9,1))=CU02(+) AND SUBSTR(TM44,1,8)=FA01(+) AND DECODE(SUBSTR(TM44,9,1),NULL,'0',SUBSTR(TM44,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND TM10=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND NP01=SK01(+) " & StrSql20(2) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND TM10 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND TM10 <= '" & frm100106_1.txt5(8).Text & "'", "") & _
                         " and decode(np02||np07,'T716',tm17,'T102',tm17,'FCT716',tm17,'FCT102',tm17,'TF716',tm17,'TF102',tm17,'Y')='Y' "
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(tm28,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, SUBSTRB(NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)),1,10) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(TM10,'000',TM45,CP45) AS 彼所案號,TM12 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", TM80 as ApplyNo " & SeColTM & " FROM NEXTPROGRESS,CASEPROGRESS,TRADEMARK,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (TM29<>'Y' or tm29 is null) AND NP02=TM01(+) AND NP03=TM02(+) AND NP04=TM03(+) AND NP05=TM04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(TM80,1,8)=CU01(+) AND DECODE(SUBSTR(TM80,9,1),NULL,'0',SUBSTR(TM80,9,1))=CU02(+) AND SUBSTR(TM44,1,8)=FA01(+) AND DECODE(SUBSTR(TM44,9,1),NULL,'0',SUBSTR(TM44,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND TM10=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND NP01=SK01(+) " & StrSql20(3) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND TM10 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND TM10 <= '" & frm100106_1.txt5(8).Text & "'", "") & _
                         " and decode(np02||np07,'T716',tm17,'T102',tm17,'FCT716',tm17,'FCT102',tm17,'TF716',tm17,'TF102',tm17,'Y')='Y' "
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,decode(tm28,'1','','N')||NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, SUBSTRB(NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)),1,10) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(TM10,'000',TM45,CP45) AS 彼所案號,TM12 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ", TM81 as ApplyNo " & SeColTM & " FROM NEXTPROGRESS,CASEPROGRESS,TRADEMARK,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (TM29<>'Y' or tm29 is null) AND NP02=TM01(+) AND NP03=TM02(+) AND NP04=TM03(+) AND NP05=TM04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(TM81,1,8)=CU01(+) AND DECODE(SUBSTR(TM81,9,1),NULL,'0',SUBSTR(TM81,9,1))=CU02(+) AND SUBSTR(TM44,1,8)=FA01(+) AND DECODE(SUBSTR(TM44,9,1),NULL,'0',SUBSTR(TM44,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND TM10=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND NP01=SK01(+) " & StrSql20(4) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND TM10 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND TM10 <= '" & frm100106_1.txt5(8).Text & "'", "") & _
         ...
         'end 2019/11/18
          ...
          strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(lc36,'')),null,'','●')||lc16 as 分所號,NVL(LC05,NVL(LC06,LC07)) AS 案件名稱,DECODE(LC15,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(LC15,'000',LC23,CP45) AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                   ",LC11 as ApplyNo " & SeColLC & " FROM NEXTPROGRESS,CASEPROGRESS,LAWCASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
         ...
         If Len(Trim(frm100106_1.txt4(0))) <> 0 Then
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(lc36,'')),null,'','●')||lc16 as 分所號,NVL(LC05,NVL(LC06,LC07)) AS 案件名稱,DECODE(LC15,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(LC15,'000',LC23,CP45) AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",LC43 as ApplyNo " & SeColLC & " FROM NEXTPROGRESS,CASEPROGRESS,LAWCASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         ...
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND LC15 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(lc36,'')),null,'','●')||lc16 as 分所號,NVL(LC05,NVL(LC06,LC07)) AS 案件名稱,DECODE(LC15,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(LC15,'000',LC23,CP45) AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",LC44 as ApplyNo " & SeColLC & " FROM NEXTPROGRESS,CASEPROGRESS,LAWCASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         ...
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND LC15 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(lc36,'')),null,'','●')||lc16 as 分所號,NVL(LC05,NVL(LC06,LC07)) AS 案件名稱,DECODE(LC15,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(LC15,'000',LC23,CP45) AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",LC45 as ApplyNo " & SeColLC & " FROM NEXTPROGRESS,CASEPROGRESS,LAWCASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         ...
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND LC15 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(lc36,'')),null,'','●')||lc16 as 分所號,NVL(LC05,NVL(LC06,LC07)) AS 案件名稱,DECODE(LC15,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(LC15,'000',LC23,CP45) AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",LC46 as ApplyNo " & SeColLC & " FROM NEXTPROGRESS,CASEPROGRESS,LAWCASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
         ...
         strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(hc20,'')),null,'','●')||hc07 as 分所號,HC06                     AS 案件名稱,CPM03                         AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日,''                                                         AS 代理人,' '                          AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                   ",HC05 as ApplyNo " & SeColHC & " FROM NEXTPROGRESS,CASEPROGRESS,HIRECASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,STAFF_IDMAP " & _
         ...
         If Len(Trim(frm100106_1.txt4(0))) <> 0 Then
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(hc20,'')),null,'','●')||hc07 as 分所號,HC06                     AS 案件名稱,CPM03                         AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日,''                                                         AS 代理人,' '                          AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                          ",HC24 as ApplyNo " & SeColHC & " FROM NEXTPROGRESS,CASEPROGRESS,HIRECASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,STAFF_IDMAP " & _
                          ...
                          " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND '000' <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(hc20,'')),null,'','●')||hc07 as 分所號,HC06                     AS 案件名稱,CPM03                         AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日,''                                                         AS 代理人,' '                          AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                          ",HC25 as ApplyNo " & SeColHC & " FROM NEXTPROGRESS,CASEPROGRESS,HIRECASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,STAFF_IDMAP " & _
                          ...
                          " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND '000' <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(hc20,'')),null,'','●')||hc07 as 分所號,HC06                     AS 案件名稱,CPM03                         AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日,''                                                         AS 代理人,' '                          AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                          ",HC26 as ApplyNo " & SeColHC & " FROM NEXTPROGRESS,CASEPROGRESS,HIRECASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,STAFF_IDMAP " & _
                          ...
                          " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND '000' <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(hc20,'')),null,'','●')||hc07 as 分所號,HC06                     AS 案件名稱,CPM03                         AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日,''                                                         AS 代理人,' '                          AS 彼所案號,' ' AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                          ",HC27 as ApplyNo " & SeColHC & " FROM NEXTPROGRESS,CASEPROGRESS,HIRECASE,NATION N1,NATION N2,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,STAFF_IDMAP " & _
         ...
         'end 2019/11/18
          ...
          'Modify by Morgan 2005/2/24 FCP智權人員抓FCP各國管制人--催審專用
          'Modified by Lydia 2019/11/01 +增加欄位SeColSP, ApplyNo
          strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FG411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                   ",SP08 as ApplyNo " & SeColSP & " FROM NEXTPROGRESS,CASEPROGRESS,SERVICEPRACTICE,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                   " WHERE (SP15<>'Y' or sp15 is null) AND NP02=SP01(+) AND NP03=SP02(+) AND NP04=SP03(+) AND NP05=SP04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(SP08,1,8)=CU01(+) AND DECODE(SUBSTR(SP08,9,1),NULL,'0',SUBSTR(SP08,9,1))=CU02(+) AND SUBSTR(SP26,1,8)=FA01(+) AND DECODE(SUBSTR(SP26,9,1),NULL,'0',SUBSTR(SP26,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND SP09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+)  " & strSQL5 & _
                   " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                   " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
          ...
          If Len(Trim(frm100106_1.txt4(0))) <> 0 Then
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FG411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",SP58 as ApplyNo " & SeColSP & " FROM NEXTPROGRESS,CASEPROGRESS,SERVICEPRACTICE,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (SP15<>'Y' or sp15 is null) AND NP02=SP01(+) AND NP03=SP02(+) AND NP04=SP03(+) AND NP05=SP04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(SP58,1,8)=CU01(+) AND DECODE(SUBSTR(SP58,9,1),NULL,'0',SUBSTR(SP58,9,1))=CU02(+) AND SUBSTR(SP26,1,8)=FA01(+) AND DECODE(SUBSTR(SP26,9,1),NULL,'0',SUBSTR(SP26,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND SP09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+)  " & StrSql50(1) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND SP09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND SP09 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FG411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",SP59 as ApplyNo " & SeColSP & " FROM NEXTPROGRESS,CASEPROGRESS,SERVICEPRACTICE,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (SP15<>'Y' or sp15 is null) AND NP02=SP01(+) AND NP03=SP02(+) AND NP04=SP03(+) AND NP05=SP04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(SP59,1,8)=CU01(+) AND DECODE(SUBSTR(SP59,9,1),NULL,'0',SUBSTR(SP59,9,1))=CU02(+) AND SUBSTR(SP26,1,8)=FA01(+) AND DECODE(SUBSTR(SP26,9,1),NULL,'0',SUBSTR(SP26,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND SP09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+)  " & StrSql50(2) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND SP09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND SP09 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FG411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",SP65 as ApplyNo " & SeColSP & " FROM NEXTPROGRESS,CASEPROGRESS,SERVICEPRACTICE,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (SP15<>'Y' or sp15 is null) AND NP02=SP01(+) AND NP03=SP02(+) AND NP04=SP03(+) AND NP05=SP04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(SP65,1,8)=CU01(+) AND DECODE(SUBSTR(SP65,9,1),NULL,'0',SUBSTR(SP65,9,1))=CU02(+) AND SUBSTR(SP26,1,8)=FA01(+) AND DECODE(SUBSTR(SP26,9,1),NULL,'0',SUBSTR(SP26,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND SP09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+)  " & StrSql50(3) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND SP09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND SP09 <= '" & frm100106_1.txt5(8).Text & "'", "")
                strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(NP09),-9) AS 法定期限,NP15 AS 備註,NP02||'-'||NP03||'-'||NP04||'-'||NP05 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,NVL(S1.ST02,CP14) AS 承辦人,NVL(S2.ST02,NP10) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(NP08),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人,DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,'' AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,DECODE(NP02||NP07,'FG411',NVL(N3.NA16,N2.NA16),NP10) NP10,NP01,NP22, NP02, NP07,NP02||'-'||NP03||'-'||NP04||'-'||NP05 as FSort " & _
                         ",SP66 as ApplyNo " & SeColSP & " FROM NEXTPROGRESS,CASEPROGRESS,SERVICEPRACTICE,NATION N1,NATION N2,NATION N3,STAFF S2,STAFF S1,CASEPROPERTYMAP,CUSTOMER,FAGENT,SYSTEMKIND,STAFF_IDMAP " & _
                         " WHERE (SP15<>'Y' or sp15 is null) AND NP02=SP01(+) AND NP03=SP02(+) AND NP04=SP03(+) AND NP05=SP04(+) AND NP01=CP09(+)  AND NP10=S2.ST01(+) AND CP14=S1.ST01(+) AND SIM02(+)=CP14 AND SUBSTR(SP66,1,8)=CU01(+) AND DECODE(SUBSTR(SP66,9,1),NULL,'0',SUBSTR(SP66,9,1))=CU02(+) AND SUBSTR(SP26,1,8)=FA01(+) AND DECODE(SUBSTR(SP26,9,1),NULL,'0',SUBSTR(SP26,9,1))=FA02(+) AND NP02=CPM01(+) AND TO_CHAR(NP07)=CPM02(+) AND SP09=N1.NA01(+) AND CU10=N2.NA01(+) AND NP01=SK01(+) AND FA10=N3.NA01(+)  " & StrSql50(4) & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND NP07 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND NP07 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND SP09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                         " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND SP09 <= '" & frm100106_1.txt5(8).Text & "'", "")
      ...
      'strSQL = "Select AA.V AS V, AA.法定期限 AS 法定期限, AA.備註 AS 備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, AA.收文日 AS 收文日, AA.本所期限 AS 本所期限, AA.申請人 AS 申請人, AA.是否出名 AS 是否出名, AA.延期日 AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, AA.發文日 AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, AA.承辦人備註 AS 承辦人備註, AA.取消收文日 AS 取消收文日, AA.NP10 AS NP10, AA.NP01 AS NP01, AA.np22 AS NP22, AA.NP02 AS NP02, AA.NP07 AS NP07,AA.FSort as FSort " & _
      ...
      'strSql = "Select AA.V AS V, AA.法定期限 AS 法定期限, AA.備註 AS 備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, AA.收文日 AS 收文日, AA.本所期限 AS 本所期限, AA.申請人 AS 申請人, AA.是否出名 AS 是否出名, AA.延期日 AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, AA.發文日 AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, AA.承辦人備註 AS 承辦人備註, '' AS 取消收文日, AA.NP10 AS NP10, AA.NP01 AS NP01, AA.np22 AS NP22, AA.NP02 AS NP02, AA.NP07 AS NP07,AA.FSort as FSort " & _
                " From ( " & strSql & " ) AA, Staff SA, Staff_Group, STAFF SB Where AA.NP02=SG02 And AA.NP07=SG03 And SA.ST11=SG01 And AA.NP10=SB.ST01(+) And SA.ST01='" & strUserNum & "' "
      'Modified by Lydia 2019/11/01 利益衝突案件：於Fsort後面增加欄位
      'strSql = "Select AA.V AS V, AA.法定期限 AS 法定期限, AA.備註 AS 備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, AA.收文日 AS 收文日, AA.本所期限 AS 本所期限, AA.申請人 AS 申請人, AA.是否出名 AS 是否出名, AA.延期日 AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, AA.發文日 AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, AA.承辦人備註 AS 承辦人備註, '' AS 取消收文日, AA.NP10 AS NP10, AA.NP01 AS NP01, AA.np22 AS NP22, AA.NP02 AS NP02, AA.NP07 AS NP07,AA.FSort as FSort " & _
                " From ( " & strSql & " ) AA"
      'end 2015/10/21
      'Modified by Lydia 2021/05/19 限定欄位長度
      'strSql = "Select AA.V AS V, AA.法定期限 AS 法定期限, AA.備註 AS 備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, AA.收文日 AS 收文日, AA.本所期限 AS 本所期限, AA.申請人 AS 申請人, AA.是否出名 AS 是否出名, AA.延期日 AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, AA.發文日 AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, AA.承辦人備註 AS 承辦人備註, '' AS 取消收文日" & _
                  ", AA.NP10 AS NP10, AA.NP01 AS NP01, AA.np22 AS NP22, AA.NP02 AS NP02, AA.NP07 AS NP07 " & _
                  ",AA.FSort as FSort ,ApplyNo,cust01,cust02,cust03,cust04,cust05,fcno" & _
                  " From ( " & strSql & " ) AA"
      'end 2019/11/01
      'Modified by Morgan 2021/5/25 補 , Staff SB (依智權人員排序會用)
      strSql = "Select AA.V AS V, substr(AA.法定期限,1,10) AS 法定期限, substr(AA.備註,1,500) AS 備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, AA.收文日 AS 收文日, substr(AA.本所期限,1,10) AS 本所期限, " & _
                  "AA.申請人 AS 申請人, AA.是否出名 AS 是否出名, AA.延期日 AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, substr(AA.發文日,1,10) AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, substr(AA.承辦人備註,1,10) AS 承辦人備註, '' AS 取消收文日" & _
                  ", AA.NP10 AS NP10, AA.NP01 AS NP01, AA.np22 AS NP22, AA.NP02 AS NP02, AA.NP07 AS NP07 " & _
                  ",AA.FSort as FSort ,ApplyNo,cust01,cust02,cust03,cust04,cust05,fcno" & _
       ...
       If frm100106_1.txt5(13).Text = "Y" Then
           'edit by nickc 2005/05/10
           'strSQL = strSQL & " ORDER BY SB.ST03, SB.ST01, 法定期限,本所案號 "
           'edit by nickc 2008/02/21 取消收文日放最下面
           'strSQL = strSQL & " ORDER BY SB.ST03, SB.ST01, 法定期限,FSort,本所案號 "
           '2010/9/17 modify by sonia 因改日期欄百年問題而修正
           'strSql = strSql & " ORDER BY SB.ST03, SB.ST01,nvl(取消收文日,'11/11/11'), 法定期限,FSort,本所案號 "
           strSql = strSql & " ORDER BY SB.ST03, SB.ST01,nvl(取消收文日,' 11/11/11'), 法定期限,FSort,本所案號 "
           pub_QL05 = pub_QL05 & ";" & frm100106_1.Label1(9) & frm100106_1.txt5(13)  'Add By Sindy 2010/01/22
       Else
           'edit by nickc 2005/05/10
           'strSQL = strSQL & " ORDER BY 法定期限,本所案號 "
           'edit by nickc 2008/02/21 取消收文日放最下面
           'strSQL = strSQL & " ORDER BY 法定期限,FSort,本所案號 "
           '2010/9/17 modify by sonia 因改日期欄百年問題而修正
           'strSql = strSql & " ORDER BY nvl(取消收文日,'11/11/11'),法定期限,FSort,本所案號 "
           strSql = strSql & " ORDER BY nvl(取消收文日,' 11/11/11'),法定期限,FSort,本所案號 "
       End If
...
JumpToNoData:   'Added by Lydia 2019/11/01
       ...
       grdDataList.Visible = False
      grdDataList.row = 0
      'Remove by Lydia 2021/05/19 已在SetDataListWidth設定
      'grdDataList.col = 27
      ...
      'end 2021/05/19
       ...
       For i = 1 To grdDataList.Rows - 1
            '910710 Sieg 107
            'Modifid by Lydia 2021/05/19 改變數取得
'            strTmp = Replace(grdDataList.TextMatrix(i, 3), "-", "")
'            If Left(strTmp, 3) = "FCP" Then
'               'Add by Morgan 2005/2/24 催審抓FCP管制人
'               If grdDataList.TextMatrix(i, 26) = "411" Then
'                  grdDataList.TextMatrix(i, 8) = GetStaffName(grdDataList.TextMatrix(i, 22))
'               Else
'                  If GetFCPSales(strTmp, strTmp1) Then
'                     grdDataList.TextMatrix(i, 8) = strTmp1
'                  End If
'               End If
...
'               grdDataList.TextMatrix(i, 6) = grdDataList.TextMatrix(i, 6) & PUB_GetNextCasePropertyName(grdDataList.TextMatrix(i, 23), grdDataList.TextMatrix(i, 24), "1")
'            End If
'            '2012/8/9 END
'           grdDataList.row = i
'           grdDataList.col = grdDataList.Cols - 1
...
'end 2021/05/19
           ...
           End If
'           grdDataList.col = 16
'edit by nickc 2008/02/15 未收文不會有C 類
...
'               grdDataList.col = 1
           ...
           If grdDataList.CellBackColor = -2147483643 Then
               ...
               For j = 1 To 4
                  ...
                  End If
               Next j
               'Modified by Lydia 2021/05/19 改用變數取得: 26->colCP10
               If (UCase(stPA(1)) = "FCP" Or UCase(stPA(1)) = "P") And grdDataList.TextMatrix(grdDataList.row, colCP10) = "605" Then
                  ...
                  strTmp = Val(ChangeTStringToWString(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, colDDate1))))
                  If strTmp <> "" Then
           ...
           If grdDataList.CellBackColor = -2147483643 Then
                ...
                '    grdDataList.col = 3
                'Modified by Lydia 2022/05/30 debug: colCP57=>colCP27(發文日)
               ...
               'If ChangeTDateStringToTString(grdDataList.Text) < ChangeWStringToTString(ServerDate) Then
               ...
               Else
                   ...
                   '   grdDataList.col = 3
                   If Val(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, colDDate1))) = Val(ChangeWStringToTString(ServerDate)) Then
                       grdDataList.col = colCaseNo
                   'end 2021/05/19
...
'           End If
      ...
      grdDataList.Visible = True
   Else
      'Modify By Lydia 2019/11/18 程式太長，切程式段
...
'Modify by Morgan 2006/10/20 是否閉卷要判斷 IS NULL
...
'   strSQL = strSQL + "union all select '',HC05,HC06,'','' FROM HIRECASE WHERE HC09<>'Y' AND HC01='" & SystemNumber(StrTag, 1) & "' AND HC02='" & SystemNumber(StrTag, 2) & "' AND HC03='" & SystemNumber(StrTag, 3) & "' AND HC04='" & SystemNumber(StrTag, 4) & "' "
   strSql = "SELECT TM44,TM23,TM05,TM06,TM07 FROM TRADEMARK WHERE TM29 IS NULL AND TM01='" & SystemNumber(StrTag, 1) & "' AND TM02='" & SystemNumber(StrTag, 2) & "' AND TM03='" & SystemNumber(StrTag, 3) & "' AND TM04='" & SystemNumber(StrTag, 4) & "' "
   strSql = strSql + "union all select PA75,PA26,PA05,PA06,PA07 FROM PATENT WHERE PA57 IS NULL AND PA01='" & SystemNumber(StrTag, 1) & "' AND PA02='" & SystemNumber(StrTag, 2) & "' AND PA03='" & SystemNumber(StrTag, 3) & "' AND PA04='" & SystemNumber(StrTag, 4) & "' "
   strSql = strSql + "union all select SP26,SP08,SP05,SP06,SP07 FROM SERVICEPRACTICE WHERE SP15 IS NULL AND SP01='" & SystemNumber(StrTag, 1) & "' AND SP02='" & SystemNumber(StrTag, 2) & "' AND SP03='" & SystemNumber(StrTag, 3) & "' AND SP04='" & SystemNumber(StrTag, 4) & "' "
   strSql = strSql + "union all select LC22,LC11,LC05,LC06,LC07 FROM LAWCASE WHERE LC08 IS NULL AND LC01='" & SystemNumber(StrTag, 1) & "' AND LC02='" & SystemNumber(StrTag, 2) & "' AND LC03='" & SystemNumber(StrTag, 3) & "' AND LC04='" & SystemNumber(StrTag, 4) & "' "
   strSql = strSql + "union all select '',HC05,HC06,'','' FROM HIRECASE WHERE HC09 IS NULL AND HC01='" & SystemNumber(StrTag, 1) & "' AND HC02='" & SystemNumber(StrTag, 2) & "' AND HC03='" & SystemNumber(StrTag, 3) & "' AND HC04='" & SystemNumber(StrTag, 4) & "' "
'END 2006/10/20
   ...
   If adoRecordset.RecordCount <> 0 And adoRecordset.RecordCount > 0 Then
       ...
       Else
           If Not IsNull(adoRecordset.Fields(1)) Then
               CheckOC2
               strSql = "SELECT CU10 FROM CUSTOMER WHERE CU01='" & Left(adoRecordset.Fields(1), 8) & "' AND CU02='" & Right(adoRecordset.Fields(1), 1) & "' "
               adoRecordset1.CursorLocation = adUseClient
               adoRecordset1.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
               If adoRecordset1.RecordCount <> 0 And adoRecordset1.RecordCount > 0 Then
                   If Not IsNull(adoRecordset1.Fields(0)) Then
   ...
   If Len(Trim(StrTemp5)) <> 0 Then
       ...
       End If
   End If
   'Modify by Morgan 2007/3/28
   StrTag = StrTemp5 + "-"
   'Modified by Lydia 2021/05/19 改用變數取得
'   If grdDataList.TextMatrix(0, 6) = "承辦人" Then
'      StrTag = StrTag + grdDataList.TextMatrix(grdDataList.row, 7) + "-"
'      StrTag = StrTag + grdDataList.TextMatrix(grdDataList.row, 6) + "-"
'   Else
'      StrTag = StrTag + grdDataList.TextMatrix(grdDataList.row, 8) + "-"
'      StrTag = StrTag + grdDataList.TextMatrix(grdDataList.row, 7) + "-"
'   End If
   StrTag = StrTag + grdDataList.TextMatrix(grdDataList.row, colSalesName) + "-"
   StrTag = StrTag + grdDataList.TextMatrix(grdDataList.row, colCP14name) + "-"
   'end 2021/05/19
   If cmdState = 1 Then
      'Modified by Lydia 2021/05/19 改用變數取得: 1=>colCaseNo
      Call frm100106_4.SetParent(Me, grdDataList.TextMatrix(i, colCaseNo)) 'Added by Lydia 2020/03/11 傳入前一畫面和法定期限
      
      frm100106_4.StrMailNum1 = GetStaffNum(StrTemp5)
      'Remove by Morgan 2007/1/11 改在frm100106_4.StrMenu作(所內員工可能同時是外翻不可再用名稱抓)
      'frm100106_4.StrMailNum2 = GetStaffNum(grdDataList.TextMatrix(grdDataList.Row, 7))
      'frm100106_4.StrMailNum3 = GetStaffNum(grdDataList.TextMatrix(grdDataList.Row, 6))
      'end 2007/1/11
   End If
   'end 2007/3/28
End Sub
...
Private Sub PrintData()
   ...
   Page = 1
    ...
    With Me.grdDataList
        ...
        Else
            Print #1, "＜＜期限管制表＞＞"
            Print #1, "法定期限：" & frm100106_1.txt2(0).Text & "－" & frm100106_1.txt2(1).Text
        ...
        For ii = 1 To .Rows - 1
            ...
            Next i
            'Modified by Lydia 2021/05/19 改用變數取得: 1=>colDDate1
            strTempA(0) = "" & .TextMatrix(ii, colDDate1) '法定期限
            'Modify by Morgan 2007/9/27
            'strTempA(21) = "" & .TextMatrix(ii, 10) '本所期限
            'Modify by Morgan 2008/11/14
            'strTempA(21) = "" & .TextMatrix(ii, 9) '本所期限
            'Modified by Lydia 2021/05/19 改用變數取得: 10=>colDDate2
            strTempA(21) = "" & .TextMatrix(ii, colDDate2) '本所期限
            'end 2007/9/27

            'Modified by Lydia 2021/05/19 改用變數取得
'            strTempA(1) = "" & .TextMatrix(ii, 3) '本所案號
'            strTempA(2) = StrConv(MidB(StrConv("" & .TextMatrix(ii, 5), vbFromUnicode), 1, 40), vbUnicode) '案件名稱
'            strTempA(3) = "" & .TextMatrix(ii, 9) '收文日
'            strTempA(4) = StrConv(MidB(StrConv("" & .TextMatrix(ii, 14), vbFromUnicode), 1, 8), vbUnicode)  '申請國家
'            strTempA(5) = "" & .TextMatrix(ii, 19) '申請案號
'            strTempA(6) = StrConv(MidB(StrConv("" & .TextMatrix(ii, 6), vbFromUnicode), 1, 10), vbUnicode)  '案件性質
'            strTempA(7) = Left("" & .TextMatrix(ii, 8), 3) '智權人員
'            strTempA(8) = Left("" & .TextMatrix(ii, 7), 3) '承辦人
'            GetOtherData "" & .TextMatrix(ii, 23)
            strTempA(1) = "" & .TextMatrix(ii, colCaseNo) '本所案號
            strTempA(2) = StrConv(MidB(StrConv("" & .TextMatrix(ii, colCaseName), vbFromUnicode), 1, 40), vbUnicode) '案件名稱
            ...
            If m_blnExportFile = False Then
                If frm100106_1.txt5(13).Text = "Y" Then
                    ...
                    'Modified by Lydia 2021/05/19 改用變數
                    'If m_strSalesNo <> "" & .TextMatrix(ii, 22) Then
                    '    m_strSalesNo = "" & .TextMatrix(ii, 22)
...
'                End If
    ...
    '若為列印管制表
    If m_blnExportFile = False Then
        PrintMemo 'Added by Lydia 2018/02/14
        Printer.EndDoc
        ShowPrintOk
    End If
End Sub
...
Private Sub GetPleft()
   ...
   '第一列
   PLeft(0) = 0
   'Modfied by Lydia 2018/02/14 調位置
   'PLeft(21) = 1050
   'PLeft(1) = 2100
   'PLeft(2) = 4000
   'PLeft(3) = 9000
...
Private Sub PrintTitle()
   ...
   Printer.CurrentY = iPrint
   Printer.Print "法定期限：" & Format(ChangeTStringToTDateString(frm100106_1.txt2(0).Text) & " ", "@@@@@@@@@@") & "－" & ChangeTStringToTDateString(frm100106_1.txt2(1).Text)
...
Private Sub PrintDatilF()
   '第一列
   Print #1, StrConv(LeftB(StrConv("法定期限：" & strTempA(0) & String(40, " "), vbFromUnicode), 40), vbUnicode) & "本所期限：" & strTempA(21)
   ...
   Print #1, StrConv(LeftB(StrConv("電話：" & strTempA(11) & String(47, " "), vbFromUnicode), 47), vbUnicode) & "傳真：" & strTempA(12)
   ...
   If m_blnSales = False Then
       ...
       'Print #1, "電話：" & strTempA(17) & "　　　　" & "傳真：" & strTempA(18)
       Print #1, StrConv(LeftB(StrConv("電話：" & strTempA(17) & String(47, " "), vbFromUnicode), 47), vbUnicode) & "傳真：" & strTempA(18)
...
'取得使用者等級
Private Function GetST05(ByVal strUserNum As String) As String
   Dim StrSQLa As String
   Dim rsA As New ADODB.Recordset
...
Private Function GetStaffNum(p_ST02 As String) As String
   If p_ST02 <> "" Then
      'Modified by Lydia 2020/03/11 優先抓在職員工
      'strExc(0) = "select st01 from staff where st02='" & p_ST02 & "'"
      strExc(0) = "select st04, st01 from staff where st02='" & p_ST02 & "' order by 1,2"
      
      intI = 1
      Set RsTemp = ClsLawReadRstMsg(intI, strExc(0)) 'edit by nickc 2007/02/05 不用 dll 了 objLawDll.ReadRstMsg(intI, strExc(0))
      If intI = 1 Then
         RsTemp.MoveFirst 'Added by Lydia 2020/03/11
         GetStaffNum = "" & RsTemp.Fields("st01")
      End If
   End If
End Function
...
'Added by Lydia 2018/02/14 列印備註(combo1)
...
'Added by Lydia 2019/11/18 已收文未發文
...
Dim dblRow As Double 'Add By Sindy 2025/9/3
    ...
    strSQL5 = ""
    'Added by Lydia 2019/11/01 利益衝突案件：於後面增加欄位
    'Modify By Sindy 2023/5/30 要加註進度備註：,cp142,cp164,cp43
    SeColTM = " ,tm23 as cust01,tm78 as cust02,tm79 as cust03,tm80 as cust04,tm81 as cust05,tm44 as fcno,cp142,cp164,cp43 "
    SeColPA = " ,pa26 as cust01,pa27 as cust02,pa28 as cust03,pa29 as cust04,pa30 as cust05,pa75 as fcno,cp142,cp164,cp43 "
    SeColSP = " ,sp08 as cust01,sp58 as cust02,sp59 as cust03,sp65 as cust04,sp66 as cust05,sp26 as fcno,cp142,cp164,cp43 "
    SeColLC = " ,lc11 as cust01,lc43 as cust02,lc44 as cust03,lc45 as cust04,lc46 as cust05,lc22 as fcno,cp142,cp164,cp43 "
    SeColHC = " ,hc05 as cust01,hc24 as cust02,hc25 as cust03,hc26 as cust04,hc27 as cust05,'' as fcno,cp142,cp164,cp43 "
    m_AllSys = IIf(frm100106_1.txt5(0).Text <> "ALL", frm100106_1.txt5(0).Text, GetAllSysKind(, frm100106_1.txt5(0).Text))
    'Added by Lydia 2020/03/11 外專人員勾選含FMP外專管制期限時,要另外增加P,PS
    If frm100106_1.Check1.Value = 1 And Left(Pub_StrUserSt03, 2) = "F2" Then
        If InStr(m_AllSys & ",", ",P,") = 0 Then m_AllSys = m_AllSys & ",P,"
    ...
    End If
    If Len(Trim(frm100106_1.txt2(1))) <> 0 Then
      'Add By Sindy 2023/4/13 淑華說查詢法定期限時，加入指定送件日,之前及當天在此期間，也一併列出案件
      'strSQL1 = strSQL1 + " and CP07<=" & Val(ChangeTStringToWString(frm100106_1.txt2(1))) & " "
      strSQL1 = strSQL1 + " and (CP07<=" & Val(ChangeTStringToWString(frm100106_1.txt2(1))) & _
                          " or (CP142<=" & Val(ChangeTStringToWString(frm100106_1.txt2(1))) & " and CP164 in('1','2')) )"
      
      pub_QL05 = pub_QL05 & "-" & frm100106_1.txt2(1)  'Add By Sindy 2010/01/22
    '若未輸入則以系日統日代替
    Else
      'Add By Sindy 2023/4/13 淑華說查詢法定期限時，加入指定送件日,之前及當天在此期間，也一併列出案件
      'strSQL1 = strSQL1 + " and CP07<=" & Val(ChangeTStringToWString(ServerDate - 19110000)) & " "
      strSQL1 = strSQL1 + " and CP07<=" & Val(ChangeTStringToWString(ServerDate - 19110000)) & _
                          " or (CP142<=" & Val(ChangeTStringToWString(ServerDate - 19110000)) & " and CP164 in('1','2')) )"
...
'---------end 2019/11/18
  ...
  If Len(Trim(frm100106_1.txt5(11).Text)) + Len(Trim(frm100106_1.txt5(12).Text)) <> 0 Then
     ...
     strSql = "SELECT '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
            "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09,CP66, CP01, CP10,PA76,pa75 " & _
            ...
            " WHERE (PA57<>'Y' or pa57 is null) AND cp01=PA01(+) AND cp02=PA02(+) AND cp03=PA03(+) AND cp04=PA04(+) AND cP09=eP02(+) AND cp14=s1.st01(+) AND SIM02(+)=CP14 and CP13=S2.ST01(+) and cp14=ep05(+) AND SUBSTR(PA26,1,8)=CU01(+) AND SUBSTR(PA26||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND cp01=CPM01(+) AND cp10=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND CP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL1 & _
            ...
            " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
            " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
     strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
               "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09,CP66, CP01, CP10,NULL,sp26 " & _
  ...
  Else
     '2010/9/13 MODIFY BY SONIA 日期欄改百年日期排序問題
     'Modified by Lydia 2019/11/01 +增加欄位SeColPA, ApplyNo,FSort
     'Modified by Lydia 2021/05/19 在CP09後面加上CP66
     strSql = "SELECT '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
               "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09,CP66, CP01, CP10 " & _
               ", PA26 as ApplyNo " & SeColPA & " FROM CASEPROGRESS,PATENT,NATION N1,NATION N2,NATION N3,STAFF S2,CASEPROPERTYMAP,CUSTOMER,FAGENT,staff s1,engineerprogress,SYSTEMKIND,STAFF_IDMAP " & _
               " WHERE (PA57<>'Y' or pa57 is null) AND cp01=PA01(+) AND cp02=PA02(+) AND cp03=PA03(+) AND cp04=PA04(+) AND cP09=eP02(+) AND cp14=s1.st01(+) AND SIM02(+)=CP14 and CP13=S2.ST01(+) and cp14=ep05(+) AND SUBSTR(PA26,1,8)=CU01(+) AND SUBSTR(PA26||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND cp01=CPM01(+) AND cp10=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND CP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL1 & _
               " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND CP10 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
               " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND CP10 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
     ...
     If Len(Trim(frm100106_1.txt4(0))) <> 0 Then
            'Modified by Lydia 2021/05/19 在CP09後面加上CP66
            strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
                       "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(PA09,'000',PA77,CP45) AS 彼所案號,PA11 AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09,CP66, CP01, CP10 " & _
                      ...
                      " WHERE (PA57<>'Y' or pa57 is null) AND cp01=PA01(+) AND cp02=PA02(+) AND cp03=PA03(+) AND cp04=PA04(+) AND cP09=eP02(+) AND cp14=s1.st01(+) AND SIM02(+)=CP14 and CP13=S2.ST01(+) and cp14=ep05(+) AND SUBSTR(PA27,1,8)=CU01(+) AND SUBSTR(PA27||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND cp01=CPM01(+) AND cp10=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND CP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(1) & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND CP10 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND CP10 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
            strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
                      ...
                      " WHERE (PA57<>'Y' or pa57 is null) AND cp01=PA01(+) AND cp02=PA02(+) AND cp03=PA03(+) AND cp04=PA04(+) AND cP09=eP02(+) AND cp14=s1.st01(+) AND SIM02(+)=CP14 and CP13=S2.ST01(+) and cp14=ep05(+) AND SUBSTR(PA28,1,8)=CU01(+) AND SUBSTR(PA28||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND cp01=CPM01(+) AND cp10=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND CP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(2) & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND CP10 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND CP10 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
            strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
                      ...
                      " WHERE (PA57<>'Y' or pa57 is null) AND cp01=PA01(+) AND cp02=PA02(+) AND cp03=PA03(+) AND cp04=PA04(+) AND cP09=eP02(+) AND cp14=s1.st01(+) AND SIM02(+)=CP14 and CP13=S2.ST01(+) and cp14=ep05(+) AND SUBSTR(PA29,1,8)=CU01(+) AND SUBSTR(PA29||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND cp01=CPM01(+) AND cp10=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND CP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(3) & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND CP10 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND CP10 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
            strSql = strSql & " union all SELECT '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(pa136,'')),null,'','●')||pa47 as 分所號,NVL(PA05,NVL(PA06,PA07)) AS 案件名稱,DECODE(PA09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
                      ...
                      " WHERE (PA57<>'Y' or pa57 is null) AND cp01=PA01(+) AND cp02=PA02(+) AND cp03=PA03(+) AND cp04=PA04(+) AND cP09=eP02(+) AND cp14=s1.st01(+) AND SIM02(+)=CP14 and CP13=S2.ST01(+) and cp14=ep05(+) AND SUBSTR(PA30,1,8)=CU01(+) AND SUBSTR(PA30||'0',9,1)=CU02(+) AND SUBSTR(PA75,1,8)=FA01(+) AND SUBSTR(PA75||'0',9,1)=FA02(+) AND cp01=CPM01(+) AND cp10=CPM02(+) AND PA09=N1.NA01(+) AND CU10=N2.NA01(+) AND CP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL10(4) & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND CP10 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND CP10 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND PA09 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND PA09 <= '" & frm100106_1.txt5(8).Text & "'", "")
     ...
     'Modified by Lydia 2019/11/01 +增加欄位SeColTM, ApplyNo
     'Modified by Lydia 2021/05/19 在CP09後面加上CP66
     strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
               "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(TM10,'000',TM45,CP45) AS 彼所案號,TM12 AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09, CP66, CP01, CP10 " & _
     ...
     If Len(Trim(frm100106_1.txt4(0))) <> 0 Then
            ...
            strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
                      ...
                      " " & IIf(Len(Trim(frm100106_1.txt5(7).Text)) > 0, "AND TM10 >= '" & frm100106_1.txt5(7).Text & "'", "") & _
                      " " & IIf(Len(Trim(frm100106_1.txt5(8).Text)) > 0, "AND TM10 <= '" & frm100106_1.txt5(8).Text & "'", "")
            strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號," & _
                      "DECODE(length(nvl(tm73,'')),null,'','●')||tm34 as 分所號,NVL(TM05,NVL(TM06,TM07)) AS 案件名稱,DECODE(TM10,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
                      "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(TM10,'000',TM45,CP45) AS 彼所案號,TM12 AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09, CP66, CP01, CP10 " & _
     ...
     'Modified by Lydia 2019/11/01 +增加欄位SeColLC, ApplyNo
     'Modified by Lydia 2021/05/19 在CP09後面加上CP66
     strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(lc36,'')),null,'','●')||lc16 as 分所號,NVL(LC05,NVL(LC06,LC07)) AS 案件名稱,DECODE(LC15,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
               "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(LC15,'000',LC23,CP45) AS 彼所案號,' ' AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09, CP66, CP01, CP10 " & _
     ...
     'Modified by Lydia 2019/11/01 +增加欄位SeColHC, ApplyNo
     'Modified by Lydia 2021/05/19 在CP09後面加上CP66
     strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(hc20,'')),null,'','●')||hc07 as 分所號,HC06                     AS 案件名稱,CPM03                          AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
               "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日,''                                                         AS 代理人,' '                          AS 彼所案號,' ' AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09, CP66, CP01, CP10 " & _
     ...
     'Modified by Lydia 2021/05/19 在CP09後面加上CP66
     strSql = strSql & " union all select '' AS V,SUBSTR(' '||sqldatet(CP07),-9) AS 法定期限,CP64 AS 進度備註,CP01||'-'||CP02||'-'||CP03||'-'||CP04 AS 本所案號,DECODE(length(nvl(sp68,'')),null,'','●')||sp28 as 分所號,NVL(SP05,NVL(SP06,SP07)) AS 案件名稱,DECODE(SP09,'000',CPM03,CPM04) AS 案件性質,nvl(s1.st02,cp14) AS 承辦人,NVL(S2.ST02,cp13) AS 智權人員,SUBSTR(' '||sqldatet(CP05),-9) AS 收文日,SUBSTR(' '||sqldatet(CP06),-9) AS 本所期限, NVL(CU04,NVL(CU05||CU88||CU89||CU90,CU06)) AS 申請人," & _
               "DECODE(CP22,'Y','是','N','否',NULL,'是','否') AS 是否出名,'' AS 延期日,N1.NA03 AS 申請國家,N2.NA03 AS 申請人國籍,SUBSTR(' '||sqldatet(CP27),-9) AS 發文日," & StrSQLa & "DECODE(SP09,'000',SP27,CP45) AS 彼所案號,SP11 AS 申請案號,ep12 AS 承辦人備註,SUBSTR(' '||sqldatet(CP57),-9) AS 取消收文日,cp13,cp09, CP66, CP01, CP10 " & _
               ",SP08 as ApplyNo " & SeColSP & " FROM CASEPROGRESS,SERVICEPRACTICE,NATION N1,NATION N2,NATION N3,STAFF S2,CASEPROPERTYMAP,CUSTOMER,FAGENT,staff s1,engineerprogress,SYSTEMKIND,STAFF_IDMAP " & _
               " WHERE (SP15<>'Y' or sp15 is null) AND cp01=SP01(+) AND cp02=SP02(+) AND cp03=SP03(+) AND cp04=SP04(+) AND cP09=eP02(+) AND cp14=s1.st01(+) AND SIM02(+)=CP14 and CP13=S2.ST01(+) and cp14=ep05(+) AND SUBSTR(SP08,1,8)=CU01(+) AND DECODE(SUBSTR(SP08,9,1),NULL,'0',SUBSTR(SP08,9,1))=CU02(+) AND SUBSTR(SP26,1,8)=FA01(+) AND DECODE(SUBSTR(SP26,9,1),NULL,'0',SUBSTR(SP26,9,1))=FA02(+) AND cp01=CPM01(+) AND cp10=CPM02(+) AND SP09=N1.NA01(+) AND CU10=N2.NA01(+) AND CP01=SK01(+) AND FA10=N3.NA01(+) " & strSQL5 & _
               " " & IIf(Len(Trim(frm100106_1.txt5(5).Text)) > 0, "AND CP10 >= '" & frm100106_1.txt5(5).Text & "'", "") & _
               " " & IIf(Len(Trim(frm100106_1.txt5(6).Text)) > 0, "AND CP10 <= '" & frm100106_1.txt5(6).Text & "'", "") & _
    ...
    'Modify by Morgan 2004/11/12 要過濾已收不續辦的來函
    'Modify by Morgan 2007/9/27 補分所號
    'Modified by Morgan 2015/10/21 取消系統類別+案件性質的權限控制--秀玲檢查文件沒有該限制
    'strSql = "Select AA.V AS V, AA.法定期限 AS 法定期限, AA.進度備註 AS 進度備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, AA.收文日 AS 收文日, AA.本所期限 AS 本所期限, AA.申請人 AS 申請人, AA.是否出名 AS 是否出名, AA.延期日 AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, AA.發文日 AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, AA.承辦人備註 AS 承辦人備註, AA.取消收文日 AS 取消收文日, AA.cp13 AS CP13, AA.cp09 AS CP09, AA.CP01 AS CP01, AA.CP10 AS CP10 " & _
    ...
    ''end 2015/10/21
    'Modified by Lydia 2021/05/19 限定欄位長度
    'strSql = "Select AA.V AS V, AA.法定期限 AS 法定期限, AA.進度備註 AS 進度備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, AA.收文日 AS 收文日, AA.本所期限 AS 本所期限, AA.申請人 AS 申請人, AA.是否出名 AS 是否出名, AA.延期日 AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, AA.發文日 AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, AA.承辦人備註 AS 承辦人備註, AA.取消收文日 AS 取消收文日" & _
                 ",AA.cp13 AS CP13, AA.cp09 AS CP09, AA.CP01 AS CP01, AA.CP10 AS CP10, ' ' as NP07" & _
                 ", AA.本所案號 as Fsort ,ApplyNo,cust01,cust02,cust03,cust04,cust05,fcno" & _
                 " From ( " & strSql & " ) AA Where not exists(select * from caseprogress a where a.cp43= AA.cp09 and a.cp10='907')"
    'end 2019/11/01
    'Modified by Morgan 2021/5/25 補 , Staff SB (依智權人員排序會用)
    'Modify By Sindy 2023/5/30 要加註進度備註：,cp142,cp164,cp43
    strSql = "Select AA.V AS V, substr(AA.法定期限,1,10) AS 法定期限, substr(AA.進度備註,1,500) AS 進度備註, AA.本所案號 AS 本所案號,AA.分所號 as 分所號, AA.案件名稱 AS 案件名稱, AA.案件性質 AS 案件性質, AA.承辦人 AS 承辦人, AA.智權人員 AS 智權人員, substr(AA.收文日,1,10) AS 收文日, substr(AA.本所期限,1,10) AS 本所期限, AA.申請人 AS 申請人" & _
                ",AA.是否出名 AS 是否出名, substr(AA.延期日,1,10) AS 延期日, AA.申請國家 AS 申請國家, AA.申請人國籍 AS 申請人國籍, substr(AA.發文日,1,10) AS 發文日, AA.代理人 AS 代理人, AA.彼所案號 AS 彼所案號, AA.申請案號 AS 申請案號, substr(AA.承辦人備註,1,500) AS 承辦人備註, substr(AA.取消收文日,1,10) AS 取消收文日" & _
                 ",AA.cp13 AS CP13, AA.cp09 AS CP09, AA.cp66 AS CP66, AA.CP01 AS CP01, AA.CP10 AS CP10, ' ' as NP07" & _
                 ", AA.本所案號 as Fsort ,ApplyNo,cust01,cust02,cust03,cust04,cust05,fcno,cp142,cp164,cp43" & _
    ...
    If frm100106_1.txt5(13).Text = "Y" Then
        ...
        'strSQL = strSQL & " ORDER BY SB.ST03, SB.ST01, 法定期限,本所案號 "
        '2010/9/17 modify by sonia 因改日期欄百年問題而修正
        'strSql = strSql & " ORDER BY SB.ST03, SB.ST01,nvl(取消收文日,'11/11/11'), 法定期限,本所案號 "
        strSql = strSql & " ORDER BY SB.ST03, SB.ST01,nvl(取消收文日,' 11/11/11'), 法定期限,本所案號 "
        pub_QL05 = pub_QL05 & ";" & frm100106_1.Label1(9) & frm100106_1.txt5(13) 'Add By Sindy 2010/01/22
    Else
        'edit by nickc 2008/02/21 取消收文日放最下面
        'strSQL = strSQL & " ORDER BY 法定期限,本所案號 "
        '2010/9/17 modify by sonia 因改日期欄百年問題而修正
        'strSql = strSql & " ORDER BY nvl(取消收文日,'11/11/11'),法定期限,本所案號 "
        strSql = strSql & " ORDER BY nvl(取消收文日,' 11/11/11'),法定期限,本所案號 "
    End If
...
JumpToNoData:   'Added by Lydia 2019/11/01
   ...
   For i = 1 To grdDataList.Rows - 1
       ...
       strNote = PUB_GetFCPAddQuyNotes(Me.grdDataList.TextMatrix(i, PUB_MGridGetId("CP01", grdDataList)), _
                                       Me.grdDataList.TextMatrix(i, PUB_MGridGetId("CP09", grdDataList)), _
                                       Me.grdDataList.TextMatrix(i, PUB_MGridGetId("CP10", grdDataList)), _
                                       Me.grdDataList.TextMatrix(i, PUB_MGridGetId("CP43", grdDataList)), _
                                       , , _
                                       Me.grdDataList.TextMatrix(i, PUB_MGridGetId("CP142", grdDataList)), _
                                       Me.grdDataList.TextMatrix(i, PUB_MGridGetId("CP164", grdDataList)))
       If strNote <> "" Then
            Me.grdDataList.TextMatrix(i, PUB_MGridGetId("進度備註", grdDataList)) = strNote & Me.grdDataList.TextMatrix(i, PUB_MGridGetId("進度備註", grdDataList))
       End If
       '2023/5/30 END
...
'
'              If Len(Trim(grdDataList.Text)) <> 0 Then
           'add by nickc 2008/02/15 修正 加入灰色
         'Modified by Lydia 2021/05/19 改用變數取得
'         If Trim(grdDataList.TextMatrix(grdDataList.row, 21)) <> "" Then
'             'add by nickc 2008/02/21 灰色 + x
'             grdDataList.TextMatrix(grdDataList.row, 3) = "x" & grdDataList.TextMatrix(grdDataList.row, 3)
         ...
         If grdDataList.CellBackColor = -2147483643 Then
                 ...
                 For j = 1 To 4
                     ...
                     End If
                 Next j
                 'Modified by Lydia 2021/05/19 改用變數取得: 25=> colCP10
                 If (UCase(stPA(1)) = "FCP" Or UCase(stPA(1)) = "P") And grdDataList.TextMatrix(grdDataList.row, colCP10) = "605" Then
                     '2010/9/20 modify by sonia 因日期加空格故加val
                     'Modified by Lydia 2021/05/19 改用變數取得: 1 => coDDate1
                     strTmp = Val(ChangeTStringToWString(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, colDDate1))))
                     If strTmp <> "" Then
                         If PUB_IfCtrlDateExtended(stPA, strTmp) = True Then
                             'Modified by Lydia 2021/05/19 改用變數取得: 3 => colCaseNo
         ...
         If grdDataList.CellBackColor = -2147483643 Then
             ...
             '    grdDataList.TextMatrix(grdDataList.row, 3) = "#" & grdDataList.TextMatrix(grdDataList.row, 3)
             'Modified by Lydia 2022/05/30 debug: colCP57=>colCP27(發文日)
             ...
             'end 2021/05/19
                 ...
                 For j = 1 To grdDataList.Cols - 1
                     ...
                     grdDataList.CellBackColor = &HFF&
                 Next j
             'edit by nickc 2008/02/15
             'Else
             '     If ChangeTDateStringToTString(grdDataList.Text) = ChangeWStringToTString(ServerDate) Then
             '2010/9/20 modify by sonia 因日期加空格改以val判斷
             'Modified by Lydia 2021/05/19 改用變數取得
             ...
             Else
                 ...
                 If grdDataList.CellBackColor = -2147483643 Then
                     'Modified by Lydia 2021/05/19 改用變數取得
                     'If UCase(SystemNumber(grdDataList.TextMatrix(grdDataList.row, 3), 1)) = "FCP" Or UCase(SystemNumber(grdDataList.TextMatrix(grdDataList.row, 3), 1)) = "P" Then
                     '    grdDataList.col = 25
                     If UCase(SystemNumber(grdDataList.TextMatrix(grdDataList.row, 3), colCaseNo)) = "FCP" Or UCase(SystemNumber(grdDataList.TextMatrix(grdDataList.row, 3), colCaseNo)) = "P" Then
                         grdDataList.col = colCP10
                     'end 2021/05/19
                         If grdDataList.Text = "605" Then
                             CheckOC
...
'Added by Lydia 2019/11/18 已收文已發文
...
'             grdDataList.TextMatrix(grdDataList.row, 3) = "x" & grdDataList.TextMatrix(grdDataList.row, 3)
         ...
         If grdDataList.CellBackColor = -2147483643 Then
             ...
             Next j
             'Modified by Lydia 2021/05/19 改用變數取得
             'If (UCase(stPA(1)) = "FCP" Or UCase(stPA(1)) = "P") And grdDataList.TextMatrix(grdDataList.row, 25) = "605" Then
             '    '2010/9/20 modify by sonia 因日期加空格故加val
             '    strTmp = Val(ChangeTStringToWString(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, 1))))
             If (UCase(stPA(1)) = "FCP" Or UCase(stPA(1)) = "P") And grdDataList.TextMatrix(grdDataList.row, colCP10) = "605" Then
                 '2010/9/20 modify by sonia 因日期加空格故加val
                 strTmp = Val(ChangeTStringToWString(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, colDDate1))))
             'end 2021/05/19
                 If strTmp <> "" Then
                     If PUB_IfCtrlDateExtended(stPA, strTmp) = True Then
                         'Modified by Lydia 2021/05/19 改用變數取得: 3=>colCaseNo
                         grdDataList.TextMatrix(grdDataList.row, 3) = "&" & grdDataList.TextMatrix(grdDataList.row, colCaseNo)
                         For j = 1 To grdDataList.Cols - 1
                            grdDataList.col = j
                            '紫色
                            grdDataList.CellBackColor = &HE600E6
...
'                 grdDataList.TextMatrix(grdDataList.row, 3) = "#" & grdDataList.TextMatrix(grdDataList.row, 3)
             ...
             'If ChangeTDateStringToTString(grdDataList.Text) < ChangeWStringToTString(ServerDate) Then
             'edit by nickc 2008/02/21 修正字串比對錯誤
             'ElseIf ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, 1)) < ChangeWStringToTString(ServerDate) And Trim(grdDataList.TextMatrix(grdDataList.row, 1)) <> "" And Trim(grdDataList.TextMatrix(grdDataList.row, 16)) = "" Then
             'Modified by Lydia 2021/05/19 改用變數取得
             'ElseIf Val(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, 1))) < Val(ChangeWStringToTString(ServerDate)) And Trim(grdDataList.TextMatrix(grdDataList.row, 1)) <> "" And Trim(grdDataList.TextMatrix(grdDataList.row, 16)) = "" Then
             '    grdDataList.col = 3
             ElseIf Val(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, colDDate1))) < Val(ChangeWStringToTString(ServerDate)) And Trim(grdDataList.TextMatrix(grdDataList.row, colDDate1)) <> "" And Trim(grdDataList.TextMatrix(grdDataList.row, colCP27)) = "" Then
                 grdDataList.col = colCaseNo
             'end 2021/05/19
                 grdDataList.Text = "*" + grdDataList.Text
                 For j = 1 To grdDataList.Cols - 1
...
'                 grdDataList.col = 3
             ElseIf Val(ChangeTDateStringToTString(grdDataList.TextMatrix(grdDataList.row, colDDate1))) = Val(ChangeWStringToTString(ServerDate)) And grdDataList.TextMatrix(grdDataList.row, colCP27) = "" Then
                 grdDataList.col = colCaseNo
             'end 2021/05/19
                 grdDataList.Text = "v" & grdDataList.Text
                 For j = 1 To grdDataList.Cols - 1
...
'                     If UCase(SystemNumber(grdDataList.TextMatrix(grdDataList.row, 3), 1)) = "FCP" Or UCase(SystemNumber(grdDataList.TextMatrix(grdDataList.row, 3), 1)) = "P" Then
'                         grdDataList.col = 25
                     If grdDataList.TextMatrix(grdDataList.row, colCP01) = "FCP" Or grdDataList.TextMatrix(grdDataList.row, colCP01) = "P" Then
                         grdDataList.col = colCP10
                     'end 2021/05/19
                         If grdDataList.Text = "605" Then
                             CheckOC
