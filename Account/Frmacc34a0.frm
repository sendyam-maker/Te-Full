...
Public adoaccrpt311 As New ADODB.Recordset
Dim strSort1, strSort2, strSort3, strSort4, strSort5 As String
Dim dllaccrpt311 As Object
...
Dim bCancel As Boolean
   ...
   Accrpt311Delete
   ProduceData
   If adoaccrpt311.State = adStateOpen Then
      adoaccrpt311.Close
   End If
   adoaccrpt311.CursorLocation = adUseClient
   adoaccrpt311.Open "select * from accrpt311", adoTaie, adOpenStatic, adLockReadOnly
   If adoaccrpt311.RecordCount <> 0 Then
      '20140120START Modify By eric
      dllaccrpt311.Acc34a0 ReportTitle(311) & "-" & strCmpN, Text2, Text3, MaskEdBox1.Text, MaskEdBox2.Text, StaffQuery(strUserNum), CFDate(ACDate(ServerDate))
      'dllaccrpt311.Acc34a0 ReportTitle(311), Text2, Text3, MaskEdBox1.Text, MaskEdBox2.Text, StaffQuery(strUserNum), CFDate(ACDate(ServerDate))
      '20140120END
   End If
   adoaccrpt311.Close
...
'   Frmacc0000.StatusBar1.Panels(1).Text = MsgText(102)
   Frmacc0000.StatusBar1.Panels(1).Text = MsgText(101)
   Set dllaccrpt311 = CreateObject("AccReport.ReportSelect")
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   MenuEnabled
   StatusClear
   Set dllaccrpt311 = Nothing
   Set Frmacc34a0 = Nothing
End Sub
...
On Error GoTo Checking
   ...
   If MaskEdBox1.Text <> MsgText(601) And MaskEdBox1.Text <> MsgText(29) Then
      strSql = strSql & " and a0e16 >= " & Val(FCDate(MaskEdBox1.Text)) & ""
   End If
...
'   End If
   ...
   adoaccrpt311.CursorLocation = adUseClient
   adoaccrpt311.Open "select * from accrpt311", adoTaie, adOpenDynamic, adLockBatchOptimistic
   adoacc0e0.CursorLocation = adUseClient
   adoacc0e0.Open "select * from acc0e0 where (A0E16 <> 0 AND A0E16 IS NOT NULL) and (a0e15 is null or a0e15 = 0) and (a0e21 is null or a0e21 = 0)" & strSql & strOrder1 & strOrder2 & strOrder3 & strOrder4 & strOrder5, adoTaie, adOpenStatic, adLockReadOnly
   ...
   Do While adoacc0e0.EOF = False
      adoaccrpt311.AddNew
      adoaccrpt311.Fields("r31101").Value = strUserNum
      If IsNull(adoacc0e0.Fields("a0e01").Value) Then
         adoaccrpt311.Fields("r31102").Value = Null
      Else
         adoaccrpt311.Fields("r31102").Value = adoacc0e0.Fields("a0e01").Value
      End If
      If IsNull(adoacc0e0.Fields("a0e07").Value) Then
         adoaccrpt311.Fields("r31103").Value = Null
      Else
         adoaccrpt311.Fields("r31103").Value = adoacc0e0.Fields("a0e07").Value
         adoaccrpt311.Fields("r31104").Value = A0g02Query(adoacc0e0.Fields("a0e01").Value)
      End If
      adoaccrpt311.Fields("r31105").Value = adoacc0e0.Fields("a0e02").Value
      Select Case adoacc0e0.Fields("a0e08").Value
         Case Mid(ComboItem(11), 1, 1)
            adoaccrpt311.Fields("r31106").Value = Mid(ComboItem(11), 4, 2)
         Case Mid(ComboItem(12), 1, 1)
            adoaccrpt311.Fields("r31106").Value = Mid(ComboItem(12), 4, 2)
         Case Mid(ComboItem(13), 1, 1)
            adoaccrpt311.Fields("r31106").Value = Mid(ComboItem(13), 4, 2)
         Case Else
            adoaccrpt311.Fields("r31106").Value = Null
      End Select
      If IsNull(adoacc0e0.Fields("a0e10").Value) Then
         adoaccrpt311.Fields("r31107").Value = Null
      Else
         adoaccrpt311.Fields("r31107").Value = adoacc0e0.Fields("a0e10").Value
      End If
      If IsNull(adoacc0e0.Fields("a0e11").Value) Then
         adoaccrpt311.Fields("r31108").Value = 0
      Else
         adoaccrpt311.Fields("r31108").Value = Val(adoacc0e0.Fields("a0e11").Value)
      End If
      If IsNull(adoacc0e0.Fields("a0e06").Value) Then
         adoaccrpt311.Fields("r31109").Value = Null
      Else
         Select Case adoacc0e0.Fields("A0E05").Value
            Case "1"
               'Modify By Cheng 2002/03/29
'               adoaccrpt311.Fields("r31109").Value = MidB(CustomerQuery(adoacc0e0.Fields("A0E06").Value, 1), 1, 20)
               adoaccrpt311.Fields("r31109").Value = adoacc0e0.Fields("A0E06").Value & MidB(CustomerQuery(adoacc0e0.Fields("A0E06").Value, 1), 1, 12)
            Case "2"
               'Modify By Cheng 2002/03/29
'               adoaccrpt311.Fields("r31109").Value = MidB(A0i02Query(adoacc0e0.Fields("A0E06").Value), 1, 20)
               adoaccrpt311.Fields("r31109").Value = adoacc0e0.Fields("A0E06").Value & MidB(A0i02Query(adoacc0e0.Fields("A0E06").Value), 1, 12)
            Case "3"
               'Modify By Cheng 2002/03/29
'               adoaccrpt311.Fields("r31109").Value = MidB(StaffQuery(adoacc0e0.Fields("A0E06").Value), 1, 20)
               adoaccrpt311.Fields("r31109").Value = adoacc0e0.Fields("A0E06").Value & MidB(StaffQuery(adoacc0e0.Fields("A0E06").Value), 1, 12)
         End Select
      End If
      If IsNull(adoacc0e0.Fields("A0E16").Value) = False Then
         adoaccrpt311.Fields("R31110").Value = adoacc0e0.Fields("A0E16").Value
      End If
      adoaccrpt311.UpdateBatch
      adoacc0e0.MoveNext
   Loop
   adoacc0e0.Close
   adoaccrpt311.Close
   adoTaie.Execute "delete from accrpt311 where r31105 is null"
   StatusClear
Checking:
...
'
'*************************************************
Private Sub Accrpt311Delete()
   adoTaie.Execute "delete from accrpt311"
End Sub
...
'   Label6.Caption = A0802Query(IIf(Text1 = "2", "J", "1"))
'End Sub
''20140120END
