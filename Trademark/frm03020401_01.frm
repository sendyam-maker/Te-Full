...
Begin VB.Form frm03020401_01 
   ...
   End
End
Attribute VB_Name = "frm03020401_01"
...
Private Function CheckDataValid() As Boolean
   ...
   Else
      If CheckIsTaiwanDate(textCP05, False) = False Then
         ...
         GoTo EXITSUB
      End If
      'edit by nickc 2006/03/17 應該要用系統日期
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm03020401_02.SetData 4, textTM12, True
         frm03020401_02.SetData 6, textCP05, False
      Case 1:
         frm03020401_02.SetData 5, textTM15, True
         frm03020401_02.SetData 6, textCP05, False
      Case 2:
         frm03020401_02.SetData 0, Trim(textTM01), True
         frm03020401_02.SetData 1, Trim(textTM02), False
         frm03020401_02.SetData 2, Trim(textTM03), False
         frm03020401_02.SetData 3, Trim(textTM04), False
         frm03020401_02.SetData 6, textCP05, False
   End Select
   Me.Hide
   frm03020401_02.Show
   frm03020401_02.QueryData
End Sub
...
frm03020401_04.ClearLastData
'Add By Cheng 2002/07/19
Set frm03020401_01 = Nothing
End Sub
