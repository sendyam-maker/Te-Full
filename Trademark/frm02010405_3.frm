...
Begin VB.Form frm02010405_3 
   ...
   End
End
Attribute VB_Name = "frm02010405_3"
...
Private Function GetUrgeData(ByVal strKey As String) As String
   ...
   rsTmp2.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly   'edit by nickc 2005/08/04 原先是  動態開啟
   If rsTmp2.RecordCount > 0 Then
      rsTmp2.MoveFirst
      Do While rsTmp2.EOF = False
         If IsNull(rsTmp2.Fields("NP06")) = True Then
            If IsNull(rsTmp2.Fields("NP09")) = False Then
               GetUrgeData = rsTmp2.Fields("NP09")
            End If
            Exit Do
         End If
         If IsEmptyText(rsTmp2.Fields("NP06")) = True Then
            If IsNull(rsTmp2.Fields("NP09")) = False Then
               GetUrgeData = rsTmp2.Fields("NP09")
            End If
            Exit Do
         End If
         rsTmp2.MoveNext 'Add By Sindy 2009/06/30
      Loop
   End If
   rsTmp2.Close
   Set rsTmp2 = Nothing
...
'               End Select
         ...
         End If
         ' 催審期間
         grdList.TextMatrix(grdList.row, 5) = GetUrgeData(strCP09)
         ' 相關人
         bDeal = False
...
Private Sub DisplayNextForm()
   frm02010405_4.SetData 0, m_TM01, True
   frm02010405_4.SetData 1, m_TM02, False
   frm02010405_4.SetData 2, m_TM03, False
   frm02010405_4.SetData 3, m_TM04, False
   frm02010405_4.SetData 4, m_CP05, False
   frm02010405_4.SetData 5, m_CP09, False
   'Added by Morgan 2017/4/21 電子公文
   frm02010405_4.m_DocWord = frm02010405_1.m_DocWord
   frm02010405_4.m_DocNo = frm02010405_1.m_DocNo
   frm02010405_4.m_AppNo = frm02010405_1.m_AppNo
   frm02010405_4.m_DeadLine = frm02010405_1.m_DeadLine
   'end 2017/4/21
   'Add By Sindy 2019/5/10
   If Not m_PrevForm Is Nothing Then
      Call frm02010405_4.SetParent(m_PrevForm)
   End If
   frm02010405_4.m_strIR01 = m_strIR01
   frm02010405_4.m_strIR02 = m_strIR02
   frm02010405_4.m_strIR03 = m_strIR03
   frm02010405_4.m_strIR04 = m_strIR04
   '2019/5/10 END
   Me.Hide
   frm02010405_4.Show
   frm02010405_4.QueryData
End Sub
