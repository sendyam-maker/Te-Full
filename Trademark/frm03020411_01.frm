...
Begin VB.Form frm03020411_01 
   ...
   End
End
Attribute VB_Name = "frm03020411_01"
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm03020411_02.SetData 4, textTM12, True
      Case 1:
         frm03020411_02.SetData 5, textTM15, True
      Case 2:
         frm03020411_02.SetData 0, Trim(textTM01), True
         frm03020411_02.SetData 1, Trim(textTM02), False
         frm03020411_02.SetData 2, Trim(textTM03), False
         frm03020411_02.SetData 3, Trim(textTM04), False
   End Select
   Me.Hide
   frm03020411_02.Show
   frm03020411_02.QueryData
End Sub

Private Sub Form_Unload(Cancel As Integer)
   Set frm03020411_01 = Nothing
End Sub
...
Private Sub radio_Click(Index As Integer)
   ...
   UpdateCtrlState
   ' 設定游標停留的位置
   If Me.Enabled And Screen.ActiveForm.Name = Me.Name Then
      Select Case Index
