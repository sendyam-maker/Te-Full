...
Begin VB.Form frm050720 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   260
      ItemData        =   "frm050720.frx":0000
      Left            =   1530
      List            =   "frm050720.frx":000D
      Style           =   2  '單純下拉式
      TabIndex        =   2
      Top             =   1740
      Width           =   1360
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":0027
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":0343
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":065F
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":083B
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":0B57
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":0E73
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":118F
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":14AB
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":17C7
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":1AE3
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm050720.frx":1DFF
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frm050720"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Create by Sindy 2024/5/22 註冊費報價資料維護
Option Explicit
...
Private Sub textYF03_Change()
   If Len(textYF03) = 9 Then
      ...
      If Left(textYF03, 1) = "Y" Then
         lblCustName = GetFAgentName(textYF03, , , , , , , , , , , , , "0")
      Else
      '2025/7/22 END
...
Private Sub textYF03_Validate(Cancel As Boolean)
   ...
   If m_EditMode = "1" And PUB_PYFIsExists(textYF01, textYF02, textYF03, "717", "1") = True Then
      strExc(0) = "檢核資料"
      strExc(1) = "該筆記錄已存在"
      MsgBox strExc(1), vbOKOnly, strExc(0)
      Cancel = True
   End If
   '開放可輸入臺灣案,但要控制業務區不可為F
...
Private Sub SetCtrlReadOnly(ByVal bLocked As Boolean)
   For Each oText In Me.Controls
      ...
      End If
   Next
   Combo1.Locked = bLocked 'Add By Sindy 2024/7/31
End Sub
'依照權限設定其工具列的按紐狀態
...
Private Function ShowRecord(Optional ByVal p_iWay As Integer = 0, Optional ByVal p_bGridOnly As Boolean) As Boolean
   ...
   stCon = " AND A.YF04='717' AND A.YF05='1'" 'AND substr(A.YF03,1,1)='X'
   
   stKey = textYF01 & textYF02 & textYF03 & "717"
   
   Select Case p_iWay
      Case 0, 3 '當筆
         strExc(0) = "SELECT A.*" & _
            " FROM patentyearfee A" & _
            " WHERE A.YF01||A.YF02||A.YF03||A.YF04='" & stKey & "'" & stCon
            
      Case -2 '首筆
         strExc(0) = "SELECT A.*" & _
            " FROM patentyearfee A" & _
            " WHERE A.YF01||A.YF02||A.YF03||A.YF04||A.YF05=(SELECT MIN(B.YF01||B.YF02||B.YF03||B.YF04||B.YF05)" & _
            " FROM patentyearfee B WHERE 1=1" & Replace(stCon, "A.", "B.") & ")"

      Case -1 '前筆
         strExc(0) = "SELECT A.*" & _
            " FROM patentyearfee A" & _
            " WHERE A.YF01||A.YF02||A.YF03||A.YF04||A.YF05=(SELECT MAX(B.YF01||B.YF02||B.YF03||B.YF04||B.YF05)" & _
            " FROM patentyearfee B WHERE B.YF01||B.YF02||B.YF03||B.YF04<'" & stKey & "'" & Replace(stCon, "A.", "B.") & ")"
...
Private Sub ClearField()
   ...
   textYF01_2 = Empty
   textYF02_2 = Empty
   textYF02.Text = "T" 'T.商標
   Me.Combo1.ListIndex = 0 '台幣 Add By Sindy 2024/7/31
End Sub
   ...
   Select Case m_EditMode
      Case 1: '新增
         ...
         If TxtValidate() = True Then
            '增加判斷
            If PUB_PYFIsExists(textYF01, textYF02, textYF03, "717", "1") = True Then
               strExc(0) = "新增資料"
               strExc(1) = "該筆記錄已存在"
               MsgBox strExc(1), vbOKOnly, strExc(0)
               Exit Function
...
Private Sub UpdateFieldNewData()
   ...
   m_FieldList(4).fiNewData = "717"
   
   m_FieldList(5).fiNewData = "1"
   
   'Add By Sindy 2024/7/31
   If Me.Combo1.Text <> "新台幣" Then
      m_FieldList(6).fiNewData = Val(Format(txtFee))
      m_FieldList(7).fiNewData = ""
   Else
   '2024/7/31 END
   ...
   m_FieldList(15).fiNewData = Combo1.Text 'Add By Sindy 2024/7/31
End Sub
   ...
   With p_Rst
      If .RecordCount > 0 Then
         ...
         For intI = 0 To Me.Combo1.ListCount - 1
            If m_FieldList(15).fiNewData = Combo1.List(intI) Then
         ...
         'Add By Sindy 2024/7/31
         If Me.Combo1.Text <> "新台幣" Then
            txtFee.Text = Val(m_FieldList(6).fiNewData)
            txtScore.Text = ""
            Call Combo1_LostFocus 'Add By Sindy 2024/10/11
         Else
         '2024/7/31 END
...
Private Function SetScore() As Boolean
   If Me.Combo1.Text <> "新台幣" Then SetScore = True: Exit Function 'Add By Sindy 2024/7/31
      
   If Trim(txtFee) <> "" And Trim(textYF01) <> "" Then
      strExc(0) = "select cf08 from casefee where cf01='T' and cf02='" & textYF01 & "' and cf03='717'"
      intI = 1
      Set RsTemp = ClsLawReadRstMsg(intI, strExc(0))
      If intI = 1 Then
...
Private Function SetFee() As Boolean
   If Me.Combo1.Text <> "新台幣" Then SetFee = True: Exit Function 'Add By Sindy 2024/7/31
   
   If Trim(txtScore) <> "" And Trim(textYF01) <> "" Then
      strExc(0) = "select cf08 from casefee where cf01='T' and cf02='" & textYF01 & "' and cf03='717'"
      intI = 1
      Set RsTemp = ClsLawReadRstMsg(intI, strExc(0))
      If intI = 1 Then
