...
Begin VB.Form frm02010408_2 
   ...
   End
End
Attribute VB_Name = "frm02010408_2"
...
Private Function PromptIfTaiwanNoResult() As Boolean
   ...
   If bPrompt = True And frm02010408_1.m_DocNo = "" Then
   'end 2017/4/24
      strTit = "資料檢核"
...
Private Sub DisplayNextForm()
   frm02010408_3.SetData 0, m_CP01, True
   frm02010408_3.SetData 1, m_CP02, False
   frm02010408_3.SetData 2, m_CP03, False
   frm02010408_3.SetData 3, m_CP04, False
   frm02010408_3.SetData 4, m_CP05, False
   If grdList.Rows > 2 Then
      frm02010408_3.SetData 5, "2", False
   Else
      frm02010408_3.SetData 5, "1", False
   End If
   'Add By Sindy 2019/5/10
   If Not m_PrevForm Is Nothing Then
      Call frm02010408_3.SetParent(m_PrevForm)
   End If
   frm02010408_3.m_strIR01 = m_strIR01
   frm02010408_3.m_strIR02 = m_strIR02
   frm02010408_3.m_strIR03 = m_strIR03
   frm02010408_3.m_strIR04 = m_strIR04
   '2019/5/10 END
   Me.Hide
   frm02010408_3.Show
   frm02010408_3.QueryData
End Sub
...
Public Sub QueryData()
   ...
   ElseIf IsEmptyText(m_TM15) = False Then
      nType = 2
   ElseIf IsEmptyText(m_CP09) = False Then
      nType = 4
   End If
   ...
   Select Case nType
      ...
      Case 2:
        ...
        Else
            ...
            If rsTmp.RecordCount > 0 Then
                ' 設定SQL語法
                strSql = "SELECT * FROM TradeMark " & _
                               "WHERE " & ChgTradeMark(rsTmp.Fields(0).Value & rsTmp.Fields(1).Value & rsTmp.Fields(2).Value & rsTmp.Fields(3).Value) & " AND " & _
                               "TM10 < '010' "
                rsTmp.Close
                rsTmp.CursorLocation = adUseClient
                rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly   'edit by nickc 2005/08/04 原先是  動態開啟
      ...
      Case 4:
         ...
         If rsTmp.RecordCount > 0 Then
            rsTmp.MoveFirst
            m_TM01 = rsTmp.Fields("CP01")
            m_TM02 = rsTmp.Fields("CP02")
            m_TM03 = rsTmp.Fields("CP03")
            m_TM04 = rsTmp.Fields("CP04")
         End If
         rsTmp.Close
         If IsEmptyText(m_TM01) = False And IsEmptyText(m_TM02) = False And IsEmptyText(m_TM03) = False And IsEmptyText(m_TM04) = False Then
            strSql = "SELECT * FROM ServicePractice " & _
