...
Begin VB.Form frm02010407_1 
   ...
   End
End
Attribute VB_Name = "frm02010407_1"
...
'91.11.25 Add By SONIA
Dim m_strTM01 As String
Dim m_strTM02 As String
Dim m_strTM03 As String
Dim m_strTM04 As String
         ...
         If rsTmp.RecordCount <= 0 Then
            ...
            Else
                ...
                If rsA.RecordCount <= 0 Then
                    ...
                    GoTo EXITSUB
                Else
                    textTM01 = rsA("TM01").Value
                    textTM02 = rsA("TM02").Value
                    textTM03 = rsA("TM03").Value
                    textTM04 = rsA("TM04").Value
                    strTM01 = textTM01
                    strTM02 = textTM02
                    strTM03 = textTM03
                    strTM04 = textTM04
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm02010407_2.SetData 4, textTM12, True
         frm02010407_2.SetData 6, textCP05, False
      Case 1:
         frm02010407_2.SetData 5, textTM15, True
         frm02010407_2.SetData 6, textCP05, False
      Case 2:
         frm02010407_2.SetData 0, Trim(textTM01), True
         If Trim(textTM01) = "TF" Then
            frm02010407_2.SetData 1, Trim(textTM02) & Trim(textTM02_2), False
         Else
            frm02010407_2.SetData 1, Trim(textTM02), False
         End If
         frm02010407_2.SetData 2, Trim(textTM03), False
         frm02010407_2.SetData 3, Trim(textTM04), False
         frm02010407_2.SetData 6, textCP05, False
         frm02010407_1.Hide
   End Select
   'Add By Sindy 2019/5/10
   If Not m_PrevForm Is Nothing Then
      Call frm02010407_2.SetParent(m_PrevForm)
   End If
   frm02010407_2.m_strIR01 = m_strIR01
   frm02010407_2.m_strIR02 = m_strIR02
   frm02010407_2.m_strIR03 = m_strIR03
   frm02010407_2.m_strIR04 = m_strIR04
   '2019/5/10 END
   Me.Hide
   frm02010407_2.Show
   frm02010407_2.QueryData
End Sub
