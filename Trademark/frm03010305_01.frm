...
Begin VB.Form frm03010305_01 
   ...
   End
End
Attribute VB_Name = "frm03010305_01"
...
Private Sub DisplayNextForm()
   frm03010305_02.SetData 0, Trim(textTM01), True
   frm03010305_02.SetData 1, Trim(textTM02), False
   If IsEmptyText(textTM03) = True Then
      frm03010305_02.SetData 2, "0", False
   Else
      frm03010305_02.SetData 2, Trim(textTM03), False
   End If
   If IsEmptyText(textTM04) = True Then
      frm03010305_02.SetData 3, "00", False
   Else
      frm03010305_02.SetData 3, Trim(textTM04), False
   End If
   frm03010305_02.SetData 4, textCP05, False
   Me.Hide
   frm03010305_02.Show
   frm03010305_02.QueryData
End Sub

Private Sub Form_Unload(Cancel As Integer)
   'Add By Cheng 2002/07/19
   Set frm03010305_01 = Nothing
End Sub
