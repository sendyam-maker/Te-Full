...
Begin VB.Form frm02010406_1 
   ...
   End
End
Attribute VB_Name = "frm02010406_1"
         ...
         If rsTmp.RecordCount > 0 Then
            ...
            If IsNull(rsTmp.Fields("TM10")) = False Then
               If rsTmp.Fields("TM10") < "010" Then
                  rsTmp.Close
                  strMsg = "所選取的資料其申請國家為台灣, 請以審定號數來搜尋"
                  strTit = "檢核資料"
                  nResponse = MsgBox(strMsg, vbOKOnly, strTit)
                  GoTo EXITSUB
               End If
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm02010406_2.SetData 4, textTM15, True
         frm02010406_2.SetData 5, textCP05, False
      Case 1:
         frm02010406_2.SetData 0, Trim(textTM01), True
         If Trim(textTM01) = "TF" Then
            frm02010406_2.SetData 1, Trim(textTM02) & Trim(textTM02_2), False
         Else
            frm02010406_2.SetData 1, Trim(textTM02), False
         End If
         frm02010406_2.SetData 2, Trim(textTM03), False
         frm02010406_2.SetData 3, Trim(textTM04), False
         frm02010406_2.SetData 5, textCP05, False
   End Select
   'Add By Sindy 2019/5/10
   If Not m_PrevForm Is Nothing Then
      Call frm02010406_2.SetParent(m_PrevForm)
   End If
   frm02010406_2.m_strIR01 = m_strIR01
   frm02010406_2.m_strIR02 = m_strIR02
   frm02010406_2.m_strIR03 = m_strIR03
   frm02010406_2.m_strIR04 = m_strIR04
   '2019/5/10 END
   Me.Hide
   frm02010406_2.Show
   frm02010406_2.QueryData
End Sub
