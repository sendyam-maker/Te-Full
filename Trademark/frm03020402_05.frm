...
Begin VB.Form frm03020402_05 
   ...
   Begin TabDlg.SSTab tabCtrl 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "第一頁"
      TabPicture(0)   =   "frm03020402_05.frx":0000
      ...
      Tab(0).Control(25)=   "textCE51"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "textCE53"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "textCE55"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "textCE15"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "textCE14"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "textCE13"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "textCE12"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "textCE11"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "textCE10"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "textCE02"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "textCE04"
      ...
      TabCaption(1)   =   "第二頁"
      TabPicture(1)   =   "frm03020402_05.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "textCE62"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "textCE50"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "textCE48"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "textCE46"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "textCE44"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "textCE60"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "textCE40"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "textCE58"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "textCE38"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "textCE41_1"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "textCE23"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "textCE24"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "textCE25"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "textCE57"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "textCE39"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "textCE41"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "textCE42"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "textCE43"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "textCE45"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "textCE47"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "textCE49"
      ...
      Tab(1).Control(26)=   "Label42"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "Label41"
      ...
      Tab(1).Control(37)=   "Label31"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "Label30"
      Tab(1).Control(38).Enabled=   0   'False
      Tab(1).Control(39)=   "Label29"
      Tab(1).Control(39).Enabled=   0   'False
      Tab(1).Control(40)=   "Label28"
      Tab(1).Control(40).Enabled=   0   'False
      Tab(1).Control(41)=   "Label27"
      Tab(1).Control(41).Enabled=   0   'False
      Tab(1).Control(42)=   "Label26"
      Tab(1).Control(42).Enabled=   0   'False
      Tab(1).Control(43)=   "Label25"
      Tab(1).Control(43).Enabled=   0   'False
      Tab(1).Control(44)=   "Label24"
      Tab(1).Control(44).Enabled=   0   'False
      Tab(1).Control(45)=   "Label23"
   ...
   End
End
Attribute VB_Name = "frm03020402_05"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2021/09/13 改成Form2.0 ; 全部textCExx.textbox
...
cnnConnection.BeginTrans
   ...
   'Add By Sindy 2012/2/16 按確定時先檢查變更事項有值的欄位, 至少要輸入一項核駁, 不可都不選
   If Me.textCE09.Text = "2" Or Me.textCE03.Text = "2" Or _
      Me.textCE16.Text = "2" Or Me.textCE56.Text = "2" Or _
      Me.textCE54.Text = "2" Or Me.textCE52.Text = "2" Or _
      Me.textCE22.Text = "2" Or Me.textCE65.Text = "2" Or _
      Me.textCE38.Text = "2" Or Me.textCE58.Text = "2" Or _
      Me.textCE40.Text = "2" Or Me.textCE60.Text = "2" Or _
      Me.textCE44.Text = "2" Or Me.textCE46.Text = "2" Or _
      Me.textCE48.Text = "2" Or Me.textCE50.Text = "2" Or _
      Me.textCE62.Text = "2" Then
      frm03020402_04.m_blnClkChgButton = True
   End If
   '2012/2/16 End
...
'         'Add By Sindy 2012/2/6 按確定時先檢查變更事項有值的欄位, 至少要輸入一項核駁, 不可都不選
'         If m_CEList(nIndex).fiNewData = "2" Then
'            frm03020402_04.m_blnClkChgButton = True
'         End If
'         '2012/2/6 End
...
'   Else
'      frm03020402_04.m_blnClkChgButton = False
'   '2012/2/6 End
   End If
      ...
      If m_TMList(nIndex).fiOldData <> m_TMList(nIndex).fiNewData Then
         ...
         Else
            If m_TMList(nIndex).fiNewData = Empty Then
               strTmp = m_TMList(nIndex).fiName & " = " & 0
            Else
               strTmp = m_TMList(nIndex).fiName & " = " & m_TMList(nIndex).fiNewData
            End If
         End If
