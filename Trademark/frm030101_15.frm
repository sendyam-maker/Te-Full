...
Begin VB.Form frm030101_15 
   BorderStyle     =   1  '單線固定
   Caption         =   "發文(補充理由, 訴願, 再訴願, 行政訴訟, 參加行政訴訟, 再審之訴)"
   ClientHeight    =   5870
   ClientLeft      =   4440
   ClientTop       =   1810
   ClientWidth     =   9160
   ...
   End
End
Attribute VB_Name = "frm030101_15"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2021/08/11 改成Form2.0 ; textCP13、textCP14、textTM23、cmbTM05、textCP44_2、textCP64、textTM67
...
cnnConnection.BeginTrans
   ...
   Select Case m_TM01
      ' 系統類別為CFT的為儲存商標基本檔
      Case "CFT":
         strSql = "UPDATE TradeMark SET TM67 = '" & textTM67 & "' " & _
                  "WHERE TM01 = '" & m_TM01 & "' AND " & _
                        "TM02 = '" & m_TM02 & "' AND " & _
                        "TM03 = '" & m_TM03 & "' AND " & _
                        "TM04 = '" & m_TM04 & "' "
