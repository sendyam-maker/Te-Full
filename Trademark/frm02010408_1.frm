...
Begin VB.Form frm02010408_1 
   ...
   End
End
Attribute VB_Name = "frm02010408_1"
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm02010408_2.SetData 4, textTM12, True
         frm02010408_2.SetData 6, textCP05, False
      Case 1:
         frm02010408_2.SetData 5, textTM15, True
         frm02010408_2.SetData 6, textCP05, False
      Case 2:
         frm02010408_2.SetData 0, Trim(textTM01), True
         If Trim(textTM01) = "TF" Then
            frm02010408_2.SetData 1, Trim(textTM02) & Trim(textTM02_2), False
         Else
            frm02010408_2.SetData 1, Trim(textTM02), False
         End If
         frm02010408_2.SetData 2, Trim(textTM03), False
         frm02010408_2.SetData 3, Trim(textTM04), False
         frm02010408_2.SetData 6, textCP05, False
      Case 3:
         frm02010408_2.SetData 7, textCP09, True
         frm02010408_2.SetData 6, textCP05, False
   End Select
   'Add By Sindy 2019/5/10
   If Not m_PrevForm Is Nothing Then
      Call frm02010408_2.SetParent(m_PrevForm)
   End If
   frm02010408_2.m_strIR01 = m_strIR01
   frm02010408_2.m_strIR02 = m_strIR02
   frm02010408_2.m_strIR03 = m_strIR03
   frm02010408_2.m_strIR04 = m_strIR04
   '2019/5/10 END
   Me.Hide
   frm02010408_2.Show
   frm02010408_2.QueryData
End Sub
