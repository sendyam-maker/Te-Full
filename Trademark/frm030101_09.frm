...
Begin VB.Form frm030101_09 
   BorderStyle     =   1  '單線固定
   Caption         =   "發文(授權, 再授權, 終止授權, 終止再授權)"
   ClientHeight    =   5640
   ClientLeft      =   5380
   ClientTop       =   1540
   ClientWidth     =   9130
   ...
   End
End
Attribute VB_Name = "frm030101_09"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2021/08/11 改成Form2.0 ; textCP13、textCP14、textTM23、cmbTM05、textCP44_2、textCP50、textCP51、textCP52、textCP64
...
Private Sub cmdMod_Click()
   ...
   frm030101_05.SetParent "frm030101_09"
   'Me.Hide
   frm030101_05.Show
...
Private Sub textCP72_Validate(Cancel As Boolean)
   ...
   If IsEmptyText(textCP72) = False Then
      strTemp = textCP72 & String(9 - Len(textCP72), "0")
      If Len(strTemp) > 8 Then
         strSql = "SELECT * FROM Customer " & _
                  "WHERE CU01 = '" & Mid(strTemp, 1, 8) & "' AND " & _
                        "CU02 = '" & Mid(strTemp, 9, 1) & "'"
      Else
         strSql = "SELECT * FROM Customer " & _
                  "WHERE CU01 = '" & Mid(strTemp, 1, 8) & "' AND " & _
                        "CU02 = '0' "
...
Private Sub OnUpdateField()
   ...
   Else
      SetCPFieldNewData "CP53", textCP53
   End If
   ' 授權期間(迄)
   If IsEmptyText(textCP54) = False Then
      SetCPFieldNewData "CP54", DBDATE(textCP54)
   Else
      SetCPFieldNewData "CP54", textCP54
   End If
   ' 進度備註
