...
Begin VB.Form frm02010504_2 
   ...
   End
End
Attribute VB_Name = "frm02010504_2"
...
Private Function PromptIfTaiwanNoResult() As Boolean
   ...
   If bPrompt = True And frm02010504_1.m_DocNo = "" Then
   'end 2017/4/25
      strTit = "資料檢核"
...
Private Sub DisplayNextForm()
   frm02010504_3.SetData 0, m_CP01, True
   frm02010504_3.SetData 1, m_CP02, False
   frm02010504_3.SetData 2, m_CP03, False
   frm02010504_3.SetData 3, m_CP04, False
   frm02010504_3.SetData 4, m_CP05, False
   If grdList.Rows > 2 Then
      frm02010504_3.SetData 5, "2", False
   Else
      frm02010504_3.SetData 5, "1", False
   End If
   'Add By Sindy 2019/5/22
   If Not m_PrevForm Is Nothing Then
      Call frm02010504_3.SetParent(m_PrevForm)
   End If
   frm02010504_3.m_strIR01 = m_strIR01
   frm02010504_3.m_strIR02 = m_strIR02
   frm02010504_3.m_strIR03 = m_strIR03
   frm02010504_3.m_strIR04 = m_strIR04
   '2019/5/22 END
   Me.Hide
   frm02010504_3.Show
   frm02010504_3.QueryData
End Sub
