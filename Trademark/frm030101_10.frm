...
Begin VB.Form frm030101_10 
   BorderStyle     =   1  '單線固定
   Caption         =   "發文(補正, 答辯, 放棄專用權)"
   ClientHeight    =   6240
   ClientLeft      =   5350
   ClientTop       =   1560
   ClientWidth     =   9150
   ...
   End
End
Attribute VB_Name = "frm030101_10"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2023/10/17 Form2.0已修改 ; grdList從MSFlexGrid改為MSHFlexGrid
'Memo by Lydia 2021/08/11 改成Form2.0 ; textCP13、textCP14、textTM23、cmbTM05、textCP44_2、textCP64、textTM58、grdList改字型=新細明體-ExtB
...
Private Sub cmdMod_Click()
   ...
   frm030101_05.SetParent "frm030101_10"
   Me.Hide
   frm030101_05.Show
