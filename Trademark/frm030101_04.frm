...
Begin VB.Form frm030101_04 
   ...
   End
End
Attribute VB_Name = "frm030101_04"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2023/10/17 Form2.0已修改 ; grdList從MSFlexGrid改為MSHFlexGrid
'Memo by Lydia 2021/08/11 改成Form2.0 ; textTM05、textTM06、textTM07、textTM23、grdList改字型=新細明體-ExtB
