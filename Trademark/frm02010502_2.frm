...
Private Function PromptIfTaiwanNoResult() As Boolean
   ...
   If bPrompt = True And frm02010502_1.m_DocNo = "" Then
   'end 2017/4/25
      strTit = "資料檢核"
...
Private Sub DisplayNextForm()
   frm02010502_3.SetData 0, m_CP01, True
   frm02010502_3.SetData 1, m_CP02, False
   frm02010502_3.SetData 2, m_CP03, False
   frm02010502_3.SetData 3, m_CP04, False
   frm02010502_3.SetData 4, m_CP05, False
   If grdList.Rows > 2 Then
      frm02010502_3.SetData 5, "2", False
   Else
      frm02010502_3.SetData 5, "1", False
   End If
   'Add By Sindy 2019/5/22
   If Not m_PrevForm Is Nothing Then
      Call frm02010502_3.SetParent(m_PrevForm)
   End If
   frm02010502_3.m_strIR01 = m_strIR01
   frm02010502_3.m_strIR02 = m_strIR02
   frm02010502_3.m_strIR03 = m_strIR03
   frm02010502_3.m_strIR04 = m_strIR04
   '2019/5/22 END
   Me.Hide
   frm02010502_3.Show
   frm02010502_3.QueryData
End Sub
...
Private Sub ListData(ByRef rsTmp As ADODB.Recordset)
   ...
   Do While rsTmp.EOF = False
      ...
      End If
      ' 91.01.22 modify by louis (無中文抓英文, 無英文抓日文)
      If IsEmptyText(grdList.TextMatrix(grdList.row, 2)) Then
...
Public Sub QueryData()
   ...
   Dim strTM02 As String, strTM02r As String
         ...
         Select Case strTM01
            Case "T", "FCT":
               ...
               strSql = "SELECT * FROM TradeMark " & _
                  "WHERE TM01 = '" & strTM01 & "' AND " & _
                        ...
                        "TM04 = '" & strTM04 & "'"
            Case "TF":
               '92.12.2 MODIFY BY SONIA
               '' 設定SQL語法
               'strSQL = "SELECT * FROM TradeMark " & _
               '   "WHERE TM01 = '" & strTM01 & "' AND " & _
               '         "TM02 = '" & strTM02 & "' "
               strTM02r = Right(strTM02, 1)
               If strTM02r <> "0" Then
                  strSql = "SELECT * FROM TradeMark " & _
                     "WHERE TM01 = '" & strTM01 & "' AND " & _
                           "TM02 = '" & strTM02 & "' "
               Else
                  strSql = "SELECT * FROM TradeMark " & _
                     "WHERE TM01 = '" & strTM01 & "' AND " & _
                           "TM02 >= '" & strTM02 & "' AND TM02<= '" & Left(strTM02, 5) & "9' "
               End If
            ...
            Case "TD":
               ...
               strSql = "SELECT SP01 AS TM01,SP02 AS TM02,SP03 AS TM03,SP04 AS TM04,SP05 AS TM05,SP06 AS TM06,SP07 AS TM07,SP09 AS TM10 " & _
                  ",'' AS TM08,'' AS TM09,SP08 AS TM23 FROM SERVICEPRACTICE " & _
