VERSION 5.00
Begin VB.Form frm03020407_01 
   BorderStyle     =   1  '單線固定
   Caption         =   "延期受理(延期、暫緩審理核准)"
   ClientHeight    =   2460
   ClientLeft      =   240
   ClientTop       =   4290
   ClientWidth     =   4920
   ...
   End
End
Attribute VB_Name = "frm03020407_01"
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm03020407_02.SetData 4, textTM12, True
         frm03020407_02.SetData 6, textCP05, False
      Case 1:
         frm03020407_02.SetData 5, textTM15, True
         frm03020407_02.SetData 6, textCP05, False
      Case 2:
         frm03020407_02.SetData 0, Trim(textTM01), True
         frm03020407_02.SetData 1, Trim(textTM02), False
         frm03020407_02.SetData 2, Trim(textTM03), False
         frm03020407_02.SetData 3, Trim(textTM04), False
         frm03020407_02.SetData 6, textCP05, False
   End Select
   Me.Hide
   frm03020407_02.Show
   frm03020407_02.QueryData
End Sub

Private Sub Form_Unload(Cancel As Integer)
   'Add By Cheng 2002/07/18
   Set frm03020407_01 = Nothing
End Sub
