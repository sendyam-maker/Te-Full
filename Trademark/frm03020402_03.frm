...
Begin VB.Form frm03020402_03 
   ...
   End
End
Attribute VB_Name = "frm03020402_03"
...
Private Sub Initial()
   ...
   Select Case frm03020402_01.m_NewCP10
      Case "1002"
         textResult = "1"
      Case "1403"
         textResult = "2"
...
Private Sub ListData()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      Do While rsTmp.EOF = False
         ...
         ' 結果欄位 (結果欄位為 2 時表列出所有的資料) modify by sonia 90.11.20
...
Private Sub DisplayNextForm()
   frm03020402_04.SetData 0, m_TM01, True
   frm03020402_04.SetData 1, m_TM02, False
   frm03020402_04.SetData 2, m_TM03, False
   frm03020402_04.SetData 3, m_TM04, False
   frm03020402_04.SetData 4, m_CP05, False
   frm03020402_04.SetData 5, m_CP09, False
   'Added by Morgan 2017/5/3 電子公文
   frm03020402_04.m_DocWord = frm03020402_01.m_DocWord
   frm03020402_04.m_DocNo = frm03020402_01.m_DocNo
   frm03020402_04.m_AppNo = frm03020402_01.m_AppNo
   frm03020402_04.m_DeadLine = frm03020402_01.m_DeadLine
   'end 2017/5/3
   Me.Hide
   frm03020402_04.Show
   frm03020402_04.SetLastData
   frm03020402_04.QueryData
End Sub
