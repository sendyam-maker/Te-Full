...
Begin VB.Form frm02010503_2 
   ...
   End
End
Attribute VB_Name = "frm02010503_2"
...
'moev to unload by nick 2004/10/22
'    '列印接洽接案單
...
Private Function PromptIfTaiwanNoResult() As Boolean
   ...
   If bPrompt = True And frm02010503_1.m_DocNo = "" Then
   'end 2017/4/25
      strTit = "資料檢核"
...
Private Sub DisplayNextForm()
   frm02010503_3.SetData 0, m_CP01, True
   frm02010503_3.SetData 1, m_CP02, False
   frm02010503_3.SetData 2, m_CP03, False
   frm02010503_3.SetData 3, m_CP04, False
   frm02010503_3.SetData 4, m_CP05, False
   If grdList.Rows > 2 Then
      frm02010503_3.SetData 5, "2", False
   Else
      frm02010503_3.SetData 5, "1", False
   End If
   'Add By Sindy 2019/5/22
   If Not m_PrevForm Is Nothing Then
      Call frm02010503_3.SetParent(m_PrevForm)
   End If
   frm02010503_3.m_strIR01 = m_strIR01
   frm02010503_3.m_strIR02 = m_strIR02
   frm02010503_3.m_strIR03 = m_strIR03
   frm02010503_3.m_strIR04 = m_strIR04
   '2019/5/22 END
   Me.Hide
   frm02010503_3.Show
   frm02010503_3.QueryData
End Sub
      ...
      Case 3:
         ...
         Select Case strTM01
            ...
            Case "TD", "TM":
               ...
               End If
               ' 設定SQL語法
               strSql = "SELECT SP01 AS TM01,SP02 AS TM02,SP03 AS TM03,SP04 AS TM04,SP05||SP06||SP07 AS TM05,SP09 AS TM10 " & _
