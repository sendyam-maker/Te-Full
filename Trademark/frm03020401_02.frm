...
Begin VB.Form frm03020401_02 
   ...
   End
End
Attribute VB_Name = "frm03020401_02"
...
'2006/6/1 CANCEL BY SONIA 移至frm03020401_03檢查,因為申請有第一期註冊費期限,其他案件性質無期限
'' 檢查來函記錄檔
...
Private Sub cmdOK_Click()
   ...
   Else
      ...
      GoTo EXITSUB
   End If
   '2006/6/1 MODIFY BY SONIA 移至frm03020401_03檢查,因為申請有第一期註冊費期限,其他案件性質無期限
...
Private Sub DisplayNextForm()
   frm03020401_03.SetData 0, m_CP01, True
   frm03020401_03.SetData 1, m_CP02, False
   frm03020401_03.SetData 2, m_CP03, False
   frm03020401_03.SetData 3, m_CP04, False
   frm03020401_03.SetData 4, m_CP05, False
   If grdList.Rows > 2 Then
      frm03020401_03.SetData 5, "2", False
   Else
      frm03020401_03.SetData 5, "1", False
   End If
   Me.Hide
   frm03020401_03.Show
   frm03020401_03.QueryData
End Sub
...
Private Sub ListData(ByRef rsTmp As ADODB.Recordset)
   ...
   Do While rsTmp.EOF = False
      ...
      '91.12.22 ADD BY SONIA
      Else
         grdList.TextMatrix(grdList.row, 2) = ""
      '91.12.22 END
      End If
      ' 申請國家
      If IsNull(rsTmp.Fields("TM10")) = False Then
