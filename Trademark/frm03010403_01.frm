...
Begin VB.Form frm03010403_01 
   ...
   End
End
Attribute VB_Name = "frm03010403_01"
...
Private Sub DisplayNextForm()
   frm03010403_02.SetData 0, Trim(textTM01), True
   frm03010403_02.SetData 1, Trim(textTM02), False
   If IsEmptyText(textTM03) = True Then
      frm03010403_02.SetData 2, "0", False
   Else
      frm03010403_02.SetData 2, Trim(textTM03), False
   End If
   If IsEmptyText(textTM04) = True Then
      frm03010403_02.SetData 3, "00", False
   Else
      frm03010403_02.SetData 3, Trim(textTM04), False
   End If
   frm03010403_02.SetData 4, textCP05, False
   'Add By Sindy 2023/4/27
   If Not m_PrevForm Is Nothing Then
      Call frm03010403_02.SetParent(m_PrevForm)
   End If
   frm03010403_02.m_strIR01 = m_strIR01
   frm03010403_02.m_strIR02 = m_strIR02
   frm03010403_02.m_strIR03 = m_strIR03
   frm03010403_02.m_strIR04 = m_strIR04
   '2023/4/27 END
   Me.Hide
   frm03010403_02.Show
   frm03010403_02.QueryData
End Sub
