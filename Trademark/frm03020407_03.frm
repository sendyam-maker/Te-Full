...
Begin VB.Form frm03020407_03 
   ...
   End
End
Attribute VB_Name = "frm03020407_03"
...
Private Sub ListData()
   ...
   'MODIFY BY SONIA 90.1.10
   'strSQL = "SELECT * FROM CaseProgress " & _
   '         "WHERE CP01 = '" & m_TM01 & "' AND " & _
   '               "CP02 = '" & m_TM02 & "' AND " & _
   '               "CP03 = '" & m_TM03 & "' AND " & _
   '               "CP04 = '" & m_TM04 & "' "
   'Modify By Sindy 2015/11/3 增加310.暫緩審理
   strSql = "SELECT CP05,CP09,CP10,CP24,CP27,CP40,CP41,CP42,CP50,CP51,CP52,CP55,CP56 FROM CaseProgress " & _
         "WHERE CP01 = '" & m_TM01 & "' AND " & _
               "CP02 = '" & m_TM02 & "' AND " & _
               "CP03 = '" & m_TM03 & "' AND " & _
               "CP04 = '" & m_TM04 & "' AND " & _
               "CP10 in('303','310') AND CP27 IS NOT NULL " & _
...
Private Sub DisplayNextForm()
   frm03020407_04.SetData 0, m_TM01, True
   frm03020407_04.SetData 1, m_TM02, False
   frm03020407_04.SetData 2, m_TM03, False
   frm03020407_04.SetData 3, m_TM04, False
   frm03020407_04.SetData 4, m_CP05, False
   frm03020407_04.SetData 5, m_CP09, False
   'Added by Morgan 2017/5/9 電子公文
   frm03020407_04.m_DocWord = frm03020407_01.m_DocWord
   frm03020407_04.m_DocNo = frm03020407_01.m_DocNo
   frm03020407_04.m_AppNo = frm03020407_01.m_AppNo
   frm03020407_04.m_DeadLine = frm03020407_01.m_DeadLine
   'end 2017/5/9
   frm03020407_04.Show
   frm03020407_04.QueryData
   Me.Hide
End Sub
