...
Begin VB.Form frm03010402_02 
   ...
   End
End
Attribute VB_Name = "frm03010402_02"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2023/10/20 Form2.0已修改 ; grdList從MSFlexGrid改為MSHFlexGrid
'Memo by Lydia 2021/08/13 改成Form2.0 ;textTM23、cmbTM05、grdList改字型=新細明體-ExtB
...
Private Sub Form_Load()
   ...
   'Add By Sindy 2023/4/27
   m_strIR01 = frm03010402_01.m_strIR01
   m_strIR02 = frm03010402_01.m_strIR02
   m_strIR03 = frm03010402_01.m_strIR03
   m_strIR04 = frm03010402_01.m_strIR04
   If m_strIR01 <> "" Then
...
Private Sub ListData()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      Do While rsTmp.EOF = False
         ...
         End Select
         ' C類只取 被異議(理由), 被評定(理由), 被廢止(理由), 通知參加訴願, 通知參加訴訟, 通知言詞辯論, 通知準備程序, 通知行政上訴答辯
         If Mid(rsTmp.Fields("CP09"), 1, 1) = "C" Then
            If IsNull(rsTmp.Fields("CP10")) = False Then
               Select Case rsTmp.Fields("CP10")
                  Case "1602", "1604", "1606", "1404", "1405", "1203", "1204", "1406":
                  Case Else: GoTo NextRecord
               End Select
            End If
         End If
...
Private Sub DisplayNextForm()
   frm03010402_03.SetData 0, m_TM01, True
   frm03010402_03.SetData 1, m_TM02, False
   frm03010402_03.SetData 2, m_TM03, False
   frm03010402_03.SetData 3, m_TM04, False
   frm03010402_03.SetData 4, m_CP05, False
   frm03010402_03.SetData 5, m_CP09, False
   'Add By Sindy 2023/4/27
   If Not m_PrevForm Is Nothing Then
      Call frm03010402_03.SetParent(m_PrevForm)
   End If
   frm03010402_03.m_strIR01 = m_strIR01
   frm03010402_03.m_strIR02 = m_strIR02
   frm03010402_03.m_strIR03 = m_strIR03
   frm03010402_03.m_strIR04 = m_strIR04
   '2023/4/27 END
   Me.Hide
   frm03010402_03.Show
   frm03010402_03.QueryData
End Sub
