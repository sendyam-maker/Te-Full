...
Begin VB.Form frm03020408_01 
   ...
   End
End
Attribute VB_Name = "frm03020408_01"
...
Public iStiu As Integer 'Added by Lydia 2015/05/05 與"更改來函期限" 共用
...
Private Sub Form_Activate()
  ...
  If iStiu = 2 Then
     ...
     radio(2).Value = 1
     '變更表單顯示
     textTM12.Visible = False: textTM15.Visible = False
     textCP05.Visible = False: Label1.Visible = False
     radio(0).Visible = False: radio(1).Visible = False
     textTM01.Visible = True: textTM02.Visible = True
     textTM03.Visible = True: textTM04.Visible = True
     textTM01.Top = 720: textTM02.Top = 720
     textTM03.Top = 720: textTM04.Top = 720
     Me.Height = 1455
     lblCno.Visible = True
     radio(2).Visible = False
  End If
...
Private Function CheckDataValid() As Boolean
   ...
   If iStiu = 1 Then   'Added by Lydia 2015/05/05
        ' 檢查來函收文日
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm03020408_02.SetData 4, textTM12, True
         frm03020408_02.SetData 6, textCP05, False
      Case 1:
         frm03020408_02.SetData 5, textTM15, True
         frm03020408_02.SetData 6, textCP05, False
      Case 2:
         frm03020408_02.SetData 0, Trim(textTM01), True
         frm03020408_02.SetData 1, Trim(textTM02), False
         frm03020408_02.SetData 2, Trim(textTM03), False
         frm03020408_02.SetData 3, Trim(textTM04), False
         frm03020408_02.SetData 6, textCP05, False
   End Select
   Me.Hide
   frm03020408_02.Show
   frm03020408_02.QueryData
End Sub

Private Sub Form_Unload(Cancel As Integer)
   'Add By Cheng 2002/07/18
   Set frm03020408_01 = Nothing
End Sub
