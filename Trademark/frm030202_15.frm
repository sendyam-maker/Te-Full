...
Begin VB.Form frm030202_15 
   ...
   End
End
Attribute VB_Name = "frm030202_15"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2021/09/10 改成Form2.0 ;cmbTM05、textCP13、textCP14、textCP64、textTM44、textTM23、textTM78~81、lstNameAgent、textTM67(111/8/8)
...
Private Sub QueryTradeMark()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      textTM118 = Empty
      If IsNull(rsTmp.Fields("TM118")) = False Then: textTM118 = rsTmp.Fields("TM118")
      SetTMSPFieldOldData "TM118", textTM118, 0
   End If
   rsTmp.Close
   Set rsTmp = Nothing
End Sub
...
Private Sub QueryCaseProgress()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      If IsNull(rsTmp.Fields("CP17")) = False And textCP84.Enabled = True Then
          ...
          '2009/4/2 modify by sonia FCT-027976陳金蓮說申請意見書雖延期但可能發文時也要繳規費
      ...
      'add by nickc 2007/03/08 若是申請意見書，則同意書商標號數就要出現
      If m_CP10 = "202" Then
        textTM118.Enabled = True
        Label17.Enabled = True
      Else
        textTM118.Enabled = False
...
Private Sub OnUpdateField()
   ...
   'add by nickc  2007/03/08 若是申請意見書，則要存  同意書商標號數
   SetTMSPFieldNewData "TM118", textTM118
   ' 預估結果
...
cnnConnection.BeginTrans
   ...
   '''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'cancel by sonia 2023/11/17 阿蓮說都取消
'   ' 更新相關總收文號資料中的承辦人代號, 預估勝敗, 條款, 進度備註
'   If IsNull(textCP43) = False Then
'      strSql = "UPDATE CaseProgress SET CP14 = '" & m_CP14 & "', " & _
'                                       "CP23 = '" & textCP23 & "', " & _
'                                       "CP49 = '" & textCP49 & "', " & _
'                                       "CP64 = '" & textCP64 & "' " & _
'               "WHERE CP09 = '" & textCP43 & "' "
...
'            g_PrtForm001.PrintForm strNP22, m_TM01, m_TM02, m_TM03, m_TM04
   ...
   rsTmp.Close
   '2012/9/10 End
   'Added by Lydia 2016/06/08 申請之申請意見書202發文，以發文日+6個月更新申請之催審期限。
   If m_CP10 = "202" And Trim(textCP43) <> "" Then
       strExc(2) = ""
       strExc(1) = CompDate(1, 6, DBDATE(textCP27))
       If Left(textCP43, 1) >= "C" Then '依機關來函
          strSql = "select c2.cp09,c2.cp10 from caseprogress c1,caseprogress c2 where c1.cp09='" & textCP43 & "' and c1.cp43=c2.cp09(+) and nvl(c2.cp27,0) > 0  "
       Else
          strSql = "select cp09,cp10 from caseprogress where cp09='" & textCP43 & "' and nvl(cp27,0) > 0 "
       End If
       intI = 1
