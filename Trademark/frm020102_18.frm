...
Begin VB.Form frm020102_18 
   ...
   Begin VB.TextBox textSP32 
      ...
      Width           =   2412
   End
   Begin VB.CommandButton cmdCCCCode 
      Caption         =   "CCC Code(&C)"
      Height          =   400
      Left            =   3720
      TabIndex        =   17
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "發文資料"
      TabPicture(0)   =   "frm020102_18.frx":0000
      ...
      Tab(0).Control(16)=   "Label39"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "lblCP113(18)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "textCP64"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "textCP44_2"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "textCP22"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "textCP27"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "textCP54"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "textCP53"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "textPrint"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "textCP18"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "textCF09"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "textCP28"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "textTM22"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "textTM21"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "textComputer"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "textCP44"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "textCP84"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "txtCP113"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).ControlCount=   34
      TabCaption(1)   =   "被授權人"
      TabPicture(1)   =   "frm020102_18.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "textCP72"
      Tab(1).Control(1)=   "textCP51"
      Tab(1).Control(2)=   "textTM58"
      Tab(1).Control(3)=   "textCP52"
      Tab(1).Control(4)=   "textCP50"
   ...
   Begin MSForms.TextBox textTM78 
      ...
      FontPitchAndFamily=   34
   End
   Begin MSForms.ComboBox cmbTM05_S 
      Height          =   300
      Left            =   1230
      TabIndex        =   61
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frm020102_18"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Amy 2021/12/27 Form2.0已修改 textCP13/textCP14/textCP44_2/lblCP14/textTM23(申請人名).../cmbTM05/cmbTM05_S/textRCP64/textCP64/textCP50/textCP52/textTM58
...
Dim m_CP44New As String        '2008/10/20 add by sonia
...
Private Sub Form_Load()
   ...
   '2008/10/20 add by sonia TM-000046
...
Private Sub QueryServicePractice()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      If IsNull(rsTmp.Fields("SP20")) = False Then
         textTM21 = rsTmp.Fields("SP20")
      End If
      ' 專用期間(迄)
      If IsNull(rsTmp.Fields("SP21")) = False Then
         textTM22 = rsTmp.Fields("SP21")
      End If
      ' CCC Code
      m_SP24 = Empty
      ...
      End If
      SetTMSPFieldOldData "SP24", m_SP24, 0
      ' 是否授權
      m_SP25 = Empty
      If IsNull(rsTmp.Fields("SP25")) = False Then
         m_SP25 = rsTmp.Fields("SP25")
      End If
      SetTMSPFieldOldData "SP25", m_SP25, 0
      'add by nickc 2006/11/17
      ...
      If IsNull(rsTmp.Fields("SP32")) = False Then
         ...
         ' 搜尋商標基本檔其必須符合商標種類及目前准駁的案件
         'Modify By Cheng 2002/07/15
'         strSubSQL = "SELECT * FROM TradeMark " & _
'                     "WHERE TM15 = '" & rsTmp.Fields("SP32") & "' AND " & _
'                           "(TM08 = '1' OR TM08 = '2' OR TM08 = '3') AND " & _
'                           "TM16 = '1' "
         strSubSQL = "SELECT * FROM TradeMark " & _
                     "WHERE TM15 = '" & rsTmp.Fields("SP32") & "' AND " & _
                           "TM16 = '1' "
         ...
         If rsSubTmp.RecordCount > 0 Then
            ...
            If IsNull(rsSubTmp.Fields("TM05")) = False Then
               cmbTM05_S.AddItem rsSubTmp.Fields("TM05")
            End If
            ' 商標英文名稱
            If IsNull(rsSubTmp.Fields("TM06")) = False Then
               cmbTM05_S.AddItem rsSubTmp.Fields("TM06")
            End If
            ' 商標日文名稱
            If IsNull(rsSubTmp.Fields("TM07")) = False Then
               cmbTM05_S.AddItem rsSubTmp.Fields("TM07")
            End If
            ' 顯示商標名稱
            If cmbTM05_S.ListCount > 0 Then
               cmbTM05_S.ListIndex = 0
            End If
            'Add By Cheng 2002/07/17
            m_TM21 = Empty
            If IsNull(rsSubTmp.Fields("TM21")) = False Then
               m_TM21 = rsSubTmp.Fields("TM21")
            End If
            ' 專用期間止日
            'Add By Cheng 2002/07/17
            m_TM22 = Empty
            If IsNull(rsSubTmp.Fields("TM22")) = False Then
               m_TM22 = rsSubTmp.Fields("TM22")
               textTM22S = TAIWANDATE(rsSubTmp.Fields("TM22"))
            End If
         End If
         rsSubTmp.Close
         Set rsSubTmp = Nothing
...
Dim nIndex As Integer
Dim bFind As Boolean
Dim strTempName As String        '2008/10/20 add by sonia
...
Dim m_Official As String    '銷帳規費   2012/8/3 add by sonia
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      ' 發文字號
      textCP28 = Empty
      If IsNull(rsTmp.Fields("CP28")) = False Then
         textCP28 = rsTmp.Fields("CP28")
      End If
      SetCPFieldOldData "CP28", textCP28, 0
      '2008/10/20 add by sonia TM-000046
      ...
      Label4 = "專用期間 :"    '2010/5/12 add by sonia
      'Add By Sindy 2009/04/30 發文規費
      'Modify By Sindy 2009/06/25
      '801監視系統登錄時不預設發文規費,可不必輸入
      If m_CP10 <> "801" And m_CP10 <> "708" Then
         ...
         End If
         '2010/5/12 end
      ElseIf m_CP10 = "708" Then '708繳費
         '取得案件性質801監視系統登錄的該筆規費
         strExc(0) = "select * from caseprogress where cp01='" & m_TM01 & "' and cp02='" & m_TM02 & "' and cp03='" & m_TM03 & "' and cp04='" & m_TM04 & "' and cp10='801' "
         intI = 1
         Set RsTemp = ClsLawReadRstMsg(intI, strExc(0))
         If intI = 1 Then
            If IsNull(RsTemp.Fields("CP17")) = False And textCP84.Enabled = True Then
               m_CP84 = CheckStr(RsTemp.Fields("CP17"))
               textCP84.Text = m_CP84
            End If
         End If
      End If
...
Public Sub QueryData()
   ...
   '2014/2/17 ADD BY SONIA 變更才可輸入,但變更不出現此畫面所以MARK
   ...
   Line1.Visible = False
   'modify by sonia 2023/11/23 延展才可輸入TM-000071再打開MARK,同時加授權502
'   If m_CP10 = "301" Then
   If m_CP10 = "102" Or m_CP10 = "502" Then
      textCP53.Enabled = True
      textCP53.Visible = True
      textCP54.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   Set frm020102_18 = Nothing
End Sub

' 是否為電腦程式
Private Sub textComputer_Validate(Cancel As Boolean)
   Dim strTit As String
   Dim strMsg As String
   Dim nResponse
   Cancel = False
   If IsEmptyText(textComputer) = False Then
      Select Case textComputer
         Case " ", "Y":
         Case Else
            Cancel = True
            strTit = "資料檢核"
...
' 發文字號
Private Sub textCP28_Validate(Cancel As Boolean)
   Dim strTit As String
   Dim strMsg As String
   Dim nResponse
   Cancel = False
   ' 發文字號有可能是中文
   If CheckLengthIsOK(textCP28, 15) = False Then
      Cancel = True
      strTit = "檢核資料"
      strMsg = "發文字號內容太長"
      textCP28_GotFocus
...
Private Sub textCP53_Validate(Cancel As Boolean)
   ...
   If IsEmptyText(textCP53) = False Then
      'modify by sonia 2023/11/23 依案件性質判斷西元年或民國年
      If m_CP10 = "502" Then
   ...
   If IsEmptyText(textCP54) = False Then
      ...
      If IsEmptyText(m_TM22) = False Then
         If Val(DBDATE(textCP54)) > Val(DBDATE(m_TM22)) Then
            Cancel = True
            strTit = "檢核資料"
            '2010/5/12 modify by sonia
            'strMsg = "專用期限止日不可超過原專用期限止日"
            If m_CP10 = "502" Then
               strMsg = "授權期間止日不可超過原專用期間止日"
            Else
               strMsg = "專用期間止日不可超過原專用期間止日"
            End If
            '2010/5/12 end
            nResponse = MsgBox(strMsg, vbOKOnly, strTit)
            textCP54_GotFocus
...
Private Sub textCP72_Validate(Cancel As Boolean)
   ...
   If IsEmptyText(textCP72) = False Then
      textCP72 = textCP72 & String(9 - Len(textCP72), "0")
      ...
      If rsTmp.RecordCount > 0 Then
         ...
         End If
         'add by nick 2004/07/22 nick  檢查該申請人或代理人狀態，若為不再使用則停在原地
...
Private Sub OnUpdateField()
   ...
   ' 發文字號
   SetCPFieldNewData "CP28", textCP28
   ' 代理人代號 2008/10/20 add by sonia
   If IsEmptyText(textCP44) = False Then
   ...
   Select Case m_TM01
      Case "T", "TF", "FCT":
         ...
         End If
      Case Else:
         SetTMSPFieldNewData "SP24", m_SP24
         SetTMSPFieldNewData "SP25", m_SP25
...
OnUpdateServicePractice = True
   ...
   '若案件性質為"監視系統申請"(801), 且申請國家為台灣時, 發文日同時更新服務基本檔的申請日
   If m_CP10 = "801" And m_TM10 = 台灣國家代號 Then
      ...
      If IsNull(rsTmp.Fields("CF23")) = False Then
         ...
         'strSql = "INSERT INTO NextProgress (NP01,NP02,NP03,NP04,NP05,NP07,NP08,NP09,NP10,NP22) " & _
                  "VALUES ('" & m_CP09 & "','" & m_TM01 & "','" & m_TM02 & "','" & m_TM03 & "','" & m_TM04 & "'," & strNP07 & "," & _
                            strNP08 & "," & strNP08 & ",'" & strUserNum & "'," & GetNextProgressNo() & ")"
         strSql = "INSERT INTO NextProgress (NP01,NP02,NP03,NP04,NP05,NP07,NP08,NP09,NP10,NP22) " & _
                  "VALUES ('" & m_CP09 & "','" & m_TM01 & "','" & m_TM02 & "','" & m_TM03 & "','" & m_TM04 & "'," & strNP07 & "," & _
                            PUB_GetWorkDay1(strNP08, True) & "," & strNP08 & ",'" & strUserNum & "'," & GetNextProgressNo() & ")"
         cnnConnection.Execute strSql
...
Private Function CheckDataValid() As Boolean
   ...
   Dim strMsg As String
   Dim nResponse
   Dim strTemp As String   'add by sonia 2023/11/23
   ...
   If m_CP10 = "102" Or m_CP10 = "502" Then
      ...
      End If
      If m_CP10 = "102" Then
         strTemp = DBDATE(DateAdd("d", 1, ChangeWStringToWDateString(DBDATE(textTM22))))
         If DBDATE(textCP53) <> strTemp Then
            strTit = "檢核資料"
            ...
            GoTo EXITSUB
         End If
         strTemp = DBDATE(textTM22) + 100000
         If DBDATE(textCP54) <> strTemp Then
            strTit = "檢核資料"
   ...
   ' 2008/10/20 add by sonia 申請國家非台灣時代理人不可空白
   If m_TM10 >= "010" Then
   ...
   '案件性質為708繳費時,發文規費一定要輸入
   If m_CP10 = "708" Then
      If IsEmptyText(textCP84) = True Then
         strTit = "檢核資料"
         strMsg = "請輸入發文規費"
         nResponse = MsgBox(strMsg, vbOKOnly, strTit)
         textCP84.SetFocus
...
Private Sub textComputer_GotFocus()
   InverseTextBox textComputer
End Sub
       ...
       If textComputer = "Y" Then
          ...
          If textPrint = "1" Then
            ...
            strSql = "INSERT INTO EXCEPTCONDITION (ET01,ET02,ET03,ET04,ET05,ET06) " & _
                     "VALUES ('" & "01" & "','" & m_CP09 & "','" & "27" & "','" & strUserNum & "'," & _
                     "'" & "回音" & "','" & textCF09 & "')"
            cnnConnection.Execute strSql
           End If
       Else
...
'2012/1/12 End
   ...
   If m_CP10 = "801" Or m_CP10 = "809" Then
      '2008/11/28 ADD BY SONIA 加入判斷申請國家
      If m_TM10 <> "000" Then
         If textPrint = "1" Then
            ' 列印定稿
...
'               NowPrint m_CP09, "01", "27", False, strUserNum, 0
            ...
            End If
         Else
            'add by nickc 2006/04/28 加入申請人國及非台灣的新定稿
            'edit by nickc 2006/06/29
            'If strTM23Nation = "000" Then
            If textPrint = "1" Then
               ' 列印定稿
...
Dim Cancel As Boolean
   ...
   If Me.textComputer.Enabled = True Then
      Cancel = False
      textComputer_Validate Cancel
      If Cancel = True Then
         Exit Function
      End If
   End If
   ...
   If Me.textCP28.Enabled = True Then
      Cancel = False
      textCP28_Validate Cancel
      If Cancel = True Then
         Exit Function
      End If
   End If
   '2008/10/20 add by sonia
