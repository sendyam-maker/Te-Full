...
Begin VB.Form frm03020405_01 
   ...
   End
End
Attribute VB_Name = "frm03020405_01"
...
Public iStiu As Integer 'Added by Lydia 2017/03/07 與"通知已轉他所(1724)" 共用 (frm03020405_05)
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm03020405_02.SetData 4, textTM12, True
         frm03020405_02.SetData 6, textCP05, False
      Case 1:
         frm03020405_02.SetData 5, textTM15, True
         frm03020405_02.SetData 6, textCP05, False
      Case 2:
         frm03020405_02.SetData 0, Trim(textTM01), True
         frm03020405_02.SetData 1, Trim(textTM02), False
         frm03020405_02.SetData 2, Trim(textTM03), False
         frm03020405_02.SetData 3, Trim(textTM04), False
         frm03020405_02.SetData 6, textCP05, False
   End Select
   Me.Hide
   frm03020405_02.Show
   frm03020405_02.QueryData
End Sub

Private Sub Form_Unload(Cancel As Integer)
   'Add By Cheng 2002/07/19
   Set frm03020405_01 = Nothing
End Sub
