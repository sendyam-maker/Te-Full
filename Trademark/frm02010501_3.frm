...
Begin VB.Form frm02010501_3 
   ...
   End
End
Attribute VB_Name = "frm02010501_3"
   ...
   '2012/7/23 END
         strSql = "SELECT * FROM TradeMark " & _
                     "WHERE TM01 = '" & m_TM01 & "' AND " & _
                           ...
                           "TM03 = '" & m_TM03 & "' AND " & _
                           "TM04 = '" & m_TM04 & "'"
   End Select  '2012/7/23 ADD BY SONIA
...
Private Sub DisplayNextForm()
   frm02010501_4.SetData 0, m_TM01, True
   frm02010501_4.SetData 1, m_TM02, False
   frm02010501_4.SetData 2, m_TM03, False
   frm02010501_4.SetData 3, m_TM04, False
   frm02010501_4.SetData 4, m_CP05, False
   frm02010501_4.SetData 5, m_CP09, False
   'Added by Morgan 2017/4/24 電子公文
   frm02010501_4.m_DocWord = frm02010501_1.m_DocWord
   frm02010501_4.m_DocNo = frm02010501_1.m_DocNo
   frm02010501_4.m_AppNo = frm02010501_1.m_AppNo
   frm02010501_4.m_DeadLine = frm02010501_1.m_DeadLine
   'end 2017/4/24
   'Add By Sindy 2019/5/22
   If Not m_PrevForm Is Nothing Then
      Call frm02010501_4.SetParent(m_PrevForm)
   End If
   frm02010501_4.m_strIR01 = m_strIR01
   frm02010501_4.m_strIR02 = m_strIR02
   frm02010501_4.m_strIR03 = m_strIR03
   frm02010501_4.m_strIR04 = m_strIR04
   '2019/5/22 END
   Me.Hide
   frm02010501_4.Show
   frm02010501_4.QueryData
End Sub
