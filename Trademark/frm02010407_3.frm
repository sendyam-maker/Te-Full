...
Begin VB.Form frm02010407_3 
   ...
   End
End
Attribute VB_Name = "frm02010407_3"
...
Private Sub ListData()
   ...
   strSql = "SELECT * FROM CaseProgress " & _
            "WHERE CP01 = '" & m_TM01 & "' AND " & _
                  ...
                  "CP03 = '" & m_TM03 & "' AND " & _
                  "CP04 = '" & m_TM04 & "' AND " & _
                  "CP10 = '303' AND CP27 IS NOT NULL " & _
            "ORDER BY CP27,CP09 DESC "
...
Private Sub DisplayNextForm()
   frm02010407_4.SetData 0, m_TM01, True
   frm02010407_4.SetData 1, m_TM02, False
   frm02010407_4.SetData 2, m_TM03, False
   frm02010407_4.SetData 3, m_TM04, False
   frm02010407_4.SetData 4, m_CP05, False
   frm02010407_4.SetData 5, m_CP09, False
   'Added by Morgan 2017/4/24 電子公文
   frm02010407_4.m_DocWord = frm02010407_1.m_DocWord
   frm02010407_4.m_DocNo = frm02010407_1.m_DocNo
   frm02010407_4.m_AppNo = frm02010407_1.m_AppNo
   frm02010407_4.m_DeadLine = frm02010407_1.m_DeadLine
   'end 2017/4/24
   'Add By Sindy 2019/5/10
   If Not m_PrevForm Is Nothing Then
      Call frm02010407_4.SetParent(m_PrevForm)
   End If
   frm02010407_4.m_strIR01 = m_strIR01
   frm02010407_4.m_strIR02 = m_strIR02
   frm02010407_4.m_strIR03 = m_strIR03
   frm02010407_4.m_strIR04 = m_strIR04
   '2019/5/10 END
   Me.Hide
   frm02010407_4.Show
   frm02010407_4.QueryData
End Sub
