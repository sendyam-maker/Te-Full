...
Begin VB.Form frm03020402_01 
   ...
   End
End
Attribute VB_Name = "frm03020402_01"
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm03020402_02.SetData 4, textTM12, True
         frm03020402_02.SetData 6, textCP05, False
      Case 1:
         frm03020402_02.SetData 5, textTM15, True
         frm03020402_02.SetData 6, textCP05, False
      Case 2:
         frm03020402_02.SetData 0, Trim(textTM01), True
         frm03020402_02.SetData 1, Trim(textTM02), False
         frm03020402_02.SetData 2, Trim(textTM03), False
         frm03020402_02.SetData 3, Trim(textTM04), False
         frm03020402_02.SetData 6, textCP05, False
   End Select
   Me.Hide
   frm03020402_02.Show
   frm03020402_02.QueryData
End Sub
...
frm03020402_04.ClearLastData

Set frm03020402_01 = Nothing 'Added by Morgan 2017/5/3 電子公文
End Sub
