...
Begin VB.Form frm02010602_01 
   ...
   End
End
Attribute VB_Name = "frm02010602_01"
...
'move to unload by nick 2004/10/27
'    '列印接洽接案單
   ...
   Select Case m_TM01
      ...
      Case "TF":
         strSql = "SELECT * FROM TradeMark " & _
                  "WHERE TM01 = '" & m_TM01 & "' AND " & _
                        "TM02 = '" & m_TM02 & "' "
         If IsEmptyText(textTM03) = False Then: strSql = strSql & " AND " & "TM03 = '" & m_TM03 & "' "
         If IsEmptyText(textTM04) = False Then: strSql = strSql & " AND " & "TM04 = '" & m_TM04 & "' "
      Case Else:
...
Private Sub DisplayNextForm()
   frm02010602_02.SetData 0, m_TM01, True
   frm02010602_02.SetData 1, m_TM02, False
   frm02010602_02.SetData 2, m_TM03, False
   frm02010602_02.SetData 3, m_TM04, False
   'Add By Sindy 2019/5/22
   If Not m_PrevForm Is Nothing Then
      Call frm02010602_02.SetParent(m_PrevForm)
   End If
   frm02010602_02.m_strIR01 = m_strIR01
   frm02010602_02.m_strIR02 = m_strIR02
   frm02010602_02.m_strIR03 = m_strIR03
   frm02010602_02.m_strIR04 = m_strIR04
   '2019/5/22 END
   frm02010602_02.Show
   frm02010602_02.QueryData
   cmdQuery.SetFocus
   Me.Hide
End Sub
