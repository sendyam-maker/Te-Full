...
Begin VB.Form frm020507 
   ...
   Begin TabDlg.SSTab tabCtrl 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "單筆"
      TabPicture(0)   =   "frm020507.frx":0000
      ...
      Tab(0).Control(4)=   "textLW03"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "textLW01"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "textLW02"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "textLW04"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).ControlCount=   8
      TabCaption(1)   =   "多筆查詢"
      TabPicture(1)   =   "frm020507.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "grdList"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      Begin VB.TextBox textLW04 
         Height          =   264
         Left            =   1620
         MaxLength       =   14
         TabIndex        =   3
      ...
      Begin MSHierarchicalFlexGridLib.MSHFlexGrid grdList 
         ...
         _Band(0).Cols   =   2
      End
      Begin MSForms.TextBox textLW03 
         Height          =   1215
         Left            =   1080
         TabIndex        =   2
         Top             =   1080
   ...
   Begin MSComctlLib.ImageList ImgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":0038
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":0354
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":0670
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":084C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":0B68
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":0E84
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":11A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":14BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":17D8
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":1AF4
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm020507.frx":1E10
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frm020507"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2023/10/16 Form2.0已修改 ; grdList從MSFlexGrid改為MSHFlexGrid
'Memo by Lydia 2021/10/13 改成Form2.0 ; textLW03、grdList改字型=新細明體-ExtB
...
Private Sub Form_Load()
   ...
   m_bInsert = IsUserHasRightOfFunction("frm020507", strAdd, False)
   m_bUpdate = IsUserHasRightOfFunction("frm020507", strEdit, False)
   m_bDelete = IsUserHasRightOfFunction("frm020507", strDel, False)
   m_bQuery = IsUserHasRightOfFunction("frm020507", strFind, False)
...
Private Sub InitialField()
   ...
   For nIndex = 1 To MAX_FIELD
      ...
      m_FieldList(nIndex - 1).fiName = "LW" & strTmp
...
Private Sub UpdateFieldNewData()
   'Modify By Sindy 2012/7/10
   'SetFieldNewData "LW01", textLW01: SetFieldNewData "LW02", textLW02: SetFieldNewData "LW03", textLW03
   SetFieldNewData "LW01", textLW01: SetFieldNewData "LW02", textLW02: SetFieldNewData "LW03", textLW03: SetFieldNewData "LW04", textLW04
End Sub
...
Private Sub ClearField()
   Dim nIndex As Integer
   textLW01 = Empty: textLW02 = Empty: textLW03 = Empty
   textLW04 = Empty 'Add By Sindy 2012/7/10
   For nIndex = 0 To MAX_FIELD - 1
      m_FieldList(nIndex).fiOldData = Empty
      m_FieldList(nIndex).fiNewData = Empty
   Next nIndex
...
Private Sub SetCtrlReadOnly(ByVal bEnable As Boolean)
   textLW01.Locked = bEnable: textLW02.Locked = bEnable: textLW03.Locked = bEnable
   textLW04.Locked = bEnable 'Add By Sindy 2012/7/10
End Sub

' 更新Key的狀態
Private Sub SetKeyReadOnly(ByVal bEnable As Boolean)
   textLW01.Locked = bEnable
End Sub
...
Private Sub UpdateCtrlData()
   ...
   ClearField
   textLW01 = m_Recordset.Fields("LW01")
   If Not IsNull(m_Recordset.Fields("LW02")) Then: textLW02 = m_Recordset.Fields("LW02"): 'End If
   If Not IsNull(m_Recordset.Fields("LW03")) Then: textLW03 = m_Recordset.Fields("LW03"): 'End If
   If Not IsNull(m_Recordset.Fields("LW04")) Then: textLW04 = m_Recordset.Fields("LW04"): 'Add By Sindy 2012/7/10
   UpdateFieldOldData
...
' 顯示資料
Private Sub ShowCurrRecord(ByVal strLW01 As String)
   ...
   If m_Recordset.RecordCount > 0 Then
      ...
      While m_Recordset.EOF = False And bFind = False
         If strLW01 = m_Recordset.Fields("LW01") Then
            bFind = True
         Else
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   Set frm020507 = Nothing
End Sub

Private Sub textLW01_KeyPress(KeyAscii As Integer)
   KeyAscii = UpperCase(KeyAscii)
End Sub

' 條款代號
Private Sub textLW01_Validate(Cancel As Boolean)
   Dim strTit As String
   Dim strMsg As String
   Dim nResponse
   Cancel = False
   If m_EditMode = 1 Then
      If IsEmptyText(textLW01) = False Then
         If IsRecordExist(textLW01) = True Then
            Cancel = True
            strTit = "檢核資料"
            strMsg = "條款代號已存在"
...
'Add By Sindy 2012/7/10
Private Sub textLW04_KeyPress(KeyAscii As Integer)
   KeyAscii = UpperCase(KeyAscii)
End Sub

'Add By Sindy 2012/7/10
' 對應舊條款代號
Private Sub textLW04_Validate(Cancel As Boolean)
   Dim strTit As String
   Dim strMsg As String
   Dim nResponse
   Dim tmpArr As Variant, i As Integer
   
   Cancel = False
   If m_EditMode = 1 Or m_EditMode = 2 Then
      If IsEmptyText(textLW04) = False Then
         tmpArr = Split(textLW04, ",")
         For i = 0 To UBound(tmpArr)
            If IsRecordExist(tmpArr(i)) = False Then
               Cancel = True
               strTit = "檢核資料"
               strMsg = tmpArr(i) & "條款代號不存在"
               nResponse = MsgBox(strMsg, vbOKOnly, strTit)
               textLW04_GotFocus
               Exit Sub
            End If
...
' 說明
Private Sub textLW03_Validate(Cancel As Boolean)
   Dim strTit As String
   Dim strMsg As String
   Dim nResponse
   Cancel = False
   If CheckLengthIsOK(textLW03, textLW03.MaxLength) = False Then
      Cancel = True
      strTit = "檢核資料"
      strMsg = "說明內容太長"
      'nResponse = MsgBox(strMsg, vbOKOnly, strTit)
   ...
   'If Cancel = False Then: textLW03.IMEMode = 2
...
' 檢查記錄是否已經存在
Private Function IsRecordExist(ByVal strLW01 As String) As Boolean
...
Private Sub AddRecord()
   ...
   Dim strLW01 As String
   
   strLW01 = textLW01
   
   ' 檢查記錄是否已存在
   If IsRecordExist(strLW01) = True Then
      strTit = "新增資料"
      strMsg = "該筆記錄已存在"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      UpdateCtrlData
...
Private Function QueryRecord() As Boolean
   ...
   While (m_Recordset.EOF <> True) And (bFind = False)
      If m_Recordset.Fields("LW01") = strLW01 Then
         bFind = True
      Else
         m_Recordset.MoveNext
      End If
...
Public Sub InitialGridList()
   ...
   grdList.col = 3
   grdList.Text = "說明"
   grdList.ColWidth(3) = 4000
   grdList.ColAlignment(3) = flexAlignLeftCenter
   'Add By Sindy 2012/7/10
   grdList.col = 4
   grdList.Text = "對應舊條款代號"
...
Private Sub UpdateGridList()
   ...
   If IsRecordsetCorrect = True Then
      strLW01 = m_Recordset.Fields("LW01")
      ...
      While m_Recordset.EOF <> True
         ...
         grdList.col = 1
         If IsNull(m_Recordset.Fields("LW03")) = False Then
            grdList.Text = m_Recordset.Fields("LW01")
         End If
         
         grdList.col = 2
         If IsNull(m_Recordset.Fields("LW02")) = False Then
            grdList.Text = m_Recordset.Fields("LW02")
         End If
         
         grdList.col = 3
         If IsNull(m_Recordset.Fields("LW03")) = False Then
            grdList.Text = m_Recordset.Fields("LW03")
         End If
         
         'Add By Sindy 2012/7/10
         grdList.col = 4
         If IsNull(m_Recordset.Fields("LW04")) = False Then
            grdList.Text = m_Recordset.Fields("LW04")
         End If
         '2012/7/10 End
...
Private Sub grdList_SelChange()
   ...
   If grdList.row > 0 Then
      strLW01 = grdList.TextMatrix(grdList.row, 1)
      ShowCurrRecord strLW01
   End If
...
Private Sub textLW01_GotFocus()
   InverseTextBox textLW01
End Sub

Private Sub textLW02_GotFocus()
   InverseTextBox textLW02
End Sub

Private Sub textLW03_GotFocus()
   'edit by nickc 2007/06/06 切換輸入法改用API
   'textLW03.IMEMode = 1
   OpenIme
   InverseTextBox textLW03
End Sub

'Add By Sindy 2012/7/10
Private Sub textLW04_GotFocus()
   InverseTextBox textLW04
End Sub
...
Private Function CheckDataValid() As Boolean
   ...
   ' 條款代號
   If IsEmptyText(textLW01) = True Then
      strTit = "檢核資料"
      strMsg = "請輸入條款代號"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      textLW01.SetFocus
   ...
   End If
   ' 條款
   If IsEmptyText(textLW02) = True Then
      strTit = "檢核資料"
      strMsg = "請輸入條款"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      textLW02.SetFocus
   ...
   End If
   ' 說明
   If IsEmptyText(textLW03) = True Then
      strTit = "檢核資料"
      strMsg = "請輸入說明"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      textLW03.SetFocus
...
TxtValidate = False
If Me.textLW01.Enabled = True Then
   Cancel = False
   textLW01_Validate Cancel
   If Cancel = True Then
      Exit Function
   End If
End If

If Me.textLW03.Enabled = True Then
   Cancel = False
   textLW03_Validate Cancel
   If Cancel = True Then
      Exit Function
   End If
End If
...
'Add By Sindy 2012/7/10
If Me.textLW04.Enabled = True Then
   Cancel = False
   textLW04_Validate Cancel
   If Cancel = True Then
      Exit Function
   End If
End If
