...
Begin VB.Form frm02010401_2 
   ...
   End
End
Attribute VB_Name = "frm02010401_2"
...
'2006/6/2 CANCEL BY SONIA 移至frm03020401_03檢查,因為申請有第一期註冊費期限,其他案件性質無期限
'' 檢查來函記錄檔
...
Private Sub cmdOK_Click()
   ...
   Else
      ...
      GoTo EXITSUB
   End If
   '2006/6/2 MODIFY BY SONIA 移至frm02010401_3檢查,因為申請有第一期註冊費期限,其他案件性質無期限
...
Public Sub SetData(ByVal nType As Integer, ByVal strData As String, Optional ByVal bClear As Boolean = False)
   ...
   Select Case nType
      ...
      ' add by nick 2004/10/29
      Case 7: m_txtTMBM07_1 = strData
      Case 8: m_txtTMBM07_2 = strData
      Case 9: m_txtTM14 = strData
   End Select
End Sub
...
Private Sub DisplayNextForm()
   frm02010401_3.SetData 0, m_CP01, True
   frm02010401_3.SetData 1, m_CP02, False
   frm02010401_3.SetData 2, m_CP03, False
   frm02010401_3.SetData 3, m_CP04, False
   frm02010401_3.SetData 4, m_CP05, False
   If grdList.Rows > 2 Then
      frm02010401_3.SetData 5, "2", False
   Else
      frm02010401_3.SetData 5, "1", False
   End If
   'add by nick 2004/10/29
   frm02010401_3.SetData 6, m_txtTMBM07_1, False
   frm02010401_3.SetData 7, m_txtTMBM07_2, False
   frm02010401_3.SetData 8, m_txtTM14, False
   frm02010401_3.m_blnNotFirst = m_blnNotFirst
   frm02010401_3.oStrCDate = oStrCDate
   'Add By Sindy 2019/5/14
   If Not m_PrevForm Is Nothing Then
      Call frm02010401_3.SetParent(m_PrevForm)
   End If
   frm02010401_3.m_strIR01 = m_strIR01
   frm02010401_3.m_strIR02 = m_strIR02
   frm02010401_3.m_strIR03 = m_strIR03
   frm02010401_3.m_strIR04 = m_strIR04
   '2019/5/14 END
   Me.Hide
   frm02010401_3.Show
   frm02010401_3.QueryData
End Sub
...
Private Sub ListData(ByRef rsTmp As ADODB.Recordset)
   ...
   ' 當只有一筆記錄時, 則直接跳至下一畫面
   If grdList.Rows = 2 Then
      '2006/6/2MODIFY BY SONIA 移至frm02010401_3檢查,因為申請有第一期註冊費期限,其他案件性質無期限
      'If PromptIfTaiwanNoResult = True Then
      '   DisplayNextForm
      'Else
      '   Unload Me
