...
Begin VB.Form frm02010401_5 
   ...
   Begin TabDlg.SSTab tabCtrl 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "第一頁"
      TabPicture(0)   =   "frm02010401_5.frx":0000
      ...
      TabCaption(1)   =   "第二頁"
      TabPicture(1)   =   "frm02010401_5.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "textCE59"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "textCE62"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "textCE49"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "textCE50"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "textCE47"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "textCE48"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "textCE45"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "textCE46"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "textCE42"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "textCE44"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "textCE60"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "textCE39"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "textCE40"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "textCE57"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "textCE58"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "textCE24"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "textCE38"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "textCE41_1"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "textCE61"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "textCE43"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "textCE41"
      Tab(1).Control(20).Enabled=   0   'False
      Tab(1).Control(21)=   "textCE25"
   ...
   End
End
Attribute VB_Name = "frm02010401_5"
...
cnnConnection.BeginTrans
   ...
   If Me.textCE09.Text = "1" Or Me.textCE03.Text = "1" Or _
      ...
      frm02010401_4.m_blnClkChgButton = True
   End If
   '2012/2/16 End
...
'   Else
'      frm02010401_4.m_blnClkChgButton = False
'   '2012/2/6 End
   End If
