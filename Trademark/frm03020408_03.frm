...
Begin VB.Form frm03020408_03 
   ...
   End
End
Attribute VB_Name = "frm03020408_03"
...
Private Sub Form_Activate()
  'Added by Lydia 2015/05/05 與"更改來函期限" 共用
  If frm03020408_01.iStiu = 2 Then Me.Caption = "更改來函期限"
End Sub
...
Private Sub ListData()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      Do While rsTmp.EOF = False
         strExc(1) = Trim(str(frm03020408_01.iStiu) & Mid(rsTmp.Fields("CP09"), 1, 1))
         'Modified by Lydia 2015/05/26 更改審查機關來函期限不限定已發文
         If strExc(1) <> "2C" Then
            ' 無發文日不予列入
         ...
         'Added by Lydia 2015/05/05 ~更改來函期限(限C類)
'         ' 收文號不為A,B類的不予計入
...
'         End Select
         Select Case strExc(1)
            Case "1A", "1B", "2C":
                 If strExc(1) = "2C" And IsNull(rsTmp.Fields("CP07")) Then
                    GoTo NextRecord '不抓沒期限資料
                 End If
            Case Else: GoTo NextRecord
         End Select
...
'Added by Lydia 2015/05/05 ~更改來函期限(限C類)
 If frm03020408_01.iStiu = 2 Then
   frm03020408_05.SetData 0, m_TM01, True
   frm03020408_05.SetData 1, m_TM02, False
   frm03020408_05.SetData 2, m_TM03, False
   frm03020408_05.SetData 3, m_TM04, False
   frm03020408_05.SetData 4, m_CP05, False
   frm03020408_05.SetData 5, m_CP09, False
   Me.Hide
   frm03020408_05.Show
   frm03020408_05.QueryData
 Else
   '其他來函
   frm03020408_04.SetData 0, m_TM01, True
   frm03020408_04.SetData 1, m_TM02, False
   frm03020408_04.SetData 2, m_TM03, False
   frm03020408_04.SetData 3, m_TM04, False
   frm03020408_04.SetData 4, m_CP05, False
   frm03020408_04.SetData 5, m_CP09, False
   'Added by Morgan 2017/5/9 電子公文
   frm03020408_04.m_DocWord = frm03020408_01.m_DocWord
   frm03020408_04.m_DocNo = frm03020408_01.m_DocNo
   frm03020408_04.m_AppNo = frm03020408_01.m_AppNo
   frm03020408_04.m_DeadLine = frm03020408_01.m_DeadLine
   'end 2017/5/9
   Me.Hide
   frm03020408_04.Show
   frm03020408_04.QueryData
 End If
End Sub
