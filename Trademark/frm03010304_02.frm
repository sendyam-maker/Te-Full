...
Begin VB.Form frm03010304_02 
   ...
   End
End
Attribute VB_Name = "frm03010304_02"
...
Private Sub Form_Load()
   ...
   'Add By Sindy 2023/4/27
   m_strIR01 = frm03010304_01.m_strIR01
   m_strIR02 = frm03010304_01.m_strIR02
   m_strIR03 = frm03010304_01.m_strIR03
   m_strIR04 = frm03010304_01.m_strIR04
   If m_strIR01 <> "" Then
...
' 取得催審期間的資料
Private Function GetUrgeDate(ByVal strKey As String) As String
...
Private Sub ListData()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      Do While rsTmp.EOF = False
         ...
         ' 催審期限
         If IsNull(rsTmp.Fields("CP09")) = False Then
            grdList.TextMatrix(nIndex, 5) = GetUrgeDate(rsTmp.Fields("CP09"))
         End If
         ' 相關人
         bDeal = False
...
Private Sub DisplayNextForm()
   frm03010304_03.SetData 0, m_TM01, True
   frm03010304_03.SetData 1, m_TM02, False
   frm03010304_03.SetData 2, m_TM03, False
   frm03010304_03.SetData 3, m_TM04, False
   frm03010304_03.SetData 4, m_CP05, False
   frm03010304_03.SetData 5, m_CP09, False
   'Add By Sindy 2023/4/27
   If Not m_PrevForm Is Nothing Then
      Call frm03010304_03.SetParent(m_PrevForm)
   End If
   frm03010304_03.m_strIR01 = m_strIR01
   frm03010304_03.m_strIR02 = m_strIR02
   frm03010304_03.m_strIR03 = m_strIR03
   frm03010304_03.m_strIR04 = m_strIR04
   '2023/4/27 END
   Me.Hide
   frm03010304_03.Show
   frm03010304_03.QueryData
End Sub
