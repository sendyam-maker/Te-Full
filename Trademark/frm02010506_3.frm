...
Begin VB.Form frm02010506_3 
   ...
   End
End
Attribute VB_Name = "frm02010506_3"
   ...
   Select Case m_TM01
      Case "TD":
         ...
         strSql = "SELECT SP01 AS TM01,SP02 AS TM02,SP03 AS TM03,SP04 AS TM04,SP05 AS TM05,SP06 AS TM06,SP07 AS TM07,SP09 AS TM10 " & _
            ",'' AS TM12,'' AS TM15,SP08 AS TM23 FROM SERVICEPRACTICE " & _
...
'               End Select
        ...
        'End
         ...
         If IsNull(rsTmp.Fields("CP43")) = False Then
            grdList.TextMatrix(grdList.row, 7) = (rsTmp.Fields("CP43"))
         End If
         ' 特殊欄位
...
Private Sub InitialGrdList()
   ...
   'add by nick 2004/07/07 加入相關總收文號
   grdList.col = 7
   grdList.Text = "相關總收文號"
...
Private Sub DisplayNextForm()
   frm02010506_4.SetData 0, m_TM01, True
   frm02010506_4.SetData 1, m_TM02, False
   frm02010506_4.SetData 2, m_TM03, False
   frm02010506_4.SetData 3, m_TM04, False
   frm02010506_4.SetData 4, m_CP05, False
   frm02010506_4.SetData 5, m_CP09, False
   'Added by Morgan 2017/4/26 電子公文
   frm02010506_4.m_DocWord = frm02010506_1.m_DocWord
   frm02010506_4.m_DocNo = frm02010506_1.m_DocNo
   frm02010506_4.m_AppNo = frm02010506_1.m_AppNo
   frm02010506_4.m_DeadLine = frm02010506_1.m_DeadLine
   'end 2017/4/26
   'Add By Sindy 2019/5/22
   If Not m_PrevForm Is Nothing Then
      Call frm02010506_4.SetParent(m_PrevForm)
   End If
   frm02010506_4.m_strIR01 = m_strIR01
   frm02010506_4.m_strIR02 = m_strIR02
   frm02010506_4.m_strIR03 = m_strIR03
   frm02010506_4.m_strIR04 = m_strIR04
   '2019/5/22 END
   Me.Hide
   frm02010506_4.Show
   frm02010506_4.QueryData
End Sub
