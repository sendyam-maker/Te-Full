...
Begin VB.Form frm030202_13 
   ...
   End
End
Attribute VB_Name = "frm030202_13"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2021/09/10 改成Form2.0 ;cmbTM05、textCP13、textCP14、textCP64、textTM44、textTM23、textTM78~81、lstNameAgent、textCP50~52
...
Private Sub QueryCaseProgress()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      If IsNull(rsTmp.Fields("CP54")) = False Then
         textCP54 = TAIWANDATE(rsTmp.Fields("CP53"))
      End If
