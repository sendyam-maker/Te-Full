...
Begin VB.Form frm02010506_1 
   ...
   End
End
Attribute VB_Name = "frm02010506_1"
...
'         rsTmp.Close
         ...
         If rsTmp.RecordCount <= 0 Then
            ...
            If rsTmp.RecordCount <= 0 Then
                ...
                GoTo EXITSUB
            Else
                StrSQLa = "SELECT * FROM TradeMark " & _
                         "WHERE  " & ChgTradeMark(rsTmp("CP01").Value & rsTmp("CP02").Value & rsTmp("CP03").Value & rsTmp("CP04").Value) & " AND " & _
                               "TM10 < '010' "
                ...
                If rsA.RecordCount <= 0 Then
                    ...
                    GoTo EXITSUB
                Else
                    strTM01 = rsA("TM01").Value
                    strTM02 = rsA("TM02").Value
                    strTM03 = rsA("TM03").Value
                    strTM04 = rsA("TM04").Value
                    '強制以輸入本所案號的方式進入畫面
                    m_KeySel = 2
                End If
            End If
...
'         rsTmp.Close
         ...
         If rsTmp.RecordCount <= 0 Then
            If rsTmp.State <> adStateClosed Then rsTmp.Close
            Set rsTmp = Nothing
            'Modified by Morgan 2020/4/21 只抓AB類 Ex:T-226861(對造號01201023)
            strSql = "SELECT * FROM CaseProgress " & _
                     "WHERE CP36 = '" & textTM15 & "' and cp09<'C'"
            rsTmp.CursorLocation = adUseClient
            rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
            If rsTmp.RecordCount <= 0 Then
                If rsTmp.State <> adStateClosed Then rsTmp.Close
      ...
      Case 2:
         ...
         If rsTmp.RecordCount > 0 Then
            ...
            If IsNull(rsTmp.Fields("TM10")) = False Then
               '2011/6/7 MODIFY BY SONIA 加strTM01<>TD
               'If rsTmp.Fields("TM10") < "010" Then
               If rsTmp.Fields("TM10") < "010" And strTM01 <> "TD" Then
                  rsTmp.Close
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm02010506_2.SetData 4, textTM12, True
         frm02010506_2.SetData 6, textCP05, False
      Case 1:
         frm02010506_2.SetData 5, textTM15, True
         frm02010506_2.SetData 6, textCP05, False
      Case 2:
        'Modify By Cheng 2002/11/19
'         frm02010506_2.SetData 0, Trim(textTM01), True
'         If Trim(textTM01) = "TF" Then
'            frm02010506_2.SetData 1, Trim(textTM02) & Trim(textTM02_2), False
'         Else
'            frm02010506_2.SetData 1, Trim(textTM02), False
'         End If
'         frm02010506_2.SetData 2, Trim(textTM03), False
'         frm02010506_2.SetData 3, Trim(textTM04), False
'         frm02010506_2.SetData 6, textCP05, False
         frm02010506_2.SetData 0, Trim(strTM01), True
         If Trim(textTM01) = "TF" Then
            frm02010506_2.SetData 1, Trim(strTM02), False
         Else
            frm02010506_2.SetData 1, Trim(strTM02), False
         End If
         frm02010506_2.SetData 2, Trim(strTM03), False
         frm02010506_2.SetData 3, Trim(strTM04), False
         frm02010506_2.SetData 6, textCP05, False
   End Select
   'Add By Sindy 2019/5/22
   If Not m_PrevForm Is Nothing Then
      Call frm02010506_2.SetParent(m_PrevForm)
   End If
   frm02010506_2.m_strIR01 = m_strIR01
   frm02010506_2.m_strIR02 = m_strIR02
   frm02010506_2.m_strIR03 = m_strIR03
   frm02010506_2.m_strIR04 = m_strIR04
   '2019/5/22 END
   Me.Show
   frm02010506_2.Show
   frm02010506_2.QueryData
End Sub
