...
Begin VB.Form frm02010509_1 
   ...
   End
End
Attribute VB_Name = "frm02010509_1"
   ...
   Select Case m_KeySel
      Case 0:
         ...
         strSql = "SELECT * FROM TradeMark " & _
                  "WHERE TM12 = '" & textTM12 & "' " 'AND " & _ "TM10 < '010' " ''Modify By Sindy 2009/08/04
      ...
      Case 1:
         ' 設定SQL語法
         strSql = "SELECT * FROM TradeMark " & _
                  "WHERE TM15 = '" & textTM15 & "' " 'AND " & _ "TM10 < '010' " ''Modify By Sindy 2009/08/04
         rsTmp.CursorLocation = adUseClient
         rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
         If rsTmp.RecordCount <= 0 Then
            rsTmp.Close
         ...
         If rsTmp.RecordCount > 0 Then
            ...
            If IsNull(rsTmp.Fields("TM10")) = False Then
               If rsTmp.Fields("TM10") < "010" Then
                  ...
                  nResponse = MsgBox(strMsg, vbOKOnly, strTit)
                  GoTo EXITSUB
               'Modify By Sindy 2009/08/04 不控管申請國家為台灣案
'               'Add By Sindy 98/04/14
'               Else
'                  rsTmp.Close
'                  strMsg = "非台灣案，不可執行"
'                  strTit = "檢核資料"
...
Private Sub DisplayNextForm()
   Select Case m_KeySel
      Case 0:
         frm02010509_2.SetData 4, textTM12, True
         frm02010509_2.SetData 6, textCP05, False
      Case 1:
         frm02010509_2.SetData 5, textTM15, True
         frm02010509_2.SetData 6, textCP05, False
      Case 2:
         frm02010509_2.SetData 0, Trim(textTM01), True
         If Trim(textTM01) = "TF" Then
            frm02010509_2.SetData 1, Trim(textTM02) & Trim(textTM02_2), False
         Else
            frm02010509_2.SetData 1, Trim(textTM02), False
         End If
         frm02010509_2.SetData 2, Trim(textTM03), False
         frm02010509_2.SetData 3, Trim(textTM04), False
         frm02010509_2.SetData 6, textCP05, False
   End Select
   'Add By Sindy 2019/5/27
   If Not m_PrevForm Is Nothing Then
      Call frm02010509_2.SetParent(m_PrevForm)
   End If
   frm02010509_2.m_strIR01 = m_strIR01
   frm02010509_2.m_strIR02 = m_strIR02
   frm02010509_2.m_strIR03 = m_strIR03
   frm02010509_2.m_strIR04 = m_strIR04
   '2019/5/27 END
   Me.Hide
   frm02010509_2.Show
   frm02010509_2.QueryData
End Sub
