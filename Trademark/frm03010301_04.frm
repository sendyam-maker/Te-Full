...
Begin VB.Form frm03010301_04 
   ...
   Begin TabDlg.SSTab tabCtrl 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "第一頁"
      TabPicture(0)   =   "frm03010301_04.frx":0000
      ...
      Tab(0).Control(22)=   "textCE64"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "textCE63"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "textCE65"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "textCE17"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "textCE22"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "textCE51"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "textCE52"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "textCE53"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "textCE54"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "textCE55"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "textCE56"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "textCE15"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "textCE14"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "textCE13"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "textCE12"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "textCE11"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "textCE10"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "textCE16"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "textCE02"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "textCE03"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "textCE04"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "textCE09"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).ControlCount=   44
      TabCaption(1)   =   "第二頁"
      TabPicture(1)   =   "frm03010301_04.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "textCE41_1"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "textCE38"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "textCE23"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "textCE24"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "textCE25"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "textCE58"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "textCE57"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "textCE40"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "textCE39"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "textCE60"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "textCE44"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "textCE41"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "textCE42"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "textCE43"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "textCE46"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "textCE45"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "textCE48"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "textCE47"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "textCE50"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "textCE49"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "textCE62"
      Tab(1).Control(20).Enabled=   0   'False
      Tab(1).Control(21)=   "textCE61"
      Tab(1).Control(21).Enabled=   0   'False
      Tab(1).Control(22)=   "textCE59"
      Tab(1).Control(22).Enabled=   0   'False
      Tab(1).Control(23)=   "Label45"
      ...
      Tab(1).Control(36)=   "Label35"
      Tab(1).Control(36).Enabled=   0   'False
      Tab(1).Control(37)=   "Label36"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "Label37"
      Tab(1).Control(38).Enabled=   0   'False
      Tab(1).Control(39)=   "Label38"
      Tab(1).Control(39).Enabled=   0   'False
      Tab(1).Control(40)=   "Label39"
      Tab(1).Control(40).Enabled=   0   'False
      Tab(1).Control(41)=   "Label40"
      Tab(1).Control(41).Enabled=   0   'False
      Tab(1).Control(42)=   "Label41"
      Tab(1).Control(42).Enabled=   0   'False
      Tab(1).Control(43)=   "Label42"
      Tab(1).Control(43).Enabled=   0   'False
      Tab(1).Control(44)=   "Label43"
      Tab(1).Control(44).Enabled=   0   'False
      Tab(1).Control(45)=   "Label44"
      ...
      End
      Begin MSForms.TextBox textCE09 
         Height          =   285
         Left            =   1320
         TabIndex        =   49
         Top             =   360
      ...
      Begin MSForms.TextBox textCE04 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE03 
         Height          =   285
         Left            =   1320
         TabIndex        =   47
         Top             =   660
      ...
      Begin MSForms.TextBox textCE02 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE16 
         Height          =   285
         Left            =   1320
         TabIndex        =   45
         Top             =   960
      ...
      Begin MSForms.TextBox textCE15 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE56 
         Height          =   285
         Left            =   1320
         TabIndex        =   38
         Top             =   2760
      ...
      Begin MSForms.TextBox textCE55 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE54 
         Height          =   285
         Left            =   1320
         TabIndex        =   36
         Top             =   3060
      ...
      Begin MSForms.TextBox textCE53 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE52 
         Height          =   285
         Left            =   1320
         TabIndex        =   34
         Top             =   3360
      ...
      Begin MSForms.TextBox textCE51 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE22 
         Height          =   285
         Left            =   1320
         TabIndex        =   32
         Top             =   3660
      ...
      Begin MSForms.TextBox textCE17 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE65 
         Height          =   285
         Left            =   1320
         TabIndex        =   30
         Top             =   3960
      ...
      Begin MSForms.TextBox textCE64 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE38 
         Height          =   285
         Left            =   -73680
         TabIndex        =   27
         Top             =   360
      ...
      Begin MSForms.TextBox textCE25 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE58 
         Height          =   285
         Left            =   -73680
         TabIndex        =   23
         Top             =   1260
      ...
      Begin MSForms.TextBox textCE57 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE40 
         Height          =   285
         Left            =   -73680
         TabIndex        =   21
         Top             =   1560
      ...
      Begin MSForms.TextBox textCE39 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE60 
         Height          =   285
         Left            =   -73680
         TabIndex        =   19
         Top             =   1860
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE44 
         Height          =   285
         Left            =   -73680
         TabIndex        =   18
         Top             =   2160
      ...
      Begin MSForms.TextBox textCE43 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE46 
         Height          =   285
         Left            =   -73680
         TabIndex        =   14
         Top             =   3060
      ...
      Begin MSForms.TextBox textCE45 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE48 
         Height          =   285
         Left            =   -73680
         TabIndex        =   12
         Top             =   3360
      ...
      Begin MSForms.TextBox textCE47 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE50 
         Height          =   285
         Left            =   -73680
         TabIndex        =   10
         Top             =   3660
      ...
      Begin MSForms.TextBox textCE49 
         ...
         FontPitchAndFamily=   34
      End
      Begin MSForms.TextBox textCE62 
         Height          =   285
         Left            =   -73680
         TabIndex        =   8
         Top             =   3960
   ...
   End
End
Attribute VB_Name = "frm03010301_04"
...
Private Sub Form_Load()
   ...
   'Add By Sindy 2023/8/7
   m_strIR01 = frm03010301_03.m_strIR01
   m_strIR02 = frm03010301_03.m_strIR02
   m_strIR03 = frm03010301_03.m_strIR03
   m_strIR04 = frm03010301_03.m_strIR04
   If m_strIR01 <> "" Then
...
On Error GoTo CheckingErr
   ...
   If Me.textCE09.Text = "1" Or Me.textCE03.Text = "1" Or _
      ...
      frm03010301_03.m_blnClkChgButton = True
   Else
...
'   Else
'      frm03010301_03.m_blnClkChgButton = False
'      MsgBox "請輸入變更事項!!!", vbExclamation + vbOKOnly
