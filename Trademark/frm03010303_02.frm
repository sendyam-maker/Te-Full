...
Begin VB.Form frm03010303_02 
   ...
   End
End
Attribute VB_Name = "frm03010303_02"
...
Private Sub Form_Load()
   ...
   MoveFormToCenter Me
   'Add By Sindy 2023/4/27
   m_strIR01 = frm03010303_01.m_strIR01
   m_strIR02 = frm03010303_01.m_strIR02
   m_strIR03 = frm03010303_01.m_strIR03
   m_strIR04 = frm03010303_01.m_strIR04
   If m_strIR01 <> "" Then
...
Private Sub ListData()
   ...
   m_CP09 = Empty
    ...
    '限定案件性質為申請(101)或延展(102)的資料
'   strSQL = "SELECT * FROM CaseProgress " & _
'            "WHERE CP01 = '" & m_TM01 & "' AND " & _
'                  "CP02 = '" & m_TM02 & "' AND " & _
'                  "CP03 = '" & m_TM03 & "' AND " & _
'                  "CP04 = '" & m_TM04 & "' ORDER BY CP05, CP09"
'edit by nick 2004/09/01 加入跨類
   'strSQL = "SELECT * FROM CaseProgress " & _
            "WHERE CP01 = '" & m_TM01 & "' AND " & _
                  "CP02 = '" & m_TM02 & "' AND " & _
                  "CP03 = '" & m_TM03 & "' AND " & _
                  "CP04 = '" & m_TM04 & "' And (CP10 ='101' OR CP10='102') ORDER BY CP05, CP09"
   '2005/3/23 modify by sonia 加入分割
   'StrSql = "SELECT * FROM CaseProgress " & _
   '         "WHERE CP01 = '" & m_TM01 & "' AND " & _
   '               "CP02 = '" & m_TM02 & "' AND " & _
   '               "CP03 = '" & m_TM03 & "' AND " & _
   '               "CP04 = '" & m_TM04 & "' And (CP10 ='101' OR CP10='102' or cp10='107') ORDER BY CP05, CP09"
   '2009/1/19 MODIFY BY SONIA 加入著作權登記806
   'strSQL = "SELECT * FROM CaseProgress " & _
   '         "WHERE CP01 = '" & m_TM01 & "' AND " & _
   '               "CP02 = '" & m_TM02 & "' AND " & _
   '               "CP03 = '" & m_TM03 & "' AND " & _
   '               "CP04 = '" & m_TM04 & "' And (CP10 ='101' OR CP10='102' or cp10='107' or cp10='308') ORDER BY CP05, CP09"
   'modify by sonia 2025/9/4 加入緩審延展109(CFT-016520)
   strSql = "SELECT * FROM CaseProgress " & _
            "WHERE CP01 = '" & m_TM01 & "' AND " & _
                  "CP02 = '" & m_TM02 & "' AND " & _
                  "CP03 = '" & m_TM03 & "' AND " & _
                  "CP04 = '" & m_TM04 & "' And (CP10 ='101' OR CP10='102' or cp10='107' or cp10='109' or cp10='308' or cp10='806') ORDER BY CP05, CP09"
   rsTmp.CursorLocation = adUseClient
   rsTmp.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly   'edit by nickc 2005/08/04 原先是  動態開啟
   If rsTmp.RecordCount > 0 Then
      rsTmp.MoveFirst
      Do While rsTmp.EOF = False
         ...
         If IsNull(rsTmp.Fields("CP19")) = False Then
            grdList.TextMatrix(nIndex, 6) = rsTmp.Fields("CP19")
         End If
...
'         End If
         ...
         If bDeal = False And IsNull(rsTmp.Fields("CP40")) = False Then
            If IsEmptyText(rsTmp.Fields("CP40")) = False Then
               grdList.TextMatrix(nIndex, 7) = rsTmp.Fields("CP40")
               bDeal = True
            End If
         End If
         If bDeal = False And IsNull(rsTmp.Fields("CP41")) = False Then
            If IsEmptyText(rsTmp.Fields("CP41")) = False Then
               grdList.TextMatrix(nIndex, 7) = rsTmp.Fields("CP41")
               bDeal = True
            End If
         End If
         If bDeal = False And IsNull(rsTmp.Fields("CP42")) = False Then
            If IsEmptyText(rsTmp.Fields("CP42")) = False Then
               grdList.TextMatrix(nIndex, 7) = rsTmp.Fields("CP42")
               bDeal = True
            End If
         End If
         If bDeal = False And IsNull(rsTmp.Fields("CP50")) = False Then
            If IsEmptyText(rsTmp.Fields("CP50")) = False Then
               grdList.TextMatrix(nIndex, 7) = rsTmp.Fields("CP50")
               bDeal = True
            End If
         End If
         If bDeal = False And IsNull(rsTmp.Fields("CP51")) = False Then
            If IsEmptyText(rsTmp.Fields("CP51")) = False Then
               grdList.TextMatrix(nIndex, 7) = rsTmp.Fields("CP51")
               bDeal = True
            End If
         End If
         If bDeal = False And IsNull(rsTmp.Fields("CP52")) = False Then
            If IsEmptyText(rsTmp.Fields("CP52")) = False Then
               grdList.TextMatrix(nIndex, 7) = rsTmp.Fields("CP52")
               bDeal = True
            End If
         End If
         If bDeal = False And IsNull(rsTmp.Fields("CP56")) = False Then
            If IsEmptyText(rsTmp.Fields("CP56")) = False Then
               grdList.TextMatrix(nIndex, 7) = GetCustomerName(rsTmp.Fields("CP56"), 0)
               bDeal = True
            End If
         End If
...
Private Sub DisplayNextForm()
   frm03010303_03.SetData 0, m_TM01, True
   frm03010303_03.SetData 1, m_TM02, False
   frm03010303_03.SetData 2, m_TM03, False
   frm03010303_03.SetData 3, m_TM04, False
   frm03010303_03.SetData 4, m_CP05, False
   frm03010303_03.SetData 5, m_CP09, False
   'Add By Sindy 2023/4/27
   If Not m_PrevForm Is Nothing Then
      Call frm03010303_03.SetParent(m_PrevForm)
   End If
   frm03010303_03.m_strIR01 = m_strIR01
   frm03010303_03.m_strIR02 = m_strIR02
   frm03010303_03.m_strIR03 = m_strIR03
   frm03010303_03.m_strIR04 = m_strIR04
   '2023/4/27 END
   Me.Hide
   frm03010303_03.Show
   frm03010303_03.QueryData
End Sub
