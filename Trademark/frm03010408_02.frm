...
Begin VB.Form frm03010408_02 
   ...
   End
End
Attribute VB_Name = "frm03010408_02"
...
Private Sub Form_Load()
   ...
   'Add By Sindy 2023/5/2
   m_strIR01 = frm03010408_01.m_strIR01
   m_strIR02 = frm03010408_01.m_strIR02
   m_strIR03 = frm03010408_01.m_strIR03
   m_strIR04 = frm03010408_01.m_strIR04
   If m_strIR01 <> "" Then
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      Do While rsTmp.EOF = False
         ...
         Select Case Mid(rsTmp.Fields("CP09"), 1, 1)
            Case "A", "B", "C":            '2009/7/29 MODIFY BY SONIA 加入C類 CFT-011606
            Case Else: GoTo NextRecord
         End Select
        '2009/7/29 ADD BY SONIA 加入C類 CFT-011606
         ' C類只取 被異議, 被異議(理由), 被評定, 被評定(理由), 被廢止, 被廢止(理由), 通知言詞辯論
         '         對方補充理由, 發回補理由, 發回補答辯, 被部分廢止, 被部分廢止(理由)
         If Mid(rsTmp.Fields("CP09"), 1, 1) = "C" Then
            If IsNull(rsTmp.Fields("CP10")) = False Then
               Select Case rsTmp.Fields("CP10")
                  Case "1601", "1602", "1603", "1604", "1605", "1606", "1204":
                  Case "1609", "1612", "1613", "1619", "1620"
                  Case Else: GoTo NextRecord
               End Select
            End If
         End If
...
Private Sub DisplayNextForm()
   frm03010408_03.SetData 0, m_TM01, True
   frm03010408_03.SetData 1, m_TM02, False
   frm03010408_03.SetData 2, m_TM03, False
   frm03010408_03.SetData 3, m_TM04, False
   frm03010408_03.SetData 4, m_CP05, False
   frm03010408_03.SetData 5, m_CP09, False
   'Add By Sindy 2023/5/2
   If Not m_PrevForm Is Nothing Then
      Call frm03010408_03.SetParent(m_PrevForm)
   End If
   frm03010408_03.m_strIR01 = m_strIR01
   frm03010408_03.m_strIR02 = m_strIR02
   frm03010408_03.m_strIR03 = m_strIR03
   frm03010408_03.m_strIR04 = m_strIR04
   '2023/5/2 END
   Me.Hide
   frm03010408_03.Show
   frm03010408_03.QueryData
End Sub
