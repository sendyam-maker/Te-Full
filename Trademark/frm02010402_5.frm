...
Begin VB.Form frm02010402_5 
   ...
   Begin TabDlg.SSTab tabCtrl 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "第一頁"
      TabPicture(0)   =   "frm02010402_5.frx":0000
      ...
      Tab(0).Control(25)=   "textCE55"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "textCE15"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).Control(27)=   "textCE13"
      Tab(0).Control(27).Enabled=   0   'False
      Tab(0).Control(28)=   "textCE12"
      Tab(0).Control(28).Enabled=   0   'False
      Tab(0).Control(29)=   "textCE10"
      Tab(0).Control(29).Enabled=   0   'False
      Tab(0).Control(30)=   "textCE04"
      Tab(0).Control(30).Enabled=   0   'False
      Tab(0).Control(31)=   "textCE65"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "textCE22"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "textCE51"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "textCE52"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "textCE53"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "textCE54"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "textCE56"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "textCE14"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "textCE11"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "textCE16"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "textCE02"
      ...
      TabCaption(1)   =   "第二頁"
      TabPicture(1)   =   "frm02010402_5.frx":001C
      ...
      Tab(1).Control(23)=   "textCE61"
      Tab(1).Control(24)=   "textCE43"
      Tab(1).Control(25)=   "textCE41"
      Tab(1).Control(26)=   "textCE25"
      Tab(1).Control(27)=   "textCE23"
      Tab(1).Control(28)=   "textCE41_1"
      Tab(1).Control(29)=   "textCE59"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "textCE62"
      Tab(1).Control(31)=   "textCE49"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "textCE50"
      Tab(1).Control(33)=   "textCE47"
      Tab(1).Control(33).Enabled=   0   'False
      Tab(1).Control(34)=   "textCE48"
      Tab(1).Control(35)=   "textCE45"
      Tab(1).Control(35).Enabled=   0   'False
      Tab(1).Control(36)=   "textCE46"
      Tab(1).Control(37)=   "textCE42"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "textCE44"
      Tab(1).Control(39)=   "textCE60"
      Tab(1).Control(40)=   "textCE39"
      Tab(1).Control(40).Enabled=   0   'False
      Tab(1).Control(41)=   "textCE40"
      Tab(1).Control(42)=   "textCE57"
      Tab(1).Control(42).Enabled=   0   'False
      Tab(1).Control(43)=   "textCE58"
      Tab(1).Control(44)=   "textCE24"
   ...
   End
End
Attribute VB_Name = "frm02010402_5"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Amy 2021/12/28 Form2.0已修改 textCE04/textCE10/textCE12/textCE13/textCE15/textCE55/textCE17/textCE63/textCE64/textCE23/textCE25/textCE41_1/textCE41/textCE43textCE61
...
cnnConnection.BeginTrans
   ...
   If Me.textCE09.Text = "2" Or Me.textCE03.Text = "2" Or _
      ...
      frm02010402_4.m_blnClkChgButton = True
   End If
   '2012/2/16 End
...
'   Else
'      frm02010402_4.m_blnClkChgButton = False
'   '2012/2/6 End
   End If
...
'   OnUpdateTradeMark
   ...
   ' 90.07.19 modify (不儲存前畫面的資料)
   ' 直接儲存前畫面的資料
   'frm02010402_4.OnSaveData
'Add By Cheng 2002/11/07
...
Public Function OnUpdateTradeMark() As Boolean
   Dim rsTmp As New ADODB.Recordset
   Dim strSql As String
   Dim strPS As String
   Dim strTmp As String
...
TxtValidate = False
'Add by Amy 2021/12/28檢查畫面的 TextBox 是否含有Unicode文字
