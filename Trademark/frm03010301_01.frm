...
Begin VB.Form frm03010301_01 
   ...
   End
End
Attribute VB_Name = "frm03010301_01"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo By Lydia 2021/08/12 Form2.0已檢查 (無需修改的物件)
...
Private Function CheckDataValid() As Boolean
   ...
   End If
    ...
    '檢查來函收文日日期格式是否有效
   If CheckIsDate(textCP05) = False Then
        Me.textCP05.SetFocus
        textCP05_GotFocus
      GoTo EXITSUB
   End If
   'add by nickc 2006/03/17 不應超過系統日
...
Private Sub DisplayNextForm()
   frm03010301_02.SetData 0, Trim(textTM01), True
   frm03010301_02.SetData 1, Trim(textTM02), False
   If IsEmptyText(textTM03) = True Then
      frm03010301_02.SetData 2, "0", False
   Else
      frm03010301_02.SetData 2, Trim(textTM03), False
   End If
   If IsEmptyText(textTM04) = True Then
      frm03010301_02.SetData 3, "00", False
   Else
      frm03010301_02.SetData 3, Trim(textTM04), False
   End If
   frm03010301_02.SetData 4, textCP05, False
   'Add By Sindy 2023/4/27
   If Not m_PrevForm Is Nothing Then
      Call frm03010301_02.SetParent(m_PrevForm)
   End If
   frm03010301_02.m_strIR01 = m_strIR01
   frm03010301_02.m_strIR02 = m_strIR02
   frm03010301_02.m_strIR03 = m_strIR03
   frm03010301_02.m_strIR04 = m_strIR04
   '2023/4/27 END
   Me.Hide
   frm03010301_02.Show
   frm03010301_02.QueryData
End Sub
...
Private Sub textCP05_Validate(Cancel As Boolean)
   ...
   If IsEmptyText(textCP05) = False Then
      If CheckIsDate(textCP05, False) = False Then
         ...
         GoTo EXITSUB
      End If
      'edit by nickc 2006/03/17 應該要與系統日比對
