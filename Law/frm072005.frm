...
Begin VB.Form frm072005 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   300
      ItemData        =   "frm072005.frx":0000
      Left            =   6150
      List            =   "frm072005.frx":0002
      Style           =   2  '單純下拉式
      TabIndex        =   4
      Top             =   510
      Width           =   3195
   ...
   End
End
Attribute VB_Name = "frm072005"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2021/09/15 改成Form2.0 ; grdDataList改字型=新細明體-ExtB、lblUserName
...
On Error GoTo ErrorHandler
   ...
   For i = 1 To grdDataList.Rows - 1
      ...
      If Trim(grdDataList.Text) = "V" Then
         ...
         If cmdState = 2 Or cmdState = 3 Then
...
Dim stNumList As String, stDept As String, stCP01 As String
Dim ii As Integer
...
Dim rsTmp As New ADODB.Recordset
   ...
   stDate5 = CompWorkDay(7, strSrvDate(1)) '+5個工作天
   stDate3 = CompWorkDay(5, strSrvDate(1)) 'Add By Sindy 2011/6/27 系統日+3個工作天
   stDate6 = DBDATE(DateAdd("d", -6, ChangeWStringToWDateString(strSrvDate(1)))) 'Add By Sindy 2011/6/27 系統日-6天
   
   stConCP06 = " AND CP06>=" & stDate1 & " AND CP06< " & stDate2
   stConCP48 = " AND CP48>=" & stDate1 & " AND CP48< " & stDate2
   stConCP0603 = " AND CP06>=" & stDate1 & " AND CP06< " & stDate3 'Add By Sindy 2011/6/27
   
   '特殊權限
   bLvl4 = CheckLevel(stUserID, "U2") '第四級管制人
   bLvl5 = CheckLevel(stUserID, "U2") '第五級管制人
   
   'Modify By Sindy 2017/9/12
   '清除暫存檔
   strSql = "delete R072005 where ID='" & strUserNum & "'"
   ...
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, LawCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0" & stCP01 & stConCP06 & _
         " AND CP10<>'9001'" & _
         " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
         " AND LC08 IS NULL AND LC34 is null" & _
         " AND LC01 IS NOT NULL" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='A' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
   cnnConnection.Execute strSql, intI
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, HireCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP06 & _
         " AND CP10<>'9001'" & _
         " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
         " AND HC09 IS NULL AND HC19 is null" & _
         " AND HC01 IS NOT NULL" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='A' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
   cnnConnection.Execute strSql, intI
   ...
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, LawCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0" & stCP01 & stConCP0603 & _
         " AND CP10='9001'" & _
         " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
         " AND LC08 IS NULL AND LC34 is null" & _
         " AND LC01 IS NOT NULL" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='A' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
   cnnConnection.Execute strSql, intI
   'Modified by Lydia 2016/10/21 CP57 is null AND CP27 is null => CP158=0 AND CP159=0
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, HireCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP0603 & _
         " AND CP10='9001'" & _
         " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
         " AND HC09 IS NULL AND HC19 is null" & _
         " AND HC01 IS NOT NULL" & _
   ...
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','B' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, LawCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0" & stCP01 & stConCP48 & _
         " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
         " AND LC08 IS NULL AND LC34 is null" & _
         " AND LC01 IS NOT NULL" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='B' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
   cnnConnection.Execute strSql, intI
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','B' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, HireCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP48 & _
         " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
         " AND HC09 IS NULL AND HC19 is null" & _
         " AND HC01 IS NOT NULL" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='B' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
   ...
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','H' EV1,'1' EV2,CP09,to_number(to_char(to_date(cp27,'YYYYMMDD')+6,'YYYYMMDD')) CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, LawCase" & _
       " WHERE cp27>=20110701 and cp50 is not null" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP57||cp46 is null AND CP158>0" & _
         " AND CP27<=" & stDate6 & stCP01 & _
         " AND LC01=CP01 AND LC02=CP02 AND LC03=CP03 AND LC04=CP04" & _
         " AND LC08 IS NULL AND LC34 is null" & _
         " AND LC01 IS NOT NULL" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='H' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
   cnnConnection.Execute strSql, intI
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','H' EV1,'1' EV2,CP09,to_number(to_char(to_date(cp27,'YYYYMMDD')+6,'YYYYMMDD')) CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
         "From CASEPROGRESS, HireCase" & _
   ...
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','D' EV1,'3' EV2,NP01,NP08,NP09,0 CP48,0 EP08,'' NA16,'' CP14,NP10,NP22 " & _
         "From NEXTPROGRESS, LawCase" & _
       " WHERE NP02||NP06 in ('FCL','CFL','LIN','L')" & _
         " AND NP10 IN(" & stNumList & ")" & _
         " AND NP08>=" & stDate1 & " AND NP08< " & stDate5 & _
         " AND LC01(+)=NP02 AND LC02(+)=NP03 AND LC03(+)=NP04 AND LC04(+)=NP05" & _
         " AND LC08 IS NULL AND LC34 is null" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='D' and EV2='3' and R072005.CP09=NEXTPROGRESS.NP01 and np22=NEXTPROGRESS.NP22)"
   cnnConnection.Execute strSql, intI
   strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','D' EV1,'3' EV2,NP01,NP08,NP09,0 CP48,0 EP08,'' NA16,'' CP14,NP10,NP22 " & _
         "From NEXTPROGRESS, HireCase" & _
       " WHERE NP02||NP06 in ('LA')" & _
         " AND NP10 IN(" & stNumList & ")" & _
         " AND NP08>=" & stDate1 & " AND NP08< " & stDate5 & _
         " AND HC01(+)=NP02 AND HC02(+)=NP03 AND HC03(+)=NP04 AND HC04(+)=NP05" & _
         " AND HC09 IS NULL AND HC19 is null" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='D' and EV2='3' and R072005.CP09=NEXTPROGRESS.NP01 and np22=NEXTPROGRESS.NP22)"
   cnnConnection.Execute strSql, intI
   ...
   If idx = 1 Then
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','E' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
        " From CASEPROGRESS, LawCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0" & stCP01 & _
         " AND (cp06||cp48 is null or (cp06>=" & stDate2 & " and cp48 is null) or (cp06 is null and cp48>=" & stDate2 & ") or (cp06>=" & stDate2 & " and cp48>=" & stDate2 & "))" & _
         " AND LC01=CP01 AND LC02=CP02 AND LC03=CP03 AND LC04=CP04" & _
         " AND LC08 IS NULL AND LC34 is null" & _
         " AND LC01 IS NOT NULL" & _
         " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='E' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      cnnConnection.Execute strSql, intI
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
       "SELECT '" & strUserNum & "','E' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
        " From CASEPROGRESS, HireCase" & _
       " WHERE CP05>20030000" & _
         " AND (CP14 IN(" & stNumList & ") or CP29 IN(" & stNumList & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & _
         " AND (cp06||cp48 is null or (cp06>=" & stDate2 & " and cp48 is null) or (cp06 is null and cp48>=" & stDate2 & ") or (cp06>=" & stDate2 & " and cp48>=" & stDate2 & "))" & _
         " AND HC01=CP01 AND HC02=CP02 AND HC03=CP03 AND HC04=CP04" & _
         " AND HC09 IS NULL AND HC19 is null" & _
         " AND HC01 IS NOT NULL" & _
   ...
   If bLvl4 = True Or bLvl5 = True Then
      '承辦人為非法務處人員(st11 not in ('F1','F2','D4','G1'))
      strSql = "select distinct cp14 from caseprogress " & _
                     ...
                     "and exists (select * from staff where st01=cp14 and st11 not in ('F1','F2','D4','G1')) "
      intI = 1
      ...
      If strOtherUser <> "" Then
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
            "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
              "From CASEPROGRESS, LawCase" & _
            " WHERE CP05>20030000" & _
              " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP158=0 AND CP159=0" & stCP01 & stConCP06 & _
              " AND CP10<>'9001'" & _
              " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
              " AND LC08 IS NULL AND LC34 is null" & _
              " AND LC01 IS NOT NULL" & _
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
            "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
              "From CASEPROGRESS, HireCase" & _
            " WHERE CP05>20030000" & _
              " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP06 & _
              " AND CP10<>'9001'" & _
              " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
              " AND HC09 IS NULL AND HC19 is null" & _
              " AND HC01 IS NOT NULL" & _
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
            "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
              "From CASEPROGRESS, LawCase" & _
            " WHERE CP05>20030000" & _
              " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP158=0 AND CP159=0" & stCP01 & stConCP0603 & _
              " AND CP10='9001'" & _
              " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
              " AND LC08 IS NULL AND LC34 is null" & _
              " AND LC01 IS NOT NULL" & _
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
            "SELECT '" & strUserNum & "','A' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
              "From CASEPROGRESS, HireCase" & _
            " WHERE CP05>20030000" & _
              " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP0603 & _
              " AND CP10='9001'" & _
              " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
              " AND HC09 IS NULL AND HC19 is null" & _
              " AND HC01 IS NOT NULL" & _
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
            "SELECT '" & strUserNum & "','B' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
              "From CASEPROGRESS, LawCase" & _
            " WHERE CP05>20030000" & _
              " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP158=0 AND CP159=0" & stCP01 & stConCP48 & _
              " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
              " AND LC08 IS NULL AND LC34 is null" & _
              " AND LC01 IS NOT NULL" & _
              " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='B' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
            "SELECT '" & strUserNum & "','B' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
              "From CASEPROGRESS, HireCase" & _
            " WHERE CP05>20030000" & _
              " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP48 & _
              " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
              " AND HC09 IS NULL AND HC19 is null" & _
              " AND HC01 IS NOT NULL" & _
              " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='B' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
             "SELECT '" & strUserNum & "','H' EV1,'1' EV2,CP09,to_number(to_char(to_date(cp27,'YYYYMMDD')+6,'YYYYMMDD')) CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
               "From CASEPROGRESS, LawCase" & _
             " WHERE cp27>=20110701 and cp50 is not null" & _
               " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP57||cp46 is null AND CP158>0" & _
               " AND CP27<=" & stDate6 & stCP01 & _
               " AND LC01=CP01 AND LC02=CP02 AND LC03=CP03 AND LC04=CP04" & _
               " AND LC08 IS NULL AND LC34 is null" & _
               " AND LC01 IS NOT NULL" & _
         ...
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
             ...
             " WHERE cp27>=20110701 and cp50 is not null" & _
               " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP57||cp46 is null AND CP158>0" & _
               " AND CP27<=" & stDate6 & " and cp01='LA'" & _
               " AND HC01=CP01 AND HC02=CP02 AND HC03=CP03 AND HC04=CP04" & _
               " AND HC09 IS NULL AND HC19 is null" & _
               " AND HC01 IS NOT NULL" & _
               " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='H' and EV2='1' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
         ...
         If idx = 1 Then
            ...
            strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
             "SELECT '" & strUserNum & "','E' EV1,'1' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
               "From CASEPROGRESS, HireCase" & _
             " WHERE CP05>20030000" & _
               " AND (CP14 IN(" & strOtherUser & ") or CP29 IN(" & strOtherUser & ")) AND CP158=0 AND CP159=0 and cp01='LA'" & _
               " AND (cp06||cp48 is null or (cp06>=" & stDate2 & " and cp48 is null) or (cp06 is null and cp48>=" & stDate2 & ") or (cp06>=" & stDate2 & " and cp48>=" & stDate2 & "))" & _
               " AND HC01=CP01 AND HC02=CP02 AND HC03=CP03 AND HC04=CP04" & _
               " AND HC09 IS NULL AND HC19 is null" & _
               " AND HC01 IS NOT NULL" & _
      ...
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
         "SELECT '" & strUserNum & "','A' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
           "From CASEPROGRESS, LawCase" & _
         " WHERE CP05>20030000" & _
           " AND CP14||CP29 IS NULL AND CP158=0 AND CP159=0" & stCP01 & stConCP06 & _
           " AND CP10<>'9001'" & _
           " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
           " AND LC08 IS NULL AND LC34 is null" & _
           " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='A' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      cnnConnection.Execute strSql, intI
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
         "SELECT '" & strUserNum & "','A' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
           "From CASEPROGRESS, HireCase" & _
         " WHERE CP05>20030000" & _
           " AND CP14||CP29 IS NULL AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP06 & _
           " AND CP10<>'9001'" & _
           " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
           " AND HC09 IS NULL AND HC19 is null" & _
           " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='A' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      ...
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
        "SELECT '" & strUserNum & "','A' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
          "From CASEPROGRESS, LawCase" & _
        " WHERE CP05>20030000" & _
          " AND CP14||CP29 IS NULL AND CP158=0 AND CP159=0" & stCP01 & stConCP0603 & _
          " AND CP10='9001'" & _
          " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
          " AND LC08 IS NULL AND LC34 is null" & _
          " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='A' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      ...
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
        "SELECT '" & strUserNum & "','A' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
          "From CASEPROGRESS, HireCase" & _
        " WHERE CP05>20030000" & _
          " AND CP14||CP29 IS NULL AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP0603 & _
          " AND CP10='9001'" & _
          " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
          " AND HC09 IS NULL AND HC19 is null" & _
          " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='A' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      ...
      'Modified by Lydia 2016/10/21 CP57 is null AND CP27 is null => CP158=0 AND CP159=0
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
        "SELECT '" & strUserNum & "','B' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
          "From CASEPROGRESS, LawCase" & _
        " WHERE CP05>20030000" & _
          " AND CP14||CP29 IS NULL AND CP158=0 AND CP159=0" & stCP01 & stConCP48 & _
          " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04" & _
          " AND LC08 IS NULL AND LC34 is null" & _
          " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='B' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      cnnConnection.Execute strSql, intI
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
        "SELECT '" & strUserNum & "','B' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
          "From CASEPROGRESS, HireCase" & _
        " WHERE CP05>20030000" & _
          " AND CP14||CP29 IS NULL AND CP158=0 AND CP159=0 and cp01='LA'" & stConCP48 & _
          " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04" & _
          " AND HC09 IS NULL AND HC19 is null" & _
          " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='B' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      cnnConnection.Execute strSql, intI
      
      '已收文已發文,發文日期+6天未回執者 --承辦人-H0(發文日期,未分案)
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
         "SELECT '" & strUserNum & "','H' EV1,'0' EV2,CP09,to_number(to_char(to_date(cp27,'YYYYMMDD')+6,'YYYYMMDD')) CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
           "From CASEPROGRESS, LawCase" & _
         " WHERE cp27>=20110701 and cp50 is not null" & _
           " AND CP14||CP29 IS NULL AND CP57||cp46 is null AND CP158>0" & _
           " AND CP27<=" & stDate6 & stCP01 & _
           " AND LC01=CP01 AND LC02=CP02 AND LC03=CP03 AND LC04=CP04" & _
           " AND LC08 IS NULL AND LC34 is null" & _
           " AND LC01 IS NOT NULL" & _
          " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='H' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
      cnnConnection.Execute strSql, intI
      strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
        "SELECT '" & strUserNum & "','H' EV1,'0' EV2,CP09,to_number(to_char(to_date(cp27,'YYYYMMDD')+6,'YYYYMMDD')) CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
          "From CASEPROGRESS, HireCase" & _
      ...
      If idx = 1 Then
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
           "SELECT '" & strUserNum & "','E' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
             "From CASEPROGRESS, LawCase" & _
           " WHERE CP05>20030000" & _
             ...
             " AND LC01=CP01 AND LC02=CP02 AND LC03=CP03 AND LC04=CP04" & _
             " AND LC08 IS NULL AND LC34 is null" & _
             " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='E' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
         cnnConnection.Execute strSql, intI
         strSql = "INSERT INTO R072005(ID,EV1,EV2,CP09,CP06,CP07,CP48,EP08,NA16,CP14,CP13,NP22)" & _
           "SELECT '" & strUserNum & "','E' EV1,'0' EV2,CP09,CP06,CP07,CP48,0 EP08,'' NA16,nvl(CP14,CP29) CP14,CP13,0 " & _
             "From CASEPROGRESS, HireCase" & _
           " WHERE CP05>20030000" & _
             " AND CP14||CP29 IS NULL AND CP158=0 AND CP159=0 and cp01='LA'" & _
             " AND (cp06||cp48 is null or (cp06>=" & stDate2 & " and cp48 is null) or (cp06 is null and cp48>=" & stDate2 & ") or (cp06>=" & stDate2 & " and cp48>=" & stDate2 & "))" & _
             " AND HC01=CP01 AND HC02=CP02 AND HC03=CP03 AND HC04=CP04" & _
             " AND HC09 IS NULL AND HC19 is null" & _
             " AND not exists (select * from R072005 where ID='" & strUserNum & "' and EV1='E' and EV2='0' and R072005.CP09=CASEPROGRESS.CP09 and np22=0)"
   ...
   strSql = "delete from R072005 R1 where R1.ID='" & strUserNum & "' and R1.EV1<>'A'" & _
            " AND exists (select * from R072005 R2 where R2.ID='" & strUserNum & "' and R2.EV1='A' and R2.CP09=R1.CP09 and R2.np22=R1.np22)"
   cnnConnection.Execute strSql, intI
   '2017/9/11 END
   
   'Modify By Sindy 2015/5/27 承辦人若無資料,則抓法務協辦人員
   '案件進度
   'Modified by Lydia 2020/09/16 +別名CaseNo
   'Modified by Lydia 2020/12/18 SORT: 無所限CP06排最下面 decode(R072005.CP06,0,99999999,R072005.CP06)=> decode(nvl(R072005.CP06,0),0,9,1)
   ...
   strExc(0) = "SELECT distinct '' V," & _
      "NVL(lpad(SQLDateT(R072005.CP06),9,' '),'2') 本所期限," & _
      "NVL(lpad(SQLDateT(R072005.CP07),9,' '),'2') 法定期限," & _
      "NVL(lpad(SQLDateT(R072005.CP48),10,' '),'2') 承辦期限," & _
      "NVL(lpad(SQLDateT(R072005.EP08),10,' '),'2') 核稿期限," & _
      "S1.ST02 管制人," & _
      "S2.ST02 承辦人," & _
      "S3.ST02 智權人員," & _
      "DECODE(EV1,'A','達本所','B','達承辦','D','未收文','E','未發文','H','未回執') 事件," & _
      "CP01||'-'||CP02||DECODE(CP03,'0','','-'||CP03)||DECODE(CP04,'00','','-'||CP04) 本所案號," & _
      "DECODE(LC15,'000',CPM03,CPM04) 案件性質," & _
      "CP64 案件備註," & _
      "NVL(LC05,NVL(LC06,LC07)) 案件名稱," & _
      "'' 代理人國籍," & _
      "EV1,EV2,R072005.NA16,R072005.CP14,R072005.CP13,LC01,LC02,LC03,LC04,'' 未收款,CP10,0 CP27,R072005.CP09,LC15,'' ti01,R072005.NP22,decode(nvl(R072005.CP06,0),0,9,1) sort," & _
      "LC01||'-'||LC02||'-'||LC03||'-'||LC04 as CaseNo " & _
      " FROM R072005,CASEPROGRESS,LawCase,STAFF S1,STAFF S2,STAFF S3,CASEPROPERTYMAP" & _
      " WHERE ID='" & strUserNum & "' AND caseprogress.CP09(+)=R072005.CP09 AND NP22=0" & _
      " AND LC01(+)=CP01 AND LC02(+)=CP02 AND LC03(+)=CP03 AND LC04(+)=CP04 AND LC01 IS NOT NULL" & _
      " AND S1.ST01(+)=R072005.NA16" & _
      " AND S2.ST01(+)=R072005.CP14" & _
      " AND S3.ST01(+)=R072005.CP13" & _
      " AND CPM01(+)=CP01" & _
      " AND CPM02(+)=CP10"
   'Modified by Lydia 2022/06/24 判斷澳門案;  + 044
   'Modified by Lydia 2022/06/28 DECODE(INSTR('020,013,044','000'),0,CPM03,CPM04) => CPM03
   strExc(0) = strExc(0) & " UNION " & _
      ...
      "HC06 案件名稱," & _
      "'' 代理人國籍," & _
      "EV1,EV2,R072005.NA16,R072005.CP14,R072005.CP13,HC01,HC02,HC03,HC04,'' 未收款,CP10,0 CP27,R072005.CP09,'000' LC15,'' ti01,R072005.NP22,decode(nvl(R072005.CP06,0),0,9,1) sort," & _
      "HC01||'-'||HC02||'-'||HC03||'-'||HC04" & _
      " FROM R072005,CASEPROGRESS,HireCase,STAFF S1,STAFF S2,STAFF S3,CASEPROPERTYMAP" & _
      " WHERE ID='" & strUserNum & "' AND caseprogress.CP09(+)=R072005.CP09 AND NP22=0" & _
      " AND HC01(+)=CP01 AND HC02(+)=CP02 AND HC03(+)=CP03 AND HC04(+)=CP04 AND HC01 IS NOT NULL" & _
      " AND S1.ST01(+)=R072005.NA16" & _
      " AND S2.ST01(+)=R072005.CP14" & _
      " AND S3.ST01(+)=R072005.CP13" & _
      " AND CPM01(+)=CP01" & _
   ...
   strExc(0) = strExc(0) & " UNION " & _
      ...
      "S3.ST02 智權人員," & _
      "DECODE(EV1,'A','達本所','B','達承辦','D','未收文','E','未發文','H','未回執') 事件," & _
      "NP02||'-'||NP03||DECODE(NP04,'0','','-'||NP04)||DECODE(NP05,'00','','-'||NP05) 本所案號," & _
      "DECODE(LC15,'000',CPM03,CPM04) 案件性質," & _
      "NP15 案件備註," & _
      "NVL(LC05,NVL(LC06,LC07)) 案件名稱," & _
      "'' 代理人國籍," & _
      "EV1,EV2,R072005.NA16,R072005.CP14,R072005.CP13,LC01,LC02,LC03,LC04,'' 未收款,NP07,0 CP27,R072005.CP09,LC15,'' ti01,R072005.NP22,decode(nvl(R072005.CP06,0),0,9,1) sort," & _
      "LC01||'-'||LC02||'-'||LC03||'-'||LC04" & _
      " FROM R072005,NEXTPROGRESS,LawCase,STAFF S1,STAFF S2,STAFF S3,CASEPROPERTYMAP" & _
      " WHERE ID='" & strUserNum & "' AND NP01(+)=R072005.CP09 AND NEXTPROGRESS.NP22(+)=R072005.NP22 AND R072005.NP22>0" & _
   ...
   strExc(0) = strExc(0) & " UNION " & _
      ...
      "HC06 案件名稱," & _
      "'' 代理人國籍," & _
      "EV1,EV2,R072005.NA16,R072005.CP14,R072005.CP13,HC01,HC02,HC03,HC04,'' 未收款,NP07,0 CP27,R072005.CP09,'000' LC15,'' ti01,R072005.NP22,decode(nvl(R072005.CP06,0),0,9,1) sort," & _
      "HC01||'-'||HC02||'-'||HC03||'-'||HC04" & _
      " FROM R072005,NEXTPROGRESS,HireCase,STAFF S1,STAFF S2,STAFF S3,CASEPROPERTYMAP" & _
      " WHERE ID='" & strUserNum & "' AND NP01(+)=R072005.CP09 AND NEXTPROGRESS.NP22(+)=R072005.NP22 AND R072005.NP22>0" & _
      " AND HC01(+)=NP02 AND HC02(+)=NP03 AND HC03(+)=NP04 AND HC04(+)=NP05 AND HC01 IS NOT NULL" & _
      " AND S1.ST01(+)=R072005.NA16" & _
      " AND S2.ST01(+)=R072005.CP14" & _
      " AND S3.ST01(+)=R072005.CP13" & _
      " AND CPM01(+)=NP02" & _
   ...
   strExc(0) = strExc(0) & " order by sort asc, 本所期限 asc,承辦人 asc,本所案號 asc" 'Added by Lydia 2020/09/16 無法在其定義長度是不明或過長的資料行執行 Relate、Compute By、及 Sort 操作的錯誤
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      'Remove by Lydia 2020/09/16 無法在其定義長度是不明或過長的資料行執行 Relate、Compute By、及 Sort 操作的錯誤
...
Private Sub grdDataList_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    If grdDataList.row < 1 Then
      ...
      If m_blnColOrderAsc = True Then
         'Modified by Lydia 2020/09/16 無法在其定義長度是不明或過長的資料行執行 Relate、Compute By、及 Sort 操作的錯誤
