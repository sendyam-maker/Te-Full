...
Dim LcTmp As String
   ...
   If txtcp01 <> "LA" Then
     ...
     " cp50 as 收件人,CP64 AS 進度備註,decode(cp71,or01,or02) as 機關名稱,lc05,lc06,lc07,lc11  from caseprogress, lawcase," + _
   ...
   Else
     ...
     " decode(cp27,null,'',SUBSTR(CP27, 1, 4)- 1911 || '/' || SUBSTR(CP27, 5, 2)|| '/' || SUBSTR(CP27, 7, 2)) as 發文日," + _
     " decode(cp46,null,'',SUBSTR(CP46, 1, 4)- 1911 || '/' || SUBSTR(CP46, 5, 2)|| '/' || SUBSTR(CP46, 7, 2)) as 回執日," + _
     " cp50 as 收件人,CP64 AS 進度備註,decode(cp71,or01,or02) as 機關名稱,hc06,null,null,hc05 from caseprogress, hirecase,STAFF S1," + _
   ...
   End If
   strExc(1) = strExc(1) & " AND CP10<>'0' ORDER BY CP27 DESC,CP09"
   intI = 0
