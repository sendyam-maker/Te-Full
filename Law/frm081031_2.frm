...
Begin VB.Form frm081031_2 
   ...
   End
   Begin MSForms.Label lbeCustomer 
      Height          =   285
      Left            =   1170
      TabIndex        =   8
      Top             =   1080
   ...
   End
End
Attribute VB_Name = "frm081031_2"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo by Lydia 2021/04/26 Form2.0已修改 cboCaseName、lbeCustomer 、lbeCusName ; MSHFlexGrid1改字型=新細明體-ExtB
...
Private Sub Form_Load()
 Dim i As Integer, temp(2 To 4) As String
   IsNoExistData = False
   MoveFormToCenter Me
   lbeCaseNumber = frm081031_1.lbeNumber
   lbeCustomer = frm081031_1.Text(1)
   lbeCusName = frm081031_1.lbe(1)
   temp(2) = "中:"
   temp(3) = "英:"
   temp(4) = "日:"
   For i = 2 To 4
      If frm081031_1.Text(i) <> "" Then
         cboCaseName.AddItem temp(i) + frm081031_1.Text(i)
      End If
   Next
   If cboCaseName.ListCount <> 0 Then
      cboCaseName.ListIndex = 0
   End If
   LcTmp = frm081031_1.lbeNumber.Tag
   GetGridData
   GridHead
...
Dim rs As New ADODB.Recordset, i As Integer
   ...
   strExc(1) = "select '',cp09,decode(cp05,null,'',SUBSTR(CP05, 1, 4)- 1911 || '/' || SUBSTR(CP05, 5, 2)|| '/' || SUBSTR(CP05, 7, 2))" + _
      ...
      " and " & ChgLawcase(LcTmp) & " and cp09<>" + CNULL(frm081031_1.lbePaperNum)
   intI = 0
