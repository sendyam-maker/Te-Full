...
Begin VB.Form frm06010608_1 
   ...
   End
End
Attribute VB_Name = "frm06010608_1"
...
Public Sub Clear()
   ...
   Text3 = Empty
   Text4 = Empty
   'Modified by Lydia 2019/11/14 因為frm06010608_3呼叫,造成回到畫面,再用申請案號查詢,Grid有問題
   'MSHFlexGrid1.Rows = 1
...
Dim rsRec As New ADODB.Recordset 'Added by Lydia 2019/11/14 取代共用的RsTemp
   ...
   ElseIf Option1(1).Value = True Then
      ...
      If intI = 1 Then
        ...
        End If
         frm06010608_2.Show
         Call frm06010608_2.cmdOK_Click(0) 'Add By Sindy 2015/9/25
         Me.Hide
      End If
