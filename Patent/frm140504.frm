...
Begin VB.Form frm140504 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":031C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":0638
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":0814
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":0B30
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":0E4C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":1168
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":1484
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":1ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm140504.frx":1DD8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "單筆資料"
      TabPicture(0)   =   "frm140504.frx":20F4
      ...
      TabCaption(1)   =   "多筆瀏覽"
      TabPicture(1)   =   "frm140504.frx":2110
      ...
      Begin VB.Label Label7 
         Caption         =   "PS：此設定不包含關係企業；付款週期基本為2個月。"
         ForeColor       =   &H000000C0&
         Height          =   290
         Left            =   540
         TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frm140504"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'Memo By Sindy 2021/12/17 Form2.0已修改
'Create By Lydia 2018/08/17 客戶特殊付款週期維護
Option Explicit
...
Private Const custSQL = "SELECT CU01 CL01,NVL(CU04,DECODE(CU05,NULL,CU06,CU05||' '||CU88||' '||CU89||' '||CU90)) CL02,CU13 CL03,ST02 CL04,CU175 CL05 FROM CUSTOMER,STAFF WHERE CU13=ST01(+) AND CU175>0 "
...
Dim nIndex As Integer
   ...
   For nIndex = 0 To tf_CL - 1
      ...
      End If
      If strTmp = "CL05" Then
         strSql = "UPDATE CUSTOMER SET CU175=" & m_FieldList(nIndex).fiNewData & " WHERE CU01='" & textCL01 & "' "
      End If
   Next nIndex
...
Dim nIndex As Integer
   ...
   For nIndex = 0 To tf_CL - 1
      ...
      End If
      If strTmp = "CL05" Then
         strSql = "UPDATE CUSTOMER SET CU175=" & m_FieldList(nIndex).fiNewData & " WHERE CU01='" & textCL01 & "' AND CU175=" & m_FieldList(nIndex).fiOldData
      End If
   Next nIndex
...
On Error GoTo ErrHand
   ...
   strSql = "UPDATE CUSTOMER SET CU175=NULL WHERE CU01='" & textCL01 & "' AND CU175=" & textCL05
...
Dim strMsg As String
   ...
   If Val(textCL05.Text) = 0 Then
       MsgBox "客戶特殊付款週期不可空白！", vbExclamation
       textCL05.SetFocus
       Exit Function
   End If
...
Private Sub SetGrd(Optional ByVal iR As Integer = 2)
   ...
   arrGridHeadText = Array("客戶編號", "客戶名稱", "CL03", "智權人員", "客戶特殊付款週期")
   arrGridHeadWidth = Array(1200, 2500, 0, 1000, 1700)
   GRD1.Visible = False
   GRD1.Rows = iR
   ...
   Next
   If iR >= 2 Then
        For iCol = 1 To GRD1.Rows - 1
             GRD1.row = iCol
             GRD1.col = 4
             GRD1.CellAlignment = flexAlignCenterCenter '置中
        Next iCol
   End If
