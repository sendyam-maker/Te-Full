...
Dim PLeft(0 To 28) As Integer, strTemp1 As Variant, strTemp2 As Variant
            ...
            End If
             ...
             Else
               ...
               If Me.txt1(5).Text <> "" And Me.txt1(6).Text <> "" Then
                  ...
                  End If
               End If
'               lbl1(1).Caption = GetPrjSales(txt1(7))
               lbl1(1).Caption = GetPrjSales(txt1(7), "智權人員")
               If Me.txt1(7).Text <> "" Then
                  If Me.txt1(7).Text = Me.lbl1(1).Caption Then
                     Me.lbl1(1).Caption = ""
                     Me.txt1(7).SetFocus
                     txt1_GotFocus 7
                     Exit Sub
...
cnnConnection.Execute "DELETE FROM R060401 WHERE ID='" & strUserNum & "' "
'cnnConnection.Execute "DELETE FROM R060401 WHERE ID='" & strUserNum & "' "
strSQL1 = ""
strSQL2 = ""
StrSQL6 = ""
...
If Len(txt1(5)) <> 0 Or Len(txt1(6)) <> 0 Then
   pub_QL05 = pub_QL05 & ";" & Label1(4) & txt1(5) & "-" & txt1(6) 'Add By Sindy 2010/12/13
End If
If Len(txt1(7)) <> 0 Then
    StrSQL6 = StrSQL6 + " AND CP13='" & txt1(7) & "' "
    pub_QL05 = pub_QL05 & ";" & Label1(5) & txt1(7) & lbl1(1) 'Add By Sindy 2010/12/13
End If
If Len(txt1(8)) <> 0 Then
    StrSQL6 = StrSQL6 + " AND CP10>='" & txt1(8) & "' "
End If
If Len(txt1(9)) <> 0 Then
    StrSQL6 = StrSQL6 + " AND CP10<='" & txt1(9) & "' "
End If
If Len(txt1(8)) <> 0 Or Len(txt1(9)) <> 0 Then
   pub_QL05 = pub_QL05 & ";" & Label1(6) & txt1(8) & "-" & txt1(9) 'Add By Sindy 2010/12/13
End If
...
strSql = "SELECT cp14,ST15,cp13,CP10,CP09 FROM CASEPROGRESS,staff WHERE CP14=ST01(+) " & strSQL1 & StrSQL6
strSql = strSql + "union all select cp14,ST15,cp13,CP10,CP09 FROM CASEPROGRESS,STAFF WHERE CP14=ST01(+) " & strSQL2 & StrSQL6
CheckOC
...
If adoRecordset.RecordCount <> 0 And adoRecordset.RecordCount > 0 Then
    With adoRecordset
        ...
        Do While .EOF = False
            ...
            strSql = "INSERT INTO R060401 VALUES('" & ChgSQL(strTemp(0)) & "','" & ChgSQL(strTemp(1)) & "','" & ChgSQL(strTemp(2)) & "'," & Val(strTemp(3)) & "," & Val(strTemp(4)) & "," & Val(strTemp(5)) & "," & Val(strTemp(6)) & "," & Val(strTemp(7)) & "," & Val(strTemp(8)) & "," & Val(strTemp(9)) & "," & Val(strTemp(10)) & "," & Val(strTemp(11)) & "," & Val(strTemp(12)) & "," & Val(strTemp(13)) & "," & Val(strTemp(14)) & "," & Val(strTemp(15)) & "," & Val(strTemp(16)) & "," & Val(strTemp(17)) & "," & Val(strTemp(18)) & "," & Val(strTemp(19)) & "," & Val(strTemp(20)) & "," & Val(strTemp(21)) & "," & Val(strTemp(22)) & "," & Val(strTemp(23)) & "," & Val(strTemp(24)) & "," & Val(strTemp(25)) & "," & Val(strTemp(26)) & "," & Val(strTemp(27)) & "," & Val(strTemp(28)) & "," & Val(strTemp(29)) & ",'" & strUserNum & "') "
...
'Sub Process1()            '承辦人
'strSQL = "SELECT ST01,CP10,PA08 FROM CASEPROGRESS,STAFF,PATENT WHERE PA01=CP01 AND PA02=CP02 AND Pa03=CP03 AND PA04=CP04 AND CP14=ST01(+) AND (SUBSTR(CP09,1,1)='A' OR SUBSTR(CP09,1,1)='B' OR (SUBSTR(CP09,1,1)='C' AND CP10='1002')) " & StrSQL1 & StrSQL6
'strSQL = strSQL + "union all select ST01,CP10,'' FROM CASEPROGRESS,STAFF,SERVICEPRACTICE WHERE SP01=CP01 AND SP02=CP02 AND SP03=CP03 AND SP04=CP04 AND CP14=ST01(+) AND (SUBSTR(CP09,1,1)='A' OR SUBSTR(CP09,1,1)='B' OR (SUBSTR(CP09,1,1)='C' AND CP10='1002')) " & StrSQL2 & StrSQL6
'CheckOC
'k = 0
'adoRecordset.CursorLocation = adUseClient
'adoRecordset.Open strSQL, cnnConnection, adOpenStatic, adLockReadOnly
...
'            Next i
'            strTemp(0) = CheckStr(.Fields(0))
'            Select Case Val(CheckStr(.Fields(1)))
'            Case 101
'                 strTemp(1) = "1"
'            Case 102
'                 strTemp(2) = "1"
...
'                 strTemp(18) = "1"
'            End Select
'            strSQL = "INSERT INTO R060401_2 VALUES('" & chgsql(strTemp(0)) & "'," & Val(strTemp(1)) & "," & Val(strTemp(2)) & "," & Val(strTemp(3)) & "," & Val(strTemp(4)) & "," & Val(strTemp(5)) & "," & Val(strTemp(6)) & "," & Val(strTemp(7)) & "," & Val(strTemp(8)) & "," & Val(strTemp(9)) & "," & Val(strTemp(10)) & "," & Val(strTemp(11)) & "," & Val(strTemp(12)) & "," & Val(strTemp(13)) & "," & Val(strTemp(14)) & "," & Val(strTemp(15)) & "," & Val(strTemp(16)) & "," & Val(strTemp(17)) & "," & Val(strTemp(18)) & "," & Val(strTemp(19)) & ",'" & strUserNum & "') "
'            cnnConnection.Execute strSQL
'            .MoveNext
'            k = k + 1
...
'    End With
'Else
'    S = MsgBox("資料庫搜尋不到符合資料", , "USER 輸入錯誤")
'    Exit Sub
'End If
'PrintData2
'Unload frm100
...
'Sub Process2()            '智權人員
'strSQL = "SELECT ST01,CP10,PA08 FROM CASEPROGRESS,STAFF,PATENT WHERE PA01=CP01 AND PA02=CP02 AND Pa03=CP03 AND PA04=CP04 AND CP13=ST01(+) AND (SUBSTR(CP09,1,1)='A' OR SUBSTR(CP09,1,1)='B' OR (SUBSTR(CP09,1,1)='C' AND CP10='1002')) " & StrSQL1 & StrSQL6
'strSQL = strSQL + "union all select ST01,CP10,'' FROM CASEPROGRESS,STAFF,SERVICEPRACTICE WHERE SP01=CP01 AND SP02=CP02 AND SP03=CP03 AND SP04=CP04 AND CP13=ST01(+) AND (SUBSTR(CP09,1,1)='A' OR SUBSTR(CP09,1,1)='B' OR (SUBSTR(CP09,1,1)='C' AND CP10='1002')) " & StrSQL2 & StrSQL6
'CheckOC
'k = 0
'adoRecordset.CursorLocation = adUseClient
'adoRecordset.Open strSQL, cnnConnection, adOpenStatic, adLockReadOnly
...
'                 strTemp(27) = "1"
'            End Select
'            strSQL = "INSERT INTO R060401_1 VALUES('" & chgsql(strTemp(0)) & "'," & Val(strTemp(1)) & "," & Val(strTemp(2)) & "," & Val(strTemp(3)) & "," & Val(strTemp(4)) & "," & Val(strTemp(5)) & "," & Val(strTemp(6)) & "," & Val(strTemp(7)) & "," & Val(strTemp(8)) & "," & Val(strTemp(9)) & "," & Val(strTemp(10)) & "," & Val(strTemp(11)) & "," & Val(strTemp(12)) & "," & Val(strTemp(13)) & "," & Val(strTemp(14)) & "," & Val(strTemp(15)) & "," & Val(strTemp(16)) & "," & Val(strTemp(17)) & "," & Val(strTemp(18)) & "," & Val(strTemp(19)) & "," & Val(strTemp(20)) & "," & Val(strTemp(21)) & "," & Val(strTemp(22)) & "," & Val(strTemp(23)) & "," & Val(strTemp(24)) & "," & Val(strTemp(25)) & "," & Val(strTemp(26)) & "," & Val(strTemp(27)) & "," & Val(strTemp(28)) & ",'" & strUserNum & "') "
'            cnnConnection.Execute strSQL
'            .MoveNext
'            k = k + 1
'            frm100.Tag = Trim(str(.RecordCount)) & "=" & Trim(str(k))
...
strSql = "select DECODE(st02,NULL,R049001,ST02),sum(r049004),sum(r049005),sum(r049006),sum(r049007)" & _
         ...
         ",r049001 from r060401,staff where r049001=st01(+) and (r049002 <> 'F22' OR R049002 IS NULL) and id='" & strUserNum & "' " & _
...
strSql = "select '合  計',sum(r049004),sum(r049005),sum(r049006),sum(r049007)" & _
         ...
         ",sum(r049015),sum(r049016),sum(r049017),sum(r049018),sum(r049019),sum(r049020)" & _
         ",sum(R049004+R049005+R049006+R049007+R049008+R049009+R049010+R049011+R049012+R049013+R049014+R049015+R049016+R049017+R049018+R049019+R049020)" & _
         " from r060401 where (r049002 <> 'F22' OR R049002 IS NULL) and id='" & strUserNum & "' "
...
'89/11/16 nick 改
'印非f22
strSql = "select DECODE(st02,NULL,R049003,ST02),sum(r049021),sum(r049022),sum(r049023),sum(r049024),sum(r049025),sum(r049026)" & _
         ",sum(r049027),sum(r049028),sum(r049029),sum(r049006),sum(r049007)" & _
         ",sum(r049008),sum(r049009),sum(r049010),sum(r049011),sum(r049012),sum(r049013),sum(r049014)" & _
         ",sum(r049015),sum(r049016),sum(r049019),sum(DECODE(r049004,NULL,0,R049004)+DECODE(r049005,NULL,0,R049005)+DECODE(r049017,NULL,0,R049017)+DECODE(r049018,NULL,0,R049018)+DECODE(r049020,NULL,0,R049020)+DECODE(R049030,NULL,0,R049030))" & _
         ",sum(R049004+R049005+R049006+R049007+R049008+R049009+R049010+R049011+R049012+R049013+R049014+R049015+R049016+R049017+R049018+R049019+R049020+R049021+R049022+R049023+R049024+R049025+R049026+R049027+R049028+R049029+R049030)" & _
         ",r049003 from r060401,staff where r049003=st01(+) and id='" & strUserNum & "' " & _
         " GROUP BY DECODE(st02,NULL,R049003,ST02),R049003 order by decode(r049003,null,'0',r049003) "
CheckOC
Page = 1
adoRecordset.CursorLocation = adUseClient
adoRecordset.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
    ...
    With adoRecordset
        ...
        Do While .EOF = False
            ...
            If iPrint >= 9000 Then
               ...
               Printer.CurrentX = 0
               Printer.CurrentY = iPrint
               Printer.Print "備註：1.讓與含合併、繼承、授權、設定質權"
               iPrint = iPrint + 300
               Printer.CurrentX = 0 + (Printer.TextWidth("備註："))
               Printer.CurrentY = iPrint
               Printer.Print "2.領證含加註追加、加註聯合"
               iPrint = iPrint + 300
               Printer.CurrentX = 0 + (Printer.TextWidth("備註："))
               Printer.CurrentY = iPrint
               Printer.Print "3.改請含所有改請程序"
...
If iPrint >= 9000 Then
    ...
    PrintTitle3
End If
strSql = "select '合  計',sum(r049021),sum(r049022),sum(r049023),sum(r049024),sum(r049025),sum(r049026)" & _
         ",sum(r049027),sum(r049028),sum(r049029),sum(r049006),sum(r049007)" & _
         ",sum(r049008),sum(r049009),sum(r049010),sum(r049011),sum(r049012),sum(r049013),sum(r049014)" & _
         ",sum(r049015),sum(r049016),sum(r049019),sum(DECODE(r049020,NULL,0,R049020)+DECODE(R049030,NULL,0,R049030))" & _
         ",sum(R049006+R049007+R049008+R049009+R049010+R049011+R049012+R049013+R049014+R049015+R049016+R049019+R049020+R049021+R049022+R049023+R049024+R049025+R049026+R049027+R049028+R049029+R049030)" & _
         " from r060401 where id='" & strUserNum & "' "
         

'strSQL = "select '合  計',sum(r049004),sum(r049005),sum(r049006),sum(r049007),sum(r049008),sum(r049009),sum(r049010),sum(r049011),sum(r049012),sum(r049013),sum(r049014),sum(r049015),sum(r049016),sum(r049017),sum(r049018),sum(r049019),sum(r049020),sum(R049004+R049005+R049006+R049007+R049008+R049009+R049010+R049011+R049012+R049013+R049014+R049015+R049016+R049017+R049018+R049019+R049020) from r060401 where id='" & strUserNum & "' "
CheckOC
adoRecordset.CursorLocation = adUseClient
adoRecordset.Open strSql, cnnConnection, adOpenStatic, adLockReadOnly
If adoRecordset.RecordCount <> 0 And adoRecordset.RecordCount > 0 Then
...
strSql = "select DECODE(st02,NULL,R049001,ST02),sum(r049021),sum(r049022),sum(r049023),sum(r049024)" & _
         ...
         ",r049001 from r060401,staff where r049001=st01(+) and r049002 = 'F22' and id='" & strUserNum & "' " & _
         " GROUP BY DECODE(st02,NULL,R049001,ST02),R049001 order by decode(r049001,null,'0',r049001) "
CheckOC
Page = 1
adoRecordset.CursorLocation = adUseClient
...
strSql = "select '合  計',sum(r049021),sum(r049022),sum(r049023),sum(r049024)" & _
         ",sum(r049025),sum(r049026),sum(r049027),sum(r049028),sum(r049029),sum(r049030)" & _
         ",sum(R049021+R049022+R049023+R049024+R049025+R049026+R049027+R049028+R049029+R049030)" & _
         " from r060401 where r049002 = 'F22' and id='" & strUserNum & "' "
...
Printer.CurrentX = 7500 - (Printer.TextWidth(GetTitleNick & "收文統計表") / 2)
Printer.CurrentY = iPrint
Printer.Print GetTitleNick & "收文統計表"
iPrint = iPrint + 500
Printer.Font.Size = 12
Printer.Font.Bold = False
Printer.Font.Underline = False
Printer.CurrentX = 7500 - (Printer.TextWidth("收文日：" & Format(ChangeTStringToTDateString(txt1(1)), "@@@@@@@@@@") & "－" & ChangeTStringToTDateString(txt1(2))) / 2)
Printer.CurrentY = iPrint
