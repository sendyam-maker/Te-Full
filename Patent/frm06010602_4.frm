...
Begin VB.Form frm06010602_4 
   ...
   Begin TabDlg.SSTab tabCtrl 
      ...
      TabHeight       =   420
      TabCaption(0)   =   "第一頁"
      TabPicture(0)   =   "frm06010602_4.frx":0000
      ...
      Tab(0).Control(36)=   "textCE09"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "textCE03"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "textCE16"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "textCE56"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "textCE54"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "textCE52"
      ...
      TabCaption(1)   =   "第二頁"
      TabPicture(1)   =   "frm06010602_4.frx":001C
      ...
      Tab(1).Control(22)=   "textCE61"
      Tab(1).Control(22).Enabled=   0   'False
      Tab(1).Control(23)=   "textCE23"
      Tab(1).Control(23).Enabled=   0   'False
      Tab(1).Control(24)=   "textCE24"
      Tab(1).Control(24).Enabled=   0   'False
      Tab(1).Control(25)=   "textCE25"
      Tab(1).Control(25).Enabled=   0   'False
      Tab(1).Control(26)=   "textCE57"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "textCE39"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "textCE41"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "textCE42"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "textCE43"
      Tab(1).Control(30).Enabled=   0   'False
      Tab(1).Control(31)=   "textCE45"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "textCE47"
      Tab(1).Control(32).Enabled=   0   'False
      Tab(1).Control(33)=   "textCE49"
      Tab(1).Control(33).Enabled=   0   'False
      Tab(1).Control(34)=   "textCE59"
      Tab(1).Control(34).Enabled=   0   'False
      Tab(1).Control(35)=   "textCE38"
      Tab(1).Control(35).Enabled=   0   'False
      Tab(1).Control(36)=   "textCE58"
      Tab(1).Control(36).Enabled=   0   'False
      Tab(1).Control(37)=   "textCE40"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "textCE60"
      Tab(1).Control(38).Enabled=   0   'False
      Tab(1).Control(39)=   "textCE44"
      Tab(1).Control(39).Enabled=   0   'False
      Tab(1).Control(40)=   "textCE46"
      Tab(1).Control(40).Enabled=   0   'False
      Tab(1).Control(41)=   "textCE48"
      Tab(1).Control(41).Enabled=   0   'False
      Tab(1).Control(42)=   "textCE50"
      Tab(1).Control(42).Enabled=   0   'False
      Tab(1).Control(43)=   "textCE62"
   ...
   End
End
Attribute VB_Name = "frm06010602_4"
...
' 針對商標基本檔欄位所用的暫存陣列
Dim m_PAList() As FIELDITEM
Dim m_PACount As Integer
...
' 檢查該商標基本檔的欄位是否存在
Private Function IsPAFieldExist(ByVal strField As String) As Boolean
   Dim nIndex As Integer
   IsPAFieldExist = False
   For nIndex = 0 To m_PACount - 1
      If m_PAList(nIndex).fiName = strField Then
         IsPAFieldExist = True
         Exit For
      End If
   Next nIndex
End Function
' 新增一個欄位
Private Sub AddPAField(ByVal strField As String, ByVal strOldData As String, ByVal nType As Integer)
   If IsPAFieldExist(strField) = True Then
      GoTo EXITSUB
   End If
   ReDim Preserve m_PAList(m_PACount + 1)
   m_PAList(m_PACount).fiName = strField
   m_PAList(m_PACount).fiOldData = strOldData
   m_PAList(m_PACount).fiNewData = strOldData
   m_PAList(m_PACount).fiType = nType
   m_PACount = m_PACount + 1
EXITSUB:
End Sub
' 設定欄位新值
Private Sub SetPAFieldNewData(ByVal strField As String, ByVal strNewData As String)
   Dim nIndex As Integer
   For nIndex = 0 To m_PACount - 1
      If m_PAList(nIndex).fiName = strField Then
         m_PAList(nIndex).fiNewData = strNewData
         Exit For
      End If
   Next nIndex
End Sub
' 清除欄位串列
Private Sub ClearPAFields()
   Erase m_PAList
   m_PACount = 0
End Sub
...
Private Sub cmdOK_Click()
   ...
   'Add by Sindy 2021/11/18 檢查畫面上的物件是否含有Unicode文字
...
Public Sub QueryData()
   ...
   textTMKey = m_PA01 & m_PA02 & m_PA03 & m_PA04
   textCE01 = m_CE01
...
Public Sub OnUpdatePatent()
   ...
   If rsTmp.RecordCount > 0 Then
      ...
      If textCE03 = "1" Then
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA10")) = False Then: strTmp = rsTmp.Fields("PA10")
         AddPAField "PA10", strTmp, 1
         SetPAFieldNewData "PA10", m_CE02
      End If
      ' 申請人
      bModifyCE09 = False
      If textCE09 = "1" Then
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA26")) = False Then: strTmp = rsTmp.Fields("PA26")
         AddPAField "PA26", strTmp, 0
         SetPAFieldNewData "PA26", m_CE04
         '連帶變更申請人的地址(中, 英, 日)
         bModifyCE09 = True
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA31")) = False Then: strTmp = rsTmp.Fields("PA31")
         AddPAField "PA31", strTmp, 0
         SetPAFieldNewData "PA31", GetAddress(m_CE04, 0)
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA36")) = False Then: strTmp = rsTmp.Fields("PA36")
         AddPAField "PA36", strTmp, 0
         SetPAFieldNewData "PA36", GetAddress(m_CE04, 1)
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA41")) = False Then: strTmp = rsTmp.Fields("PA41")
         AddPAField "PA41", strTmp, 0
         SetPAFieldNewData "PA41", GetAddress(m_CE04, 2)
      End If
      ' 申請地址
      ...
      If textCE38 = "1" Then
         ...
         If IsNull(rsTmp.Fields("PA31")) = False Then: strTmp = rsTmp.Fields("PA31")
         AddPAField "PA31", strTmp, 0
         SetPAFieldNewData "PA31", textCE23
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA36")) = False Then: strTmp = rsTmp.Fields("PA36")
         AddPAField "PA36", strTmp, 0
         SetPAFieldNewData "PA36", textCE24
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA41")) = False Then: strTmp = rsTmp.Fields("PA41")
         AddPAField "PA41", strTmp, 0
         SetPAFieldNewData "PA41", textCE25
      End If
      ' 代表人
      If textCE16 = "1" Then
         '代表人１
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA79")) = False Then: strTmp = rsTmp.Fields("PA79")
         AddPAField "PA79", strTmp, 0
         SetPAFieldNewData "PA79", textCE10
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA80")) = False Then: strTmp = rsTmp.Fields("PA80")
         AddPAField "PA80", strTmp, 0
         SetPAFieldNewData "PA80", textCE11
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA81")) = False Then: strTmp = rsTmp.Fields("PA81")
         AddPAField "PA81", strTmp, 0
         SetPAFieldNewData "PA81", textCE12
         '代表人２
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA82")) = False Then: strTmp = rsTmp.Fields("PA82")
         AddPAField "PA82", strTmp, 0
         SetPAFieldNewData "PA82", textCE13
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA83")) = False Then: strTmp = rsTmp.Fields("PA83")
         AddPAField "PA83", strTmp, 0
         SetPAFieldNewData "PA83", textCE14
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA84")) = False Then: strTmp = rsTmp.Fields("PA84")
         AddPAField "PA84", strTmp, 0
         SetPAFieldNewData "PA84", textCE15
      
      End If
      ' 專利種類代號
      If textCE40 = "1" Then
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA08")) = False Then: strTmp = rsTmp.Fields("PA08")
         AddPAField "PA08", strTmp, 0
         SetPAFieldNewData "PA08", m_CE39
      End If
'      ' 商品類別
'      If textCE48 = "1" Then
'         strTmp = Empty
'         If IsNull(rsTmp.Fields("TM09")) = False Then: strTmp = rsTmp.Fields("TM09")
'         AddPAField "TM09", strTmp, 0
'         SetPAFieldNewData "TM09", textCE47
'      End If
'      ' 正商標號數
'      If textCE58 = "1" Then
'         strTmp = Empty
'         If IsNull(rsTmp.Fields("TM27")) = False Then: strTmp = rsTmp.Fields("TM27")
'         AddPAField "TM27", strTmp, 0
'         SetPAFieldNewData "TM27", textCE57
'      End If
      ' 專利名稱
      If textCE44 = "1" Then
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA05")) = False Then: strTmp = rsTmp.Fields("PA05")
         AddPAField "PA05", strTmp, 0
         SetPAFieldNewData "PA05", textCE41
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA06")) = False Then: strTmp = rsTmp.Fields("PA06")
         AddPAField "PA06", strTmp, 0
         SetPAFieldNewData "PA06", textCE42
         strTmp = Empty
         If IsNull(rsTmp.Fields("PA07")) = False Then: strTmp = rsTmp.Fields("PA07")
         AddPAField "PA07", strTmp, 0
         SetPAFieldNewData "PA07", textCE43
      End If
'      ' 商品群組
'      If textCE50 = "1" Then
'         strTmp = Empty
'         If IsNull(rsTmp.Fields("TM32")) = False Then: strTmp = rsTmp.Fields("TM32")
'         AddPAField "TM32", strTmp, 0
'         SetPAFieldNewData "TM32", textCE49
'      End If
   End If
   rsTmp.Close
   ' 更新專利基本檔
   ...
   For nIndex = 0 To m_PACount - 1
      strTmp = Empty
      If m_PAList(nIndex).fiOldData <> m_PAList(nIndex).fiNewData Then
         If m_PAList(nIndex).fiType = 0 Then
            strTmp = m_PAList(nIndex).fiName & " = '" & m_PAList(nIndex).fiNewData & "'"
         Else
            If m_PAList(nIndex).fiNewData = Empty Then
               strTmp = m_PAList(nIndex).fiName & " = " & 0
            Else
               strTmp = m_PAList(nIndex).fiName & " = " & m_PAList(nIndex).fiNewData
            End If
         End If
         ' 將更新的項目以原資料儲存到 strPS 中
         If m_PAList(nIndex).fiOldData <> Empty Then
            If strPS <> Empty Then: strPS = strPS & ","
            strPS = strPS & m_PAList(nIndex).fiOldData
         End If
      End If
      If strTmp <> Empty Then
         bDifference = True
