...
Begin VB.Form frm06010602_1 
   ...
   End
End
Attribute VB_Name = "frm06010602_1"
...
Private Sub Command1_Click()
   ...
   If Option1(0).Value = True Then
      ...
      strExc(0) = "select " & ChgPatent("", 1) & " as No,nvl(pa05,nvl(pa06,pa07)) as Name," & _
         ...
         "cp01,cp02,cp03,cp04,'' from caseprogress where CP01='FCP' AND " & _
   ...
   ElseIf Option1(1).Value = True Then
      ...
      strExc(0) = "select ''," & ChgPatent("", 1) & ",nvl(pa05,nvl(pa06,pa07)),''," & _
         "pa11,pa01,pa02,pa03,pa04 from patent where " & ChgPatent(Text1 & Text2 & Text3 & Text4) & _
         " and pa09='" & 台灣國家代號 & "'"
      Set RsTemp = ClsLawReadRstMsg(intI, strExc(0)) 'edit by nickc 2007/02/05 不用 dll 了 objLawDll.ReadRstMsg(intI, strExc(0))
      If intI = 1 Then
         'Remove by Morgan 2004/9/2 改成存檔時檢查
...
'         End If
   ...
   ElseIf Option1(2).Value = True Then
      ...
      strExc(0) = "select " & ChgPatent("", 1) & " as No,nvl(pa05,nvl(pa06,pa07)) as Name," & _
         ...
         "CP01='FCP' AND cp36='" & Text6 & "' and (cp01,cp02,cp03,cp04) not in " & _
...
Private Sub Form_Load()
   ...
   Me.Option1(1).Value = True: DoEvents
   SendKeys "{Tab}"
   
End Sub

Private Sub Form_Unload(Cancel As Integer)
   Set frm06010602_1 = Nothing
End Sub
...
Private Sub FormConfirm()
 Dim bolChk As Boolean, i As Integer, j As Integer, strTmp(1 To 2) As String
   ...
   'If objLawDll.ChkMRec(TransDate(Text5, 2), strExc(1) & strExc(2) & strExc(3) & strExc(4), strTmp(1), strTmp(2)) Then
'2011/7/12 CANCEL BY SONIA 改至第二畫面再檢查
