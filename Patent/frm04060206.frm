...
Begin VB.Form frm04060206 
   ...
   Begin MSComctlLib.ImageList ImgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":031C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":0638
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":0814
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":0B30
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":0E4C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":1168
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":1484
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":17A0
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":1ABC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm04060206.frx":1DD8
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid grdList 
      ...
      _Band(0).Cols   =   2
   End
   Begin MSForms.TextBox textCBEC02 
      Height          =   300
      Left            =   1440
      TabIndex        =   3
      Top             =   960
   ...
   End
   Begin MSForms.TextBox textCBEC01 
      Height          =   300
      Left            =   1440
      TabIndex        =   1
      Top             =   630
...
'   Select Case KeyCode
'      ' 新增
'      Case vbKeyF2, vbKeyF4, vbKeyF5, vbKeyHome, vbKeyPageUp, vbKeyPageDown, vbKeyEnd, vbKeyEscape:
...
Private Sub QueryDB()
   ...
   End If
   ' 設定 Query 的命令
   strSql = "SELECT * FROM CBECustom ORDER BY CBEC01"
...
Private Sub InitialField()
   ...
   For nIndex = 1 To MAX_FIELD
      ...
      m_FieldList(nIndex - 1).fiName = "CBEC" & strTmp
...
Private Sub UpdateFieldNewData()
   SetFieldNewData "CBEC01", textCBEC01
   SetFieldNewData "CBEC02", textCBEC02
End Sub
...
Private Sub SetCtrlReadOnly(ByVal bEnable As Boolean)
   textCBEC01.Locked = bEnable
   textCBEC02.Locked = bEnable
End Sub
' 更新Key的狀態
...
Private Sub UpdateCtrlData()
   ...
   ClearField
   If IsNull(m_Recordset.Fields("CBEC01")) = False Then
      textCBEC01 = m_Recordset.Fields("CBEC01")
   End If
   If IsNull(m_Recordset.Fields("CBEC02")) = False Then
      textCBEC02 = m_Recordset.Fields("CBEC02")
   End If
EXITSUB:
End Sub

' 顯示資料
Private Sub ShowCurrRecord(ByVal strCBEC01 As String)
   Dim bFind As Boolean
   If m_Recordset.RecordCount > 0 Then
      bFind = False
      m_Recordset.MoveFirst
      While m_Recordset.EOF = False And bFind = False
         If strCBEC01 = m_Recordset.Fields("CBEC01") Then
            bFind = True
         Else
...
Private Sub UpdateFieldState()
   Select Case m_EditMode
      ' 無
      Case 0:
         textCBEC01.Locked = True
         textCBEC02.Locked = True
      ' 新增
      Case 1:
         textCBEC01.Locked = False
         textCBEC02.Locked = False
      ' 修改
      Case 2:
         textCBEC01.Locked = False
         textCBEC02.Locked = False
...
Private Sub textCBEC01_Validate(Cancel As Boolean)
   Dim strTit As String
   Dim strMsg As String
   Dim nResponse
   
   Cancel = False
   If IsEmpty(textCBEC01) = False Then
      ' 離開欄位時檢查是否該代號有重覆
      If m_EditMode = 1 Then
         ' 檢查記錄是否已存在
         If IsRecordExist(textCBEC01, textCBEC02) = True Then
            Cancel = True
            strTit = "新增資料"
            strMsg = "該筆記錄已存在"
         ...
         End If
      End If
      If StrLength(textCBEC01) > 40 Then
         Cancel = True
         strTit = "檢核資料"
         strMsg = "客戶名稱太長"
         nResponse = MsgBox(strMsg, vbOKOnly, strTit)
...
Private Sub textCBEC02_Validate(Cancel As Boolean)
   Dim strTit As String
   Dim strMsg As String
   Dim nResponse
   
   Cancel = False
   If IsEmpty(textCBEC02) = False Then
      If StrLength(textCBEC02) > 70 Then
         Cancel = True
         strTit = "檢核資料"
         strMsg = "客戶地址太長"
         nResponse = MsgBox(strMsg, vbOKOnly, strTit)
...
' 檢查記錄是否已經存在
Private Function IsRecordExist(ByVal strCBEC01 As String, ByVal strCBEC02 As String) As Boolean
   Dim rsTmp As New ADODB.Recordset
   Dim strSql As String
   
   IsRecordExist = False
   strSql = "SELECT * FROM CBECustom " & _
            "WHERE CBEC01 = '" & strCBEC01 & "' AND " & _
                  "CBEC02 = '" & strCBEC02 & "' "
...
Private Sub AddRecord()
   ...
   Dim strCBEC01 As String
   Dim strCBEC02 As String
      
   strCBEC01 = textCBEC01
   strCBEC02 = textCBEC02
   
   ' 檢查記錄是否已存在
   If IsRecordExist(strCBEC01, strCBEC02) = True Then
      strTit = "新增資料"
      strMsg = "該筆記錄已存在"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      UpdateCtrlData
...
Private Sub DelRecord()
   ...
   For nIndex = 1 To grdList.Rows - 1
      If grdList.TextMatrix(nIndex, 1) = strCBEC01 And grdList.TextMatrix(nIndex, 2) = strCBEC02 Then
         nSel = nIndex
      End If
   Next nIndex
   
   strSql = "DELETE FROM CBEcustom " & _
            "WHERE CBEC01 = '" & strCBEC01 & "'"
...
Private Function QueryRecord() As Boolean
   ...
   While (m_Recordset.EOF <> True) And (bFind = False)
      If m_Recordset.Fields("CBEC01") = strCBEC01 And m_Recordset.Fields("CBEC02") = strCBEC02 Then
         bFind = True
      Else
         m_Recordset.MoveNext
      End If
...
Private Sub grdList_SelChange()
   ...
   If grdList.row > 0 Then
      strCBEC01 = grdList.TextMatrix(grdList.row, 1)
   End If
...
Private Sub SetEntryFocus()
   Select Case m_EditMode
      Case 1, 4:
         If textCBEC01.Locked = False Then
            textCBEC01.SetFocus
         End If
      Case 2:
         If textCBEC02.Locked = False Then
            textCBEC02.SetFocus
         End If
   End Select
End Sub
...
Private Sub UpdateGridList()
   ...
   If m_Recordset.RecordCount > 0 Then
      ...
      While m_Recordset.EOF <> True
         ...
         grdList.col = 1
         If IsNull(m_Recordset.Fields("CBEC01")) = False Then
            grdList.Text = m_Recordset.Fields("CBEC01")
         End If
         
         grdList.col = 2
         If IsNull(m_Recordset.Fields("CBEC02")) = False Then
            grdList.Text = m_Recordset.Fields("CBEC02")
         End If
...
Private Sub textCBEC01_GotFocus()
   InverseAll textCBEC01
   'edit by nickc 2007/07/11 切換輸入法改用API
   'textCBEC01.IMEMode = 1
   OpenIme
End Sub

Private Sub textCBEC02_GotFocus()
   InverseAll textCBEC02
   'edit by nickc 2007/07/11 切換輸入法改用API
   'textCBEC02.IMEMode = 1
   OpenIme
End Sub
...
Private Function CheckDataValid() As Boolean
   ...
   If IsEmpty(textCBEC01) = True Then
      strTit = "檢核資料"
      strMsg = "請輸入客戶名稱"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      GoTo EXITSUB
   End If
   If IsEmpty(textCBEC02) = True Then
      strTit = "檢核資料"
      strMsg = "請輸入客戶地址"
      nResponse = MsgBox(strMsg, vbOKOnly, strTit)
      GoTo EXITSUB
