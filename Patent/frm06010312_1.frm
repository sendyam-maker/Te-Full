...
Begin VB.Form frm06010312_1 
   ...
   End
End
Attribute VB_Name = "frm06010312_1"
...
Dim rsTemp1 As New ADODB.Recordset
   ...
   End If
   If Text8 <> "" Then
      strExc(0) = "SELECT PA26 FROM PATENT WHERE PA11='" & Text8 & "'"
      intI = 1
      Set rsTemp1 = ClsLawReadRstMsg(intI, strExc(0))
      If intI = 1 Then
         With rsTemp1
