                        ...
                        If i = 12 Then
                           If optChoose(0).Value Then
                              ...
                              ElseIf txtCode(8) = "1" Then
                                 ...
                                 Next
                                 'edit by nickc 2007/02/05 不用 dll 了
                                 'If obj003.ChkCaseMap(strCode, 2) Then
                                 If Cls003ChkCaseMap(strCode, 2) Then
                                    GoTo A0
                                 Else
                                    txtCode(0).SetFocus
                                 End If
                              Else
A0:                              frm040108_2.intWhereToGo = 0
                                 frm040108_2.strCode1 = txtCode(0)
                                 frm040108_2.strCode2 = txtCode(1)
                                 frm040108_2.strCode3 = txtCode(2)
                                 frm040108_2.strCode4 = txtCode(3)
                                 frm040108_2.strCode5 = txtCode(4)
                                 frm040108_2.strCode6 = txtCode(5)
                                 frm040108_2.strCode7 = txtCode(6)
                                 frm040108_2.strCode8 = txtCode(7)
                                 frm040108_2.intChoose = Val(txtCode(8))
                                 frm040108_2.Show
                                 Me.Hide
                              End If
                           Else '多筆
                              frm040108_3.lblEnginer = txtCode(9)
                              frm040108_3.lblEnginerName = lblEnginer
                              frm040108_3.lblDate(0) = ChangeWStringToWDateString(txtCode(10))
                              frm040108_3.lblDate(1) = ChangeWStringToWDateString(txtCode(11))
                              Me.Hide
                           End If
                        End If
...
Select Case intIndex
             ...
             Case 3, 7
                  ...
                  If FMP2open = False Or intIndex <> 3 Then
