...
Begin VB.Form frm04060303_1 
   ...
   End
End
Attribute VB_Name = "frm04060303_1"
...
Dim nRowTot As Long 'Add By Sindy 2011/12/16
...
Private Sub buttonOK_Click()
   ...
   If text04 = "1" Then
      ...
      frm04060303_2.SetData text01_01, text05, text03_01, text03_02, bListDetail
      frm04060303_2.UpdateCtrlData
      frm04060303_2.Show
      frm04060303_1.Hide
   '列印
   Else
...
Private Sub text03_02_LostFocus()
   ...
   If IsEmpty(text03_02) = False Then
      ...
      Else
         If Not ChkRange(text03_01, text03_02, "公開日") Then
...
Public Function CheckDataValid() As Boolean
   ...
   CheckDataValid = True
    '檢查公開起日
   If IsEmpty(text03_01) = True Then
      CheckDataValid = False
      strMsg = "公開日必須輸入"
      strTit = "檢核輸入"
      nResponse = MsgBox(strMsg, vbOKOnly + vbCritical, strTit)
        Me.text03_01.SetFocus
        text03_01_GotFocus
      GoTo EXITSUB
   ElseIf CheckIsTaiwanDate(text03_01, False) = False Then
      CheckDataValid = False
      strMsg = "請輸入正確的公開日"
      strTit = "檢核輸入"
      nResponse = MsgBox(strMsg, vbOKOnly + vbCritical, strTit)
...
Public Sub PrintReport()
   ...
   If IsEmpty(text03_01) = False Then
      ...
      strSubSQL = strSubSQL & "TPG03 >= " & ChangeTStringToWString(text03_01) & " "
   End If
   If IsEmpty(text03_02) = False Then
      If strSubSQL <> Empty Then: strSubSQL = strSubSQL & " AND "
      strSubSQL = strSubSQL & "TPG03 <= " & ChangeTStringToWString(text03_02) & " "
   End If
...
PrintData:
   nPage = 1
   rsData.MoveFirst
   strCurr1 = rsData.Fields("TPG04")
   strCurr2 = rsData.Fields("TPG05")
   ...
   nRow = 1
   nRowTot = 0 'Add By Sindy 2012/1/10
   While rsData.EOF <> True
      Fld1 = rsData.Fields("TPG01")
      Fld2 = CStr(rsData.Fields("TPG02"))
      Fld3 = Empty
      Fld4 = Empty
      Fld5 = Empty
      
      ' 若卷號或期數不同則換頁
      If rsData.Fields("TPG04") <> strCurr1 Or rsData.Fields("TPG05") <> strCurr2 Then
         strCurr1 = rsData.Fields("TPG04")
         strCurr2 = rsData.Fields("TPG05")
         ' 印合計值
      ...
      ' 申請人國籍
      If IsNull(rsData.Fields("TPG06")) = False Then
         Fld3 = GetNation(rsData.Fields("TPG06"))
      End If
      
      ' 代理人
      If IsNull(rsData.Fields("TPG07")) = False Then
         If (rsTmp.State <> adStateClosed) Then rsTmp.Close
         strSql = "SELECT * FROM TAGENT WHERE TA02 = '" & rsData.Fields("TPG07") & "'"
         rsTmp.CursorLocation = adUseClient
         rsTmp.Open strSql, cnnConnection, adOpenDynamic
         If rsTmp.RecordCount > 0 Then
            rsTmp.MoveFirst
      ...
      ' 本所案號
      If (rsTmp.State <> adStateClosed) Then rsTmp.Close
      strSql = "SELECT * FROM Patent WHERE PA11 = '" & rsData.Fields("TPG01") & "'"
      rsTmp.CursorLocation = adUseClient
      rsTmp.Open strSql, cnnConnection, adOpenDynamic
      If rsTmp.RecordCount > 0 Then
         rsTmp.MoveFirst
      ...
      'Add By Sindy 2012/1/10
      Else
         If Check1.Value = 1 Then GoTo ReadNext
      '2012/1/10 End
      End If
      rsTmp.Close
      ...
      nRowTot = nRowTot + 1 'Add By Sindy 2012/1/10
...
ReadNext: 'Add By Sindy 2012/1/10
      rsData.MoveNext
   Wend
   InsertQueryLog (nRowTot) 'Add By Sindy 2012/1/10
