...
Begin VB.Form frm06010608_31 
   ...
   End
End
Attribute VB_Name = "frm06010608_31"
...
Private Sub ReadAllData()
 On Error GoTo ErrHnd
   intLeaveKind = Left(frm06010608_31.Tag, 1)
   cp(9) = Right(frm06010608_31.Tag, (frm06010608_31.Tag) - 1)
   'edit by nickc 2007/02/02 不用 dll 了
   ...
   If ClsPDReadCaseProgressDatabase(cp(), intPWhere) Then
      ...
      Select Case intLeaveKind
         'Remove by Morgan 2011/10/5 沒有再用
         'Case 4
         '   lblCaseField(1) = frm04010504_3.MPa9
         '   SetComboToCombo cboCaseName, frm04010504_3.Combo1
            
         Case 6
            lblCaseField(1) = frm06010608_3.MPa9
            SetComboToCombo cboCaseName, frm06010608_3.Combo1
      End Select
   Else
