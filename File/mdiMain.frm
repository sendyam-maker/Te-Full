...
Private Sub mnu140402_Click(Index As Integer)
   ToolHide
   Select Case Index
      Case 1   '發文數輸入
         If CheckUse("frm010018", strExec) = False Then
            Exit Sub
         End If
         frm010018.Show
      Case 2   '總務處工作報告列印
         If CheckUse("frm010019", strExec) = False Then
            Exit Sub
         End If
         frm010019.Show
      Case 3   '櫃檯每日信件輸入
         If CheckUse("frm010016", strExec) = False Then
            Exit Sub
         End If
         frm010016.Show
      Case 4   '櫃台每日作業統計數輸入
         If CheckUse("frm010017", strExec) = False Then
            Exit Sub
         End If
         frm010017.Show
      Case 5   '新案立卷數量輸入
         If CheckUse("frm010020", strExec) = False Then
            Exit Sub
         End If
         frm010020.Show
      'add by nickc 2007/11/01
      Case 6   '每月收文統計明細查詢
         If CheckUse("frm010021", strExec) = False Then
            Exit Sub
         End If
        frm010021.Show
      'add by Sindy 2009/02/05
      Case 7     '櫃檯每日信件查詢
         If CheckUse("frm010023", strExec) = True Then
            frm010023.Show
         End If
      'add by Sindy 2014/4/15
      Case 8     '電話分機資料維護
         If CheckUse("frm010028", strExec) = True Then
            frm010028.Show
         End If
      'Added by Lydia 2019/02/01 公告本整批匯入
      Case 9
         If CheckUse("frm010038", strExec) = True Then
            frm010038.Show
         End If
   End Select
End Sub
...
Private Sub mnu23_Click(Index As Integer)
   Select Case Index
      Case 1 '預約作業
         frm140112.Show
      Case 7 'Add by Amy 2016/10/03 圖書借閱查詢
         frm010035.Show
     ...
     Case 8 '行事曆提醒通知
         ...
         frm060209.Show
     Case 9 'Add by Amy 2020/11/02 教育訓練登入作業
        frm140113.Show
...
Private Sub mnu3_Click(Index As Integer)
   ...
   Select Case Index
      Case 1   '發文-主管機關
         If CheckUse("frm010024", strExec) = False Then
            Exit Sub
         End If
         frm010024.Show
      'Added by Morgan 2014/5/6
      Case 2   '發文-非主管機關
         If CheckUse("frm010029", strExec) = False Then
            Exit Sub
         End If
         frm010029.Show
      Case 3   '發文清單
         If CheckUse("frm010031", strExec) = False Then
            Exit Sub
         End If
         frm010031.Show
      Case 4   '主管機關發文統計
         If CheckUse("frm010032", strExec) = False Then
            Exit Sub
         End If
         frm010032.Show
      Case 5   '取消發文資料查詢
         If CheckUse("frm010025", strExec) = False Then
            Exit Sub
         End If
         frm010025.Show
      ...
      Case 6   '分所寄件統計
         '不必鎖
         'If CheckUse("frm010030", strExec) = False Then
         '   Exit Sub
         'End If
         frm010030.Show
   End Select
...
Private Sub mnu4_Click(Index As Integer)
   Select Case Index
      ...
      Case 3 '國內潛在客戶資料查詢
         ...
         'End If
      Case 4 '商標申請書
         If CheckUse("frm010027", strExec) = True Then
            frm010027.Show
         End If
      'Add By Sindy 2023/10/2
      Case 5 '待排版區
         frm090202_1.m_ProSysState = "3" '打字室
         frm090202_1.Show
      'Added by Lydia 2018/05/17
      Case 6 '外專工程師上傳作業
         If CheckUse("frm090905", strExec) = True Then
            frm090905.Show
         End If
      'Added by Lydia 2018/12/28
      Case 7 '案件基本資料-打字室
         If CheckUse("frm010037", strExec) = True Then
            frm010037.Show
         End If
      Case 8   '潛在客戶資料維護
...
Dim strUserId As String * 10, strLocalId As String
    ...
    'Ken 90/07/06
      ...
      mnu4(5).Visible = False '待排版區
      If Pub_StrUserSt03 = "M51" Or strSrvDate(1) >= 外專承辦歷程啟用日 Then
         mnu4(5).Visible = True
      End If
      '2023/9/28 END
...
'       'end
      ...
      'Add By Sindy 2014/12/18 掃瞄資料匯入
      If strSrvDate(1) >= P台灣案電子化啟用日 Then
         mnu140401(13).Visible = True
      ElseIf Pub_StrUserSt03 = "M51" Or InStr(UCase(Pub_GetModuleFileName), "VB6.EXE") <> 0 Then
         mnu140401(13).Visible = True
      Else
         mnu140401(13).Visible = False
      End If
      '2014/12/18 END
...
Private Sub mnu140401_Click(Index As Integer)
   ToolHide
   Select Case Index
      Case 1    '客戶基本資料維護
         If CheckUse("frm140401", strExec) = False Then
            Exit Sub
         End If
         frm140401.Show
      '2008/7/23 add by sonia
      Case 2    '客戶發明人資料維護
         If CheckUse("frm050709", strExec) = False Then
            Exit Sub
         End If
         frm050709.Show
      '2008/7/23 end
      '2009/7/2 add by sonia
      Case 3    '客戶接洽人資料修改
         If CheckUse("frm210101_1", strExec) = False Then
            Exit Sub
         End If
         frm210101_1.setSalesNo strUserNum
         frm210101_1.setDeptNo Pub_StrUserSt03
         frm210101_1.Show
      '2009/7/2 end
      Case 4    '客戶變更名稱作業
         If CheckUse("frm140101", strExec) = False Then
            Exit Sub
         End If
         frm140101.Show
     'Add by Amy 2015/06/10 +國內潛在客戶
      Case 5
         frm210128.Show
      Case 6  '國外代理人資料維護
         If CheckUse("frm050705", strExec) = False Then
            Exit Sub
         End If
         frm050705.Show
      Case 7    '代理人變更名稱作業
         If CheckUse("frm140103", strExec) = False Then
            Exit Sub
         End If
         frm140103.Show      '
      'add by nickc 2006/07/11
      Case 8    '北所銷卷案號輸入作業
         If CheckUse("frm140102", strExec) = False Then
            Exit Sub
         End If
         frm140102.Show
      Case 9   '分所銷卷維護
         If CheckUse("frm140104", strExec) = False Then
            Exit Sub
         End If
         frm140104.Show
      Case 10    '分所內商延展、第二期註冊費未續辦清單
         If CheckUse("frm140105", strExec) = False Then
            Exit Sub
         End If
         frm140105.Show
      Case 11   '分所內商延展、第二期註冊費銷卷作業
         If CheckUse("frm140106", strExec) = False Then
            Exit Sub
         End If
         frm140106.Show
      Case 12   '銷卷後復原維護
         If CheckUse("frm140107", strExec) = False Then
            Exit Sub
         End If
         frm140107.Show
      'Add By Sindy 2010/10/20
      Case 13   '分所案號維護
         If CheckUse("frm010026", strExec) = False Then
            Exit Sub
         End If
         frm010026.Show
      ...
      Case 14   '掃瞄資料匯入
      'end 2015/06/10
         If CheckUse("frm010033", strExec) = False Then
            Exit Sub
         End If
         frm010033.Show
      'Add By Amy 2016/10/03
      Case 15 '圖書基本資料維護
         If CheckUse("frm010034", strExec) = False Then
            Exit Sub
         End If
         frm010034.Show
      Case 16 '圖書借閱資料查詢
         If CheckUse("frm010036", strExec) = False Then
            Exit Sub
         End If
          frm010036.Show
   End Select
...
Public Sub SetTmpfrm090401()
   '騙系統的func為了不要加入撰寫信函form,因加入就要再加basLaw,裡面有一堆的form又要再被呼叫進來
End Sub
